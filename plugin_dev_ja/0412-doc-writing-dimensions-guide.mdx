  ...
  <Tab title="AI支援の利用">
    <Steps>
      ...
      <Step title="AIでメタデータを生成">
        あなたのドキュメントと[**dimensionsシステムの説明**](/plugin_dev_ja/0412-doc-understanding-the-dimensions)の内容を、お好みの大規模言語モデルに提供し、適切なFrontmatterの生成を依頼します。
      </Step>
      <Step title="手動での調整">
...
<Tabs>
  ...
  <Tab title="type.detail">
    ...
    <Note>
      より多くのオプションについては、[dimensionsシステムの説明](/plugin_dev_ja/0412-doc-understanding-the-dimensions)ドキュメントを参照してください
    </Note>
  </Tab>
...
<Card title="もっと詳しく知りたいですか？" icon="book-open" href="/plugin_dev_ja/0412-doc-understanding-the-dimensions">
...
<CardGroup cols="2">
    <Card
        title="このページを編集する"
        icon="pen-to-square"
        href="https://github.com/langgenius/dify-docs-mintlify/edit/main/plugin_dev_ja/0412-doc-writing-dimensions-guide.mdx"
    >
    ...
    <Card
        title="問題を報告する"
        icon="github"
        href="https://github.com/langgenius/dify-docs-mintlify/issues/new?title=ドキュメントの問題%3A%20doc-writing-dimensions-gu&body=%23%23%20問題の説明%0A%3C%21--%20発見した問題について簡単に説明してください%20--%3E%0A%0A%23%23%20ページリンク%0Ahttps%3A%2F%2Fgithub.com%2Flanggenius%2Fdify-docs-mintlify%2Fblob%2Fmain%2Fplugin_dev_ja%2F0412-doc-writing-dimensions-guide.mdx%0A%0A%23%23%20提案される変更%0A%3C%21--%20特定の変更案がある場合は、ここで説明してください%20--%3E%0A%0A%3C%21--%20ドキュメントの品質向上にご協力いただきありがとうございます！%20--%3E"
    >

...
The {lang}/api-reference/openapi_service.json files are generated by
build_specs.py from the Dify Service API contract and language annotations.
This module owns navigation and app-type coverage, not contract generation.

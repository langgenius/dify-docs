...
出于安全性考虑，部分身份提供商（IDP）会禁用在 iframe 页面中启用 SSO 鉴权。这可能会影响 WebApp 嵌入至其它网页的情况，你需要检查身份提供商（IDP）的 CSP: frame-ancestors 配置以确保正常启用该功能，详细说明请参考[此文档](/zh-cn/administrator-guide/faq)。
...
- Okta
    ...
    - [使用 Okta 配置 OIDC](./okta/oidc)
    - [使用 Okta 配置 SAML](./okta/saml)
- Azure

    - [使用 Azure 配置 SAML](./azure/saml)

- GitHub

    - [使用 GitHub 配置 OAuth2](./github/oauth2)
...
详细说明请参考 [常见问题](/zh-cn/administrator-guide/faq)。

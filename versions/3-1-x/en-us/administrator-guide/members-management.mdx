...
In the member list, click the dropdown menu on the right side of the member and select **Delete** to delete the member. The deleted member will no longer be able to log into the workspace.

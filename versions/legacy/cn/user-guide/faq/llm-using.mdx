...
### 1. 如何使用 OpenAI 代理服务器进行访问？

Dify 支持 OpenAI 的自定义 API 域名能力，支持任何兼容 OpenAI 的大模型 API 服务器。
...
目前数据集文档上传单个文档最大是 15MB，总文档数量限制 100 个。如你本地部署版本需要调整修改该限制，请参考[文档](/zh-cn/user-guide/faq/llm-using)。
...
是否使用数据集，会和数据集的描述有关系，尽可能把数据集描述写清楚。
...
<Frame caption="">
  <img src="/zh-cn/user-guide/.gitbook/assets/image (135).png" alt="" />
</Frame>

...
<Frame caption="召回测试">
  <img src="/zh-cn/user-guide/.gitbook/assets/image (86).png" alt="" />
</Frame>
...
<Frame caption="召回测试-检索设置">
  <img src="/zh-cn/user-guide/.gitbook/assets/image (87).png" alt="" />
</Frame>
...
<Frame caption="打开引用与归属功能">
  <img src="/zh-cn/user-guide/.gitbook/assets/citation-and-attribution.png" alt="" />
</Frame>

开启功能后，当 LLM 引用知识库内容来回答问题时，可以在回复内容下面查看到具体的引用段落信息，包括**原始分段文本、分段序号、匹配度**等。点击引用分段上方的 **跳转至知识库**，可以快捷访问该分段所在的知识库分段列表，方便开发者进行调试编辑。

<Frame caption="查看回复内容的引用信息">
  <img src="/zh-cn/user-guide/.gitbook/assets/image (84).png" alt="" />
</Frame>

...
<CardGroup cols="2">
    <Card
        title="编辑此页面"
        icon="pen-to-square"
        href="https://github.com/langgenius/dify-docs-mintlify/edit/main/zh-hans/guides/model-configuration/schema.mdx"
    >
        通过直接提交修改来帮助改进文档内容
    </Card>
    <Card

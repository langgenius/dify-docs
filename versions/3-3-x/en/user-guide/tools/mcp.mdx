...
<Note>
  This article shows how to use MCP tools within Dify. If you're looking to publish an Dify application as an MCP server, check [here](/versions/3-3-x/en-us/user-guide/application-publishing/publish-mcp).
</Note>

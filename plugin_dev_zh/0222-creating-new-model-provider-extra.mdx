...
* [模型 Schema 定义](/plugin_dev_zh/0412-model-schema) (模型 YAML 规范)
* [插件 Manifest 结构](/plugin_dev_zh/0411-general-specifications) (`manifest.yaml` 规范)
...
<CardGroup cols="2">
    <Card
        title="编辑此页面"
        icon="pen-to-square"
        href="https://github.com/langgenius/dify-docs-mintlify/edit/main/plugin_dev_zh/0222-creating-new-model-provider-extra.mdx"
    >
        通过直接提交修改来帮助改进文档内容
    </Card>
    <Card

...
2. Export `service-openapi.json` from a clean Dify checkout, import it with its full commit SHA, and review the raw diff and affected overlay text/examples.

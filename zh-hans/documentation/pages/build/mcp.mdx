...
将来自 [MCP 服务器](https://modelcontextprotocol.io/introduction) 的外部工具连接到您的 Dify 应用程序。您可以使用不断增长的 [MCP 生态系统](https://mcpservers.org/) 中的工具，而不仅仅是内置工具。
...
**应用程序损坏**：您可能更改了服务器 ID。使用原始 ID 重新添加它。

...
每个节点类型都会抛出特定的错误类别，帮助您了解出错的原因以及如何修复。
...
`CodeNodeError`
<Info>您的 Python 或 JavaScript 代码在执行过程中抛出了异常</Info>
...
`DepthLimitError`
<Info>您的代码创建的嵌套数据结构深度超过了 5 层</Info>

`CodeExecutionError`
<Info>沙箱服务无法执行您的代码 - 通常意味着服务已停止</Info>
...
<Info>您已达到 API 或模型提供商的速率限制</Info>

`QuotaExceededError`
<Info>您对此服务的使用配额已超限</Info>
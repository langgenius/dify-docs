...
在上一个实验 [如何搭建 AI 图片生成应用](/en/build-ai-image-generation-app) 中，我们已初步了解了 Agent 的概念，并且尝试动手写了系统提示词。
...
* 注册和登录 [Dify](https://dify.ai)，如果你想要进行本地部署，可以参考 [社区版 - Docker Compose 部署](/en/../../getting-started/install-self-hosted/docker-compose)
...
当然，你也可以使用其他的搜索引擎，例如[必应](/zh-hans/guides/tools/tool-configuration/bing)，甚至是由 AI 驱动的 [Perplexity](/zh-hans/guides/tools/tool-configuration/perplexity)。

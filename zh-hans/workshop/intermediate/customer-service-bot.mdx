...
你可以在提示词书写区域输入 `/` 或者 `{` 来引用变量。在变量中，`sys.` 开头的变量是系统变量，请查询[帮助文档](/en/../../guides/workflow/variables#xi-tong-bian-liang)相关说明。
...
有关 AWS Bedrock 知识库的最佳实践，请阅读：[如何连接 AWS Bedrock 知识库？](/en/../../learn-more/use-cases/how-to-connect-aws-bedrock)

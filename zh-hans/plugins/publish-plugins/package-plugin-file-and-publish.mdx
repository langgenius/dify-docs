...
* **Dify 插件开发工具**，详细说明请参考[初始化开发工具](/en/../quick-start/develop-plugins/initialize-development-tools)。
...
插件项目开发完成后，请确保已完成[远程连接测试](/en/../quick-start/develop-plugins/extension-plugin#tiao-shi-cha-jian)。需前往插件项目的上一级目录，运行以下插件打包命令：

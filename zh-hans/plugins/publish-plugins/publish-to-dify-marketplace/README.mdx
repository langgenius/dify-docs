...
1. 根据[插件开发者准则](/en/plugin-developer-guidelines)完成插件的开发和测试；
2. 根据[插件隐私政策准则](/en/plugin-privacy-protection-guidelines)撰写该插件隐私政策，并将该隐私政策的文件路径或 URL 写入插件 [Manifest 文件](/en/../../schema-definition/manifest)；
3. 完成插件打包；
...
上图中的 Contributor Agreement 指的是[插件开发者准则](/en/plugin-developer-guidelines)。
</Info>
...
* 检查插件的 [Manifest 文件](/en/../../schema-definition/manifest)是否符合格式规范，并包含有效的作者联系信息。

3. **插件的功能性和相关性**

* 根据[插件开发说明](/en/../../quick-start/develop-plugins/)测试插件。

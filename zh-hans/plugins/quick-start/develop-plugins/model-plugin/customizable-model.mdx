...
与[预定义模型类型](integrate-the-predefined-model)不同，由于未在 YAML 文件中预设模型所支持的参数，因此需要动态生成模型参数的 Schema。
...
<Card title="debug-plugins.md" icon="link" href="../../debug-plugins.md">
  debug-plugins.md
</Card>

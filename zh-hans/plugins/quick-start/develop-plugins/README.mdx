...
1. [通用结构标准定义](/en/../../schema-definition/general-specifications)
2. [Manifest 标准定义](/en/../../schema-definition/manifest)
3. [工具接入标准定义](/en/../../schema-definition/tool)
4. [模型接入简介](/en/../../schema-definition/model/)
5. [Endpoint 标准定义](/en/../../schema-definition/endpoint)
6. [扩展 Agent 策略](/en/../../schema-definition/agent)
7. 反向调用 Dify 平台能力
   1. 反向调用 [app.md](/en/../../schema-definition/reverse-invocation-of-the-dify-service/app)
   2. 反向调用 [model.md](/en/../../schema-definition/reverse-invocation-of-the-dify-service/model)
   3. 反向调用节点 [node.md](/en/../../schema-definition/reverse-invocation-of-the-dify-service/node)
   4. 反向调用工具 [tool.md](/en/../../schema-definition/reverse-invocation-of-the-dify-service/tool)
8. [插件持久化存储能力](/en/../../schema-definition/persistent-storage)

### 贡献指南

想为官方插件市场贡献更多插件，或面向社区开源插件？请参考以下详细的插件贡献指南：

*   [Marketplace 发布指南](/en/../../publish-plugins/publish-to-dify-marketplace/)

    了解如何将你的插件发布至 Dify Marketplace，向更多 Dify 用户分享你的成果。
*   [GitHub 发布指南](/en/../../publish-plugins/publish-plugin-on-personal-github-repo)

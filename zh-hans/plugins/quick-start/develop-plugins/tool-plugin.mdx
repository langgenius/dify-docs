...
关于如何准备插件开发的脚手架工具，详细说明请参考[初始化开发工具](/en/initialize-development-tools)。
...
> 如果你已熟悉插件开发，无需借助模板，可参考[接口文档](/en/../../schema-definition/)指引完成不同类型的插件开发。
...
* 其中 `credentials_for_provider` 的子级结构需要满足 [ProviderConfig](/en/../../schema-definition/general-specifications#providerconfig) 的规范。
...
该例子的含义为请求 `serpapi`，并使用 `self.create_json_message` 返回一串 `json` 的格式化数据，如果想了解更多的返回数据类型，可以参考[工具接口文档](/en/../../schema-definition/tool)。
...
如果想要将插件发布至 Dify Marketplace，请确保你的插件遵循了[插件发布规范](/zh-hans/plugins/publish-plugins/publish-to-dify-marketplace)。审核通过后，代码将合并至主分支并自动上线至 [Dify Marketplace](https://marketplace.dify.ai/)。

<Card title="publish-plugins" icon="link" href="../../publish-plugins/">
  publish-plugins
</Card>
...
* [开发 Extension 插件](/en/extension-plugin)
* [开发 Model 插件](/en/model-plugin/)
* [Bundle 插件：将多个插件打包](/en/bundle)

#### **插件接口文档：**

* [Manifest](/en/../../schema-definition/manifest) 结构
* [Endpoint](/en/../../schema-definition/endpoint) 详细定义
* [反向调用 Dify 能力](/en/../../schema-definition/reverse-invocation-of-the-dify-service/)
* [工具](/en/../../schema-definition/tool)
* [模型](/en/../../schema-definition/model/)
* [扩展 Agent 策略](/en/../../schema-definition/agent)

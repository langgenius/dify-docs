...
如果你要添加模型提供程序，请参考 [模型开发](/plugins/quick-start/develop-plugins/model-plugin)。

如果你要向 Agent 或 Workflow 添加工具提供程序，请参考 [工具开发](/plugins/quick-start/develop-plugins/tool-plugin)。

...
* 阅读[**快速开始**](guides/application-orchestrate/creating-an-application/readme)，速览 Dify 的应用构建流程
* 了解如何[**自部署 Dify 到服务器**](getting-started/install-self-hosted/)上，并[**接入开源模型**](guides/model-configuration/)
* 了解 Dify 的[**特性规格**](getting-started/readme/features-and-specifications)和 **Roadmap**

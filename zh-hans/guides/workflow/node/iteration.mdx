...
**输入变量：** 仅接受 Array 数组变量类型数据，包括 Array[string]、Array[number]、Array[boolean]、Array[object] 和 Array[file]。如果你不了解什么是数组变量，请阅读 [扩展阅读：数组](../../../learn-more/extended-reading/what-is-array-variable)。

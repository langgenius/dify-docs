...
-   **Developing Different Types of Plugins:** Specific development guides for each plugin type:
    ...
    -   **[Agent Strategies](/plugin_dev_en/9432-agent-strategy-plugin.en):** Create custom reasoning strategies (like ReAct, CoT, ToT) to empower autonomous Agents in Dify.
...
-   **[Community and Contributions](/plugin_dev_en/0313-contributor-covenant-code-of-conduct.en):** Learn how to communicate with other developers, seek help, and contribute to the Dify plugin ecosystem and this documentation.
...
-   **[Development Practice Example](/plugin_dev_en/0433-develop-a-slack-bot-plugin.en)** - View a real plugin development case

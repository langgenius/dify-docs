...
<Note> ⚠️ このドキュメントは AI によって自動翻訳されています。不正確な部分がある場合は、[英語版](/en/use-dify/nodes/code)を参照してください。</Note>
...
<Frame caption="Cloudflare WAFによるセキュリティフィルタリング">
  ![Cloudflare WAFによるセキュリティフィルタリング](https://assets-docs.dify.ai/2024/12/ad4dc065c4c567c150ab7fa7bfd123a3.png)
</Frame>

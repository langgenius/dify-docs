...
<Steps>
    <Step title="要件を満たす外部ナレッジベースAPIを構築する" titleSize="h2">
        Difyとの接続を成功させるためには、外部ナレッジベースがDifyが作成した[外部ナレッジベースAPI仕様](/ja/use-dify/knowledge/api-documentation/external-knowledge-api-documentation)を慎重に読み、APIサービスを構築する必要があります。
    </Step>

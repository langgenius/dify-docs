...
<div className="max-w-5xl mx-auto px-6 py-16">
  ...
  <div className="mt-6">
    <Columns cols={4}>
      <Card title="API リファレンス" icon="code" href="/ja/api-reference/chat-messages/send-chat-message">
        REST API を通じて、Dify アプリケーションを自分のプロダクトに組み込めます。
      </Card>
      <Card title="CLI" icon="terminal" href="/ja/cli/overview">
        difyctl を使って、ターミナル、スクリプト、CI、AI エージェントから Dify アプリを実行できます。
      </Card>
  ...
  <div className="mt-6">
    <Columns cols={2}>
      ...
      <Card title="マーケットプレイス" icon="store" href="https://marketplace.dify.ai/" horizontal>
        コミュニティが作成した統合やアプリテンプレートを閲覧し、すぐにインストールできます。
      </Card>

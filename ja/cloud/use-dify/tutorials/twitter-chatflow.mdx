...
<Note> ⚠️ このドキュメントは AI によって自動翻訳されています。不正確な部分がある場合は、[英語版](/en/cloud/use-dify/tutorials/twitter-chatflow) を参照してください。</Note>
...
[cloud.dify.ai](https://cloud.dify.ai) でアカウントを登録します。新規アカウントは Sandbox プランで開始され、200 AI クレジットが付与されます。このため、独自のモデルプロバイダー API キーを追加しなくても、このチュートリアルを完了できます。

---
title: ゼロから AI 画像生成アプリの構築方法
---

<Note> ⚠️ このドキュメントは AI によって自動翻訳されています。不正確な部分がある場合は、[英語版](/en/cloud/use-dify/tutorials/build-ai-image-generation-app) を参照してください。</Note>
...
Dify の無料版では、200 回の無料の OpenAI メッセージクレジットが提供されます。

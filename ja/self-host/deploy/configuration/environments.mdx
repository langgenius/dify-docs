...
| `MARKETPLACE_API_URL` | `https://marketplace.dify.ai` | プラグインとテンプレートの閲覧・ダウンロード、プラグインのアップグレード確認に使う Marketplace API エンドポイント。<br/><br/>Dify API サービス、Celery ワーカー、Web サービス、ユーザーのブラウザでこの URL を使用します。各実行環境からアクセスできる必要があります。 |

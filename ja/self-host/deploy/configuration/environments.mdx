...
| `DEPLOYMENT_EDITION` | `COMMUNITY` | デプロイのエディション（`COMMUNITY`、`ENTERPRISE`、`CLOUD`）。デフォルトのまま使用してください。<br/><br/>従来の `EDITION`、`ENTERPRISE_ENABLED`、`BILLING_ENABLED` を置き換えるものです。これらの旧変数は 1.16.2 以降無視されます。 |

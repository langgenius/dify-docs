...
> このドキュメントは AI によって自動翻訳されています。不正確な部分がある場合は、[英語版](/en/self-host/deploy/advanced-deployments/start-the-frontend-docker-container) を参照してください。
...
3. コンソールドメインと Web アプリドメインが異なる場合は、CONSOLE_URLとAPP_URLを個別に設定できます。

...
<Note> ⚠️ このドキュメントは AI によって自動翻訳されています。不正確な部分がある場合は、[英語版](/en/self-host/troubleshooting/integrations) を参照してください。</Note>
...
環境変数でHugging Faceミラーまたはプロキシを設定してください。詳細については[環境ドキュメント](https://docs.dify.ai/en/self-host/deploy/ce/configuration/environments)をご覧ください。

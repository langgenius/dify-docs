...
<Note> ⚠️ このドキュメントは AI によって自動翻訳されています。不正確な部分がある場合は、[英語版](/en/self-host/use-dify/tutorials/workflow-101/lesson-08) を参照してください。</Note>
...
<Steps>
  <Step title="イテレーションを整理する">
    ...
    <Frame>
      ![イテレーション](/images/use-dify/tutorial/workflow-101-lesson-08/iteration.png)
    </Frame>
  </Step>
  <Step title="エージェントノードを追加する">
    ...
    <Frame>
      ![エージェントノードを追加](/images/use-dify/tutorial/workflow-101-lesson-08/add-agent-node.png)
    </Frame>
  </Step>
  <Step title="エージェントストラテジーをインストールする">
    ...
    <Frame>
      ![エージェントストラテジーを検索](/images/use-dify/tutorial/workflow-101-lesson-08/search-agent-strategy.png)
    </Frame>
  </Step>
  <Step title="エージェントストラテジーを選択する">
    ...
    <Frame>
      ![エージェントストラテジーを選択](/images/use-dify/tutorial/workflow-101-lesson-08/choose-agent-node.png)
    </Frame>
  </Step>
  <Step title="ReAct を選択する">
    ...
    <Frame>
      ![ReAct を選択](/images/use-dify/tutorial/workflow-101-lesson-08/select-react.png)
    </Frame>
    **なぜ ReAct を選ぶのか？**
  ...
  <Step title="モデルを選択する">
    ...
    <Frame>
      ![モデルを選択](/images/use-dify/tutorial/workflow-101-lesson-08/choose-a-model.png)
    </Frame>
  ...
  <Step title="ツールを追加する">
    ...
    <Frame>
      ![ツールを追加](/images/use-dify/tutorial/workflow-101-lesson-08/add-tool.png)
    </Frame>
  </Step>
  <Step title="指示を追加する">
    ...
    <Frame>
      ![指示を追加](/images/use-dify/tutorial/workflow-101-lesson-08/add-instructions.png)
    </Frame>
  </Step>
  <Step title="コンテキストとクエリ">
    ...
    **なぜ元の email_content ではなく item を使うのか？**
    ...
    <Frame>
      ![コンテキストとクエリ](/images/use-dify/tutorial/workflow-101-lesson-08/context-and-query.png)
    </Frame>
  </Step>
  <Step title="イテレーションの出力を設定する">
    ...
    <Frame>
      ![イテレーション出力を設定](/images/use-dify/tutorial/workflow-101-lesson-08/iteration-output.png)
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="最終編集者（LLM）">
    ...
    3. User Message に answers、email content、customer name をそれぞれ対応する変数に置き換えて追加します。現在の LLM ノードは以下のようになります。
        ...
        <Frame>
          ![最終 LLM](/images/use-dify/tutorial/workflow-101-lesson-08/final-llm.png)
        </Frame>
  </Step>
  <Step title="出力ノードを追加する">
    ...
    <Frame>
      ![出力ノードを追加](/images/use-dify/tutorial/workflow-101-lesson-08/add-output-node.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![最終ワークフロー](/images/use-dify/tutorial/workflow-101-lesson-08/final-workflow.png)
</Frame>

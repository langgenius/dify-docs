...
<Note> ⚠️ このドキュメントは AI によって自動翻訳されています。不正確な部分がある場合は、[英語版](/en/self-host/use-dify/tutorials/workflow-101/lesson-05) を参照してください。</Note>
...
<Frame>
  ![If/Else ノード](/images/use-dify/tutorial/workflow-101-lesson-05/if-else-node.png)
</Frame>
...
<Steps>
  ...
  <Step title="ルールを設定する">
    ...
    <Frame>
      ![条件を追加](/images/use-dify/tutorial/workflow-101-lesson-05/settings-01.png)
    </Frame>
    3. 判断ロジック：**Contains** のまま維持し、入力ボックスに **Dify** と入力します。

    <Frame>
      ![Contains 条件](/images/use-dify/tutorial/workflow-101-lesson-05/settings-02.png)
    </Frame>
...
<Frame>
  ![IF 分岐を接続](/images/use-dify/tutorial/workflow-101-lesson-05/connect-if-branch.png)
</Frame>
...
<Steps>
  ...
  <Step title="ユーザーメッセージを追加する">
    ...
    <Frame>
      ![LLM 2 のプロンプト](/images/use-dify/tutorial/workflow-101-lesson-05/final-prompt-for-llm-02.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![変数アグリゲーター](/images/use-dify/tutorial/workflow-101-lesson-05/variable-aggregator.png)
</Frame>
...
<Steps>
  <Step title="アグリゲーターを追加する">
    ...
    <Frame>
      ![変数アグリゲーターを追加](/images/use-dify/tutorial/workflow-101-lesson-05/add-variable-aggregator.png)
    </Frame>
  </Step>
  <Step title="パスを合流させる">
  ...
  <Step title="出力を割り当てる">
    ...
    <Frame>
      ![変数の割り当て](/images/use-dify/tutorial/workflow-101-lesson-05/assign-variable.png)
    </Frame>
  ...
  <Step title="最後のステップ">
    ...
    <Frame>
      ![出力変数を更新](/images/use-dify/tutorial/workflow-101-lesson-05/update-output-variable.png)
    </Frame>
    ワークフローは以下のようになります：

    <Frame>
      ![最終ワークフロー](/images/use-dify/tutorial/workflow-101-lesson-05/final-workflow.png)
    </Frame>
  </Step>
  <Step title="テストと実行">

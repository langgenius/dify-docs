...
<Note> ⚠️ このドキュメントは AI によって自動翻訳されています。不正確な部分がある場合は、[英語版](/en/self-host/use-dify/tutorials/workflow-101/lesson-06) を参照してください。</Note>
...
<Frame>
  ![パラメータ抽出](/images/use-dify/tutorial/workflow-101-lesson-06/parameter-extractor.png)
</Frame>
...
<Steps>
  <Step title="ノードを追加する">
    ...
    <Frame>
      ![パラメータ抽出を追加](/images/use-dify/tutorial/workflow-101-lesson-06/add-parameter-extractor.png)
    </Frame>
  </Step>
  <Step title="入力を設定する">
    ...
    <Frame>
      ![入力を設定する](/images/use-dify/tutorial/workflow-101-lesson-06/set-the-input.png)
    </Frame>
  ...
  <Step title="抽出パラメータを追加する">
    **抽出パラメータ ** の横にある**プラス（+）** アイコンをクリックして、AI が探すべき内容の定義を始めます。名前は `question_list` とします。
    ...
    <Frame>
      ![抽出パラメータを追加する](/images/use-dify/tutorial/workflow-101-lesson-06/add-extract-parameter.png)
    </Frame>
    <Info>
      **パラメータの型**
  ...
  <Step title="抽出パラメータの追加を完了する">
    ...
    <Frame>
      ![抽出パラメータの追加を完了](/images/use-dify/tutorial/workflow-101-lesson-06/finish-add-extract-parameter.png)
    </Frame>
  </Step>
  <Step title="指示を追加する">
...
<Frame>
  ![イテレーション](/images/use-dify/tutorial/workflow-101-lesson-06/iteration.png)
</Frame>
...
<Steps>
  <Step title="ノードを追加する">
    ...
    <Frame>
      ![イテレーションノードを追加](/images/use-dify/tutorial/workflow-101-lesson-06/add-iteration.png)
    </Frame>
    **イテレーションの高度なオプション**
    ...
    <Frame>
      ![イテレーションの高度なオプション](/images/use-dify/tutorial/workflow-101-lesson-06/advanced-iteration-options.png)
    </Frame>
    **並列モード**：OFF（デフォルト）
  ...
  <Step title="ナレッジ検索ノードを追加する">
    ...
    <Frame>
      ![ナレッジ検索ノードを追加してクエリテキストを設定](/images/use-dify/tutorial/workflow-101-lesson-06/knowledge-retrieval-query-text.png)
    </Frame>
  </Step>
  <Step title="LLM ノードを追加する">
    ...
    **User**:
    ...
    <Frame>
      ![LLM ノードとプロンプトを追加](/images/use-dify/tutorial/workflow-101-lesson-06/add-llm-and-prompt.png)
    </Frame>
  ...
  <Step title="イテレーションの出力を設定する">
    ...
    <Frame>
      ![イテレーション出力を設定](/images/use-dify/tutorial/workflow-101-lesson-06/set-iteration-output.png)
    </Frame>
  </Step>
  <Step title="最終 LLM ノードを追加する">
    ...
    **User**:
    ...
    <Frame>
      ![最終 LLM ノードを追加](/images/use-dify/tutorial/workflow-101-lesson-06/add-final-llm-node.png)
    </Frame>
  </Step>
  <Step title="最終チェック">
    ...
    <Frame>
      ![出力変数を選択](/images/use-dify/tutorial/workflow-101-lesson-06/output-variable.png)
    </Frame>
  </Step>
</Steps>

...
<Note> ⚠️ このドキュメントは AI によって自動翻訳されています。不正確な部分がある場合は、[英語版](/en/self-host/use-dify/tutorials/workflow-101/lesson-07) を参照してください。</Note>
...
<Frame>
  ![ツール](/images/use-dify/tutorial/workflow-101-lesson-07/tools.png)
</Frame>
...
<Steps>
  ...
  <Step title="判定用 LLM ノードを追加する">
    ...
    <Frame>
      ![LLM 設定](/images/use-dify/tutorial/workflow-101-lesson-07/llm-settings.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![ワークフロープレビュー](/images/use-dify/tutorial/workflow-101-lesson-07/workflow-preview-01.png)
</Frame>
...
<Steps>
  <Step title="If/Else ノードを追加する">
    ...
    <Frame>
      ![If/Else ノードの追加](/images/use-dify/tutorial/workflow-101-lesson-07/add-if-else-node.png)
    </Frame>
  </Step>
  <Step title="検索ツールを追加する">
    ...
    <Frame>
      ![プラグインのインストール](/images/use-dify/tutorial/workflow-101-lesson-07/add-tools.png)
    </Frame>
  </Step>
  <Step title="Google Search をインストールする">
    ...
    <Frame>
      ![Google Search のインストール](/images/use-dify/tutorial/workflow-101-lesson-07/install-google-search.png)
    </Frame>
  </Step>
  <Step title="API キーを取得する">
    ...
    <Frame>
      ![Google Search の設定](/images/use-dify/tutorial/workflow-101-lesson-07/google-search-setup.png)
    </Frame>
    1. 「API Key 認証設定」をクリックし、「SerpApi から SerpApi API key を取得」をクリックします。SerpApi にサインインして、専用の API キーを取得してください。
       ...
       <Frame>
         ![API Key 認証設定](/images/use-dify/tutorial/workflow-101-lesson-07/api-key-authorization-configuration.png)
       </Frame>
    ...
    <Frame>
      ![クエリ文字列の追加](/images/use-dify/tutorial/workflow-101-lesson-07/add-query-string.png)
    </Frame>
  </Step>
  <Step title="2 つのパスを設定する">
    ...
    **User Message**：
    ...
    <Frame>
      ![LLM 2 のプロンプト](/images/use-dify/tutorial/workflow-101-lesson-07/llm-02-prompt.png)
    </Frame>
    **ナレッジベース回答パス**
    ...
    **User Message**：
    ...
    <Frame>
      ![LLM 3 のプロンプト](/images/use-dify/tutorial/workflow-101-lesson-07/prompt-llm-03.png)
    </Frame>
  </Step>
  <Step title="情報を統合する">
    ...
    <Frame>
      ![変数アグリゲーターの設定](/images/use-dify/tutorial/workflow-101-lesson-07/variable-aggregator-setup.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![ワークフロープレビュー 2](/images/use-dify/tutorial/workflow-101-lesson-07/workflow-preview-02.png)
</Frame>
...
<Steps>
  <Step title="イテレーションの出力を設定する">
    ...
    <Frame>
      ![イテレーション出力](/images/use-dify/tutorial/workflow-101-lesson-07/iteration-output.png)
    </Frame>
  </Step>
  <Step title="要約 LLM を接続する">
    ...
    **User Message**：
    ...
    <Frame>
      ![LLM 4 のプロンプト](/images/use-dify/tutorial/workflow-101-lesson-07/prompt-for-llm-04.png)
    </Frame>
  </Step>
  <Step title="出力ノードで仕上げる">
    ...
    <Frame>
      ![出力設定](/images/use-dify/tutorial/workflow-101-lesson-07/output-setup.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![最終ワークフロープレビュー](/images/use-dify/tutorial/workflow-101-lesson-07/final-workflow-preview.png)
</Frame>

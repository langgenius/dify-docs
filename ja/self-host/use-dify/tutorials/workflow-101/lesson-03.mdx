...
<Note> ⚠️ このドキュメントは AI によって自動翻訳されています。不正確な部分がある場合は、[英語版](/en/self-host/use-dify/tutorials/workflow-101/lesson-03) を参照してください。</Note>

<Frame>
  ![LLM ノード](/images/use-dify/tutorial/workflow-101-lesson-03/llm-node.png)
</Frame>
...
<Steps>
  <Step title="設定を開く">
    ...
    <Frame>
      ![設定](/images/use-dify/tutorial/workflow-101-lesson-03/llm-node-01.png)
    </Frame>
  </Step>
  <Step title="OpenAI プロバイダーをインストール">
    ...
    <Frame>
      ![OpenAI を選択](/images/use-dify/tutorial/workflow-101-lesson-03/llm-node-02.png)
    </Frame>
    <Frame>
      ![OpenAI をインストール](/images/use-dify/tutorial/workflow-101-lesson-03/install.png)
    </Frame>
  </Step>
  <Step title="キャンバスに戻る">
...
<Steps>
  ...
  <Step title="ノードを追加する">
    ...
    <Frame>
      ![ノードを追加](/images/use-dify/tutorial/workflow-101-lesson-03/add-the-node.png)
    </Frame>
  </Step>
  <Step title="ノードを接続する">
    ...
    <Frame>
      ![ノードを接続](/images/use-dify/tutorial/workflow-101-lesson-03/connect-the-nodes.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![プロンプトを追加](/images/use-dify/tutorial/workflow-101-lesson-03/prompt.png)
</Frame>
...
<Steps>
  ...
  <Step title="ユーザーメッセージを追加する">
    ...
    <Frame>
      ![ユーザーメッセージを追加](/images/use-dify/tutorial/workflow-101-lesson-03/add-user-message.png)
    </Frame>
    <Tip>
    ...
    <Frame>
      ![最終プロンプト](/images/use-dify/tutorial/workflow-101-lesson-03/final-prompt.png)
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="事前チェック">
    ...
    <Frame>
      ![チェックリスト](/images/use-dify/tutorial/workflow-101-lesson-03/checklist.png)
    </Frame>
  </Step>
  <Step title="警告を分析する">
  ...
  <Step title="問題を修正する">
    ...
    <Frame>
      ![問題を修正](/images/use-dify/tutorial/workflow-101-lesson-03/fix-the-issue.png)
    </Frame>
  </Step>
  <Step title="テスト実行">
    ...
    <Frame>
      ![テスト実行](/images/use-dify/tutorial/workflow-101-lesson-03/test-run.png)
    </Frame>
    <CodeGroup>
...
<Tip>
  **プロンプトジェネレーター** を活用して、より良いプロンプトを作成してみましょう！
  ...
  <Frame>
    ![プロンプトジェネレーター](/images/use-dify/tutorial/workflow-101-lesson-03/prompt-generator.png)
  </Frame>
</Tip>
...
<Note> ⚠️ このドキュメントは AI によって自動翻訳されています。不正確な部分がある場合は、[英語版](/en/self-host/use-dify/knowledge/create-knowledge/import-text-data/sync-from-website) を参照してください。</Note>

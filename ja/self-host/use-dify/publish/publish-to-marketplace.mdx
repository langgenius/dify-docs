...
テンプレート名、概要、セットアップ手順、アプリ内コンテンツは、すべて提出時に選択した言語で記述してください。
...
テンプレート全体で使用する言語を選択し、ユーザーが言語フィルターで見つけられるようにします。
...
- テンプレート名、概要、セットアップ手順、アプリ内コンテンツが、すべて提出時に選択した言語で記述されていること。

...
テンプレートを公開するには、[クリエイターセンター](https://creators.dify.ai) から提出します。自分で管理する場合は個人アカウント、チームで管理する場合は組織から提出します。提出後、テンプレートは **Pending** ステータスになります。承認されると、マーケットプレイスに公開されます。
...
公開後は、[**テンプレート**](https://creators.dify.ai/dashboard/templates) ページで利用数、総合評価、評価件数、いいね総数を確認できます。[**受信トレイ**](https://creators.dify.ai/dashboard/inbox) では、個々の評価やいいね、非公開フィードバックを確認できます。

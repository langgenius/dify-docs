...
提出前に、テンプレートの管理先を選択します。

- **個人アカウント**：自分だけがテンプレートを閲覧および管理できます。
- **組織**：すべての組織メンバーがテンプレートを閲覧および管理できます。提出前に組織を選択します。必要に応じて、組織を作成してメンバーを招待します。
...
公開後、クリエイターセンターの次のページで確認できます。

- [**テンプレート**](https://creators.dify.ai/dashboard/templates)：各テンプレートの利用数、総合評価、評価件数、いいね総数を一覧で確認できます。
- [**受信トレイ**](https://creators.dify.ai/dashboard/inbox)：個々の評価やいいね、非公開フィードバックを確認できます。

選択中の個人アカウントまたは組織によって、両方のページに表示されるテンプレートとユーザーからの反応が決まります。

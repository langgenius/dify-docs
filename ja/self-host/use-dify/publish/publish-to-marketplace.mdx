...
- **個人**：個人で活動するクリエイター向けです。個人アカウントで提出したテンプレートをクリエイターセンターで表示、管理できるのは、本人だけです。クリエイターセンターへの初回ログイン時は、個人アカウントが選択されています。

- **組織**：チームでテンプレートを共同管理する場合に使用します。組織を作成してメンバーを招待し、テンプレートの提出前にその組織を選択します。組織で提出したテンプレートは、すべてのメンバーが管理できます。
...
公開後は、クリエイターセンターの **テンプレート** ページで利用状況、総合評価、いいねの合計を確認できます。**受信トレイ** では、選択中の個人アカウントまたは組織が所有するテンプレートへの評価、いいね、非公開フィードバックを確認できます。

...
<Note> ⚠️ このドキュメントは AI によって自動翻訳されています。不正確な部分がある場合は、[英語版](/en/self-host/use-dify/publish/publish-to-marketplace) を参照してください。</Note>
...
- 最新のコミュニティ版でアプリを少なくとも一度実行し、期待どおりに動作することを確認してください。マーケットプレイスは、最新のコミュニティ版リリースとの互換性についてアプリテンプレートを審査します。
</Note>

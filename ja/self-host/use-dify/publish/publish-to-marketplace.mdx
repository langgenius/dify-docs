...
公開後は、[**テンプレート**](https://creators.dify.ai/dashboard/templates) ページで利用数、総合評価、評価件数、いいね総数を確認できます。個々の評価やいいね、非公開フィードバックは、[**受信トレイ**](https://creators.dify.ai/dashboard/inbox) で確認できます。

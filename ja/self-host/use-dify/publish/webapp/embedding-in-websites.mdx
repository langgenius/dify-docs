...
<Steps>
  <Step title="埋め込みトークンを取得">
    Dify アプリで **アクセスポイント** タブを開き、**Web アプリ** カードの **サイトに埋め込む** をクリックして、固有のトークンを確認します。
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="フォームと Workflow アプリ">
...
- アプリトークンが、アプリの **アクセスポイント** タブの **サイトに埋め込む** に表示されているものと一致していることを確認します

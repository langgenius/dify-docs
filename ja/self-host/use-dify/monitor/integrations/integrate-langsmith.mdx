...
> このドキュメントは AI によって自動翻訳されています。不正確な部分がある場合は、[英語版](/en/self-host/use-dify/monitor/integrations/integrate-langsmith) を参照してください。
...
#### Workflow/Chatflow のトレース情報

Workflow や Chatflow を追跡するために使用されます。

...
---
<Note> ⚠️ このドキュメントは AI によって自動翻訳されています。不正確な部分がある場合は、[英語版](/en/self-host/use-dify/monitor/analysis) を参照してください。</Note>

ダッシュボードは、アプリケーションのパフォーマンスを示すために、時間の経過に伴う 4 つの指標を追跡します：

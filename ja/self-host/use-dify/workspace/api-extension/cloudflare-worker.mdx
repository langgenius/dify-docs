---
title: Cloudflare Workers を使用したカスタム API のデプロイ
---

> このドキュメントは AI によって自動翻訳されています。不正確な部分がある場合は、[英語版](/en/self-host/use-dify/workspace/api-extension/cloudflare-worker) を参照してください。

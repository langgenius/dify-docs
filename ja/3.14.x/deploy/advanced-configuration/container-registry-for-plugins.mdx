...
各種イメージをプライベートレジストリに同期する方法については、[プライベートレジストリへのイメージ同期手順](/ja/3.14.x/deploy/advanced-configuration/container-registry#syncing-images-to-a-private-registry) をご参照ください。
...
**設定** > **データソース** に移動し、**Firecrawl** カードで API キーを追加します。カードが表示されない場合は、先に Dify Marketplace から Firecrawl データソースプラグインをインストールしてください。
...
**設定** > **データソース** に移動し、**Jina Reader** カードで API キーを追加します。カードが表示されない場合は、先に Dify Marketplace から Jina Reader データソースプラグインをインストールしてください。

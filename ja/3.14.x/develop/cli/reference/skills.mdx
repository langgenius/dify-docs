...
その発見の仕組みは [help リファレンス](/ja/3.14.x/develop/cli/reference/help#機械可読ヘルプ) を、統合の全体像は [difyctl スキルをインストールする](/ja/3.14.x/develop/cli/integrate-agents/install-the-difyctl-skill) を参照してください。

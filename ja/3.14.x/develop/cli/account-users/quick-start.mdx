...
始める前に、`difyctl` が [インストール](/ja/3.14.x/develop/cli/install) されていることを確認してください。
...
1. 会社の Dify ホストにサインインします。利用しているインスタンスの [コンソール API URL](/ja/3.14.x/deploy/advanced-configuration/environment-variables#console_api_url) を使用します。
...
- **すぐにコピーして使える日常的なコマンド**：[よくあるタスク](/ja/3.14.x/develop/cli/account-users/common-tasks)
- **token の保存場所とセッションの仕組み**：[認証](/ja/3.14.x/develop/cli/account-users/authenticate)
- **`difyctl` でできるその他すべて**：[コマンド一覧](/ja/3.14.x/develop/cli/reference/command-index)

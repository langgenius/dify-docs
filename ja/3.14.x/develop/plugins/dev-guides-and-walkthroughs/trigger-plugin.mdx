...
<Tabs>
    <Tab title="github.yaml">
        ...
        - `oauth_schema`（オプション）：OAuth によるサブスクリプション作成に必要です。定義方法の詳細については、[ツールプラグインに OAuth サポートを追加する](/ja/3.14.x/develop/plugins/dev-guides-and-walkthroughs/tool-oauth) を参照してください。
    </Tab>
    <Tab title="github.py">

...
description: プロジェクトのセットアップ、プロバイダー設定からモデル実装、デバッグ、公開まで、モデルプロバイダープラグインを構築します。
---

## 前提条件

- [Dify プラグイン CLI](/ja/3.14.x/develop/plugins/getting-started/cli)
...
<Frame>
  ![モデルプラグインの権限](https://assets-docs.dify.ai/2024/12/10f3b3ee6c03a1215309f13d712455d4.png)
</Frame>
...
完全なモデルプロバイダー YAML 仕様については、[モデルスキーマ](/ja/3.14.x/develop/plugins/features-and-specs/plugin-types/model-schema) を参照してください。
...
- [モデル設計ルール](/ja/3.14.x/develop/plugins/features-and-specs/plugin-types/model-designing-rules)：事前定義モデルを統合するための標準。
- [モデルスキーマ](/ja/3.14.x/develop/plugins/features-and-specs/plugin-types/model-schema)：モデル設定ファイルの標準。
...
公開プロセスの詳細については、[公開の概要](/ja/3.14.x/develop/plugins/publishing/marketplace-listing/release-overview) を参照してください。

## 参考リソース

- [新しいモデルのクイック統合](/ja/3.14.x/develop/plugins/dev-guides-and-walkthroughs/creating-new-model-provider)：既存のプロバイダーに新しいモデルを追加する方法。
- [プラグイン開発の基本概念](/ja/3.14.x/develop/plugins/getting-started/getting-started-dify-plugin)：プラグイン開発入門ガイドに戻る。
- [モデルスキーマ](/ja/3.14.x/develop/plugins/features-and-specs/plugin-types/model-schema)：詳細なモデル設定仕様。
- [一般仕様](/ja/3.14.x/develop/plugins/features-and-specs/plugin-types/general-specifications)：プラグインマニフェストファイルの設定。

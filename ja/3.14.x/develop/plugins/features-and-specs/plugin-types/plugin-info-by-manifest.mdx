...
プラグインの全体的なアーキテクチャについては、[プラグイン開発の基本概念](/ja/3.14.x/develop/plugins/getting-started/getting-started-dify-plugin) と [開発者チートシート](/ja/3.14.x/develop/plugins/dev-guides-and-walkthroughs/cheatsheet) を参照してください。
...
<ParamField path="plugins" type="object" required>
  ...
  <ParamField path="tools" type="array[string]">
    [ツール](/ja/3.14.x/develop/plugins/dev-guides-and-walkthroughs/tool-plugin) provider のプラグイン拡張。
  </ParamField>
  
  <ParamField path="models" type="array[string]">
    [モデル](/ja/3.14.x/develop/plugins/features-and-specs/plugin-types/model-designing-rules) provider のプラグイン拡張。
  </ParamField>
  
  <ParamField path="endpoints" type="array[string]">
    [Endpoints](/ja/3.14.x/develop/plugins/dev-guides-and-walkthroughs/develop-a-slack-bot-plugin) provider のプラグイン拡張。
  </ParamField>
  
  <ParamField path="agent_strategies" type="array[string]">
    [Agent 戦略](/ja/3.14.x/develop/plugins/features-and-specs/advanced-development/reverse-invocation) provider のプラグイン拡張。
  </ParamField>
</ParamField>
...
<ParamField path="privacy" type="string">
  プラグインのプライバシーポリシーの相対パスまたは URL。例：`"./privacy.md"` または `"https://your-web/privacy"`。**Dify マーケットプレイスへの掲載には必須**であり、プラグインはユーザーデータの利用方法を明確に記載する必要があります。詳細については、[プラグインプライバシーデータ保護ガイドライン](/ja/3.14.x/develop/plugins/publishing/standards/privacy-protection-guidelines) を参照してください。
</ParamField>

...
<Tabs>
  <Tab title="Workspace">
  **管理バックエンド** → **認証** → **メンバー** → **SSO アイデンティティプロバイダー** → **New Identity Provider** → **New OIDC Provider** をクリックし、一番下に記載のある Callback URL を取得します。
  ...
  **管理バックエンド** → **認証** → **Web App 外部ユーザー認証** → **SSO アイデンティティプロバイダー** → **New Identity Provider** → **New OIDC Provider** をクリックし、一番下に記載のある Callback URL を取得します。

...
プラグインを Dify マーケットプレイスに公開するには、[マーケットプレイス向けの準備と検証要件](/ja/develop-plugin/publishing/marketplace-listing/submit-plugin-to-marketplace#パッケージの準備) を満たしていることを確認してください。レビューに合格すると、パッケージがメインブランチにマージされ、マーケットプレイスのパイプラインから公開されます。

...
プラグインを Dify Marketplace に公開するには、[Marketplace の準備と検証要件](/ja/develop-plugin/publishing/marketplace-listing/prepare-plugin-for-marketplace) を満たしていることを確認してください。レビューに合格すると、パッケージがメインブランチにマージされ、Marketplace パイプラインから公開されます。

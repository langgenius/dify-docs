...
完全なモデルプロバイダー YAML 仕様については、[モデルスキーマ](/en/develop-plugin/features-and-specs/plugin-types/model-schema)ドキュメントを参照してください。
...
* [モデル設計ルール](/en/develop-plugin/features-and-specs/plugin-types/model-designing-rules) - 事前定義モデルを統合するための標準
* [モデルスキーマ](/en/develop-plugin/features-and-specs/plugin-types/model-schema) - モデル設定ファイルの標準
...
公開プロセスの詳細については、[公開の概要](/en/develop-plugin/publishing/marketplace-listing/release-overview)を参照してください。

## 参考リソース

- [新しいモデルのクイック統合](/en/develop-plugin/dev-guides-and-walkthroughs/creating-new-model-provider) - 既存のプロバイダーに新しいモデルを追加する方法
- [プラグイン開発の基本概念](/en/develop-plugin/getting-started/getting-started-dify-plugin) - プラグイン開発入門ガイドに戻る
- [モデルスキーマ](/en/develop-plugin/features-and-specs/plugin-types/model-schema) - 詳細なモデル設定仕様を学ぶ
- [一般仕様](/en/develop-plugin/features-and-specs/plugin-types/general-specifications) - プラグインマニフェストファイルの設定を学ぶ

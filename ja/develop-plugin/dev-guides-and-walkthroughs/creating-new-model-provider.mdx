...
完全なモデルプロバイダー YAML 仕様については、[モデルスキーマ](/plugin-dev-en/0412-model-schema)ドキュメントを参照してください。
...
* [モデル設計ルール](/plugin-dev-en/0411-model-designing-rules) - 事前定義モデルを統合するための標準
* [モデルスキーマ](/plugin-dev-en/0412-model-schema) - モデル設定ファイルの標準
...
公開プロセスの詳細については、[公開の概要](/plugin-dev-en/0321-release-overview)を参照してください。

## 参考リソース

- [新しいモデルのクイック統合](/plugin-dev-en/0211-getting-started-new-model) - 既存のプロバイダーに新しいモデルを追加する方法
- [プラグイン開発の基本概念](/plugin-dev-en/0111-getting-started-dify-plugin) - プラグイン開発入門ガイドに戻る
- [モデルスキーマ](/plugin-dev-en/0412-model-schema) - 詳細なモデル設定仕様を学ぶ
- [一般仕様](/plugin-dev-en/0411-general-specifications) - プラグインマニフェストファイルの設定を学ぶ

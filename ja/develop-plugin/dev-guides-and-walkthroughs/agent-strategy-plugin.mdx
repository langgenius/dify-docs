...
プラグインパッケージを [Dify プラグインリポジトリ](https://github.com/langgenius/dify-plugins) に提出できます。提出前に、[Marketplace の準備と検証要件](/ja/develop-plugin/publishing/marketplace-listing/prepare-plugin-for-marketplace) を満たしていることを確認してください。承認されると、パッケージがメインブランチにマージされ、Marketplace パイプラインから公開されます。

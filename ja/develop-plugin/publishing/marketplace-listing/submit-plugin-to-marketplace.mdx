...
クリエイターセンターがその組織を公開者として確認すると、組織名義で公開されたプラグインが **プラグイン** ページに表示されます。チームメンバーを招待すると、それぞれが GitHub アカウントを連携しなくても同じプラグインを確認できます。
...
申請状況は **申請履歴** で確認できます。承認されると、その公開者のすべてのプラグインを確認できます。却下された場合は理由を確認し、**新規申請** を選択して証拠を更新し、再提出してください。

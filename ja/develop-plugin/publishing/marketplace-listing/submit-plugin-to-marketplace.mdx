...
language: ja
title: マーケットプレイスにプラグインを公開
sidebarTitle: マーケットプレイス
description: .difypkg を準備、検証してマーケットプレイスの審査に提出し、Pull Request への対応と公開後の管理を行います
---
...
Dify マーケットプレイスにプラグインを公開するには、`.difypkg` を 1 つ準備して検証し、[`langgenius/dify-plugins`](https://github.com/langgenius/dify-plugins) に提出します。

Pull Request では自動チェックが実行され、メンテナーのレビューに進みます。チェックまたはレビュアーから対応を求められた場合だけ、修正してください。

承認、マージ、最終検証を経て、パッケージがマーケットプレイスに公開されます。
...
## クリエイターセンターでの公開済みプラグイン管理 {#manage-published-plugins}

プラグインがマーケットプレイスに表示されたら、[クリエイターセンター](https://creators.dify.ai/) の **プラグイン** ページで確認、管理できます。個別の評価、いいね、非公開フィードバックは **受信トレイ** で確認できます。
...
<Frame caption="Marketplace 詳細ページのプラグイン ID">
  ![Marketplace 詳細ページのプラグイン ID](/images/develop-plugin/publish/marketplace-plugin-id.png)
</Frame>

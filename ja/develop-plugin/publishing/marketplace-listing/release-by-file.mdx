...
- [Dify プラグイン CLI](/ja/develop-plugin/getting-started/cli) がインストールされていること。`dify version` を実行して確認します。
...
<CardGroup cols={2}>
  ...
  <Card title="マーケットプレイスに提出" icon="store" href="/ja/develop-plugin/publishing/marketplace-listing/prepare-plugin-for-marketplace">
...
- [Dify プラグイン CLI](/ja/develop-plugin/getting-started/cli)

---
title: Flomo Notes Plugin in 10 Minutes
description: 'Learn how to build a functional Dify plugin that connects with Flomo note-taking service in just 10 minutes'
language: en
standard_title: Flomo Notes Plugin in 10 Minutes
---

Launch a fully functional integration in one focused sprint. In this tutorial you will connect Dify to Flomo, wire up authentication, and polish the experience for marketplace distribution in under ten minutes.
...
<Steps>
  <Step title="Set up debug environment">
    Use the [Remote Debugging Playbook](/plugin-dev-en/0411-remote-debug-a-plugin) to copy `.env.example`, paste in your workspace host, port, and debug key, and confirm the CLI connection details. The dashboard screens referenced there match what you'll see in this workflow.
  </Step>

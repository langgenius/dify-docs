...
dimensions:
  type:
    ...
    detail: advanced
  level: advanced
standard_title: Customize Models with Reverse Invocation
language: en
title: Customize Models with Reverse Invocation
...
Bring your self-hosted or niche models into Dify while keeping the user experience consistent. This playbook uses Xinference as a pattern you can adapt to any custom deployment.

...
dimensions:
  type:
    ...
    detail: deployment
  level: beginner
standard_title: Automate Marketplace Publishing with PRs
language: en
title: Automate Marketplace Publishing with PRs
...
Turn release day into a single pull request. This workflow blueprint uses GitHub Actions to package your plugin, open a marketplace PR, and keep every launch consistent without manual steps.
...
[Edit this page](https://github.com/langgenius/dify-docs/edit/main/plugin-dev-en/0321-plugin-auto-publish-pr.mdx) | [Report an issue](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)

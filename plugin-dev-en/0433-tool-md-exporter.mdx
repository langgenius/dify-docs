...
description: |
    Author [Bowen Liang](https://github.com/bowenliang123).
...
The in-advance conception would be the key to make it as one of most popular plugins in [Dify Marketplace](https://marketplace.dify.ai).

And it satisfies the following scopes and requirements:

### **Decide Dify Plugin Type To Build**
    - Tool plugin in this case. It provides in high-code skills and leverages the existed Python runtime libraries and SDK

...
This article describes how to develop a data source plugin, covering the plugin structure, code samples, debugging methods, and publishing process to help you quickly develop and launch your data source plugin.

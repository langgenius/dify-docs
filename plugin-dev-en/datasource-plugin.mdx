...
<Info>
  ...
  To configure OAuth, see [Add OAuth Support to Your Tool Plugin](/plugin-dev-en/tool-oauth).
</Info>
...
[Edit this page](https://github.com/langgenius/dify-docs/edit/main/plugin-dev-en/datasource-plugin.mdx) | [Report an issue](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)

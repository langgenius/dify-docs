...
dimensions:
  type:
    ...
    detail: examples
  level: intermediate
standard_title: Design a Webhook Endpoint Plugin
language: en
title: Design a Webhook Endpoint Plugin
...
Expose your service as a reliable webhook endpoint that any workspace can consume. This guide breaks down the configuration, YAML structure, and handler implementation using the Neko Cat project as a template.

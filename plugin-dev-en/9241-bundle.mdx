...
For detailed instructions on how to prepare the plugin development scaffolding tool, please refer to [Initialize Development Tools](/plugin-dev-en/0221-initialize-development-tools).

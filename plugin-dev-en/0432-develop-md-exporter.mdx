---
title: Create a Markdown Exporter Plugin
description: 'Learn how to create a plugin that exports conversations to different document formats'
language: en
standard_title: Create a Markdown Exporter Plugin
---

Transform conversations into polished documents your users can share. This tutorial guides you through building an exporter plugin that delivers professional Word and PDF outputs with minimal setup.
...
<Steps>
  <Step title="Set up your debug environment">
    Follow the [Remote Debugging Playbook](/plugin-dev-en/0411-remote-debug-a-plugin) to copy `.env.example`, add your workspace host, port, and debug key, then return here once the environment variables are in place.
  </Step>

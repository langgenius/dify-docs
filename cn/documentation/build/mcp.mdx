...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考[英文原版](/en/documentation/build/mcp)。</Note>
...
<Note>
  本内容涵盖在 Dify 中使用 MCP 工具。要将 Dify 应用程序发布为 MCP 服务器，请参阅[这里](/cn/documentation/publish/publish-mcp)。
</Note>

...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考[英文原版](/en/documentation/build/predefined-error-handling-logic)。</Note>


![](https://assets-docs.dify.ai/2024/12/6e2655949889d4d162945d840d698649.png)
[大型语言模型](/en/documentation/nodes/llm)、[HTTP](/en/documentation/nodes/http-request)、[代码](/en/documentation/nodes/code) 和 [工具](/en/documentation/nodes/tools) 
...
- `error_type` - 发生了什么类型的错误（参见 [错误类型](cn/documentation/debug/error-type)）

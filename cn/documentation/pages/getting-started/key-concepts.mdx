...
您可以指定如何以及何时启动工作流。有两种类型的开始节点：

- **[用户输入](/cn/pages/documentation/nodes/user-input)**：通过直接用户交互或 API 调用触发应用程序。

- **[触发器](/cn/pages/documentation/nodes/trigger/overview)**：应用程序按计划自动运行或响应特定的第三方事件。
...
与工作流不同，对话流不能使用[触发器](/cn/pages/documentation/nodes/trigger/overview)来启动。
...
**输入**：你可以在[用户输入](/cn/pages/documentation/nodes/user-input)节点为你的应用最终用户指定任意数量的输入变量来填写。

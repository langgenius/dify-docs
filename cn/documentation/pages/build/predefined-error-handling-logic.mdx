...
[大型语言模型](/en/documentation/pages/nodes/llm)、[HTTP](/en/documentation/pages/nodes/http-request)、[代码](/en/documentation/pages/nodes/code) 和 [工具](/en/documentation/pages/nodes/tools) 
...
- `error_type` - 发生了什么类型的错误（参见 [错误类型](cn/documentation/pages/debug/error-type)）

...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考[英文原版](/en/documentation/publish/webappwebapp/chatflow-webapp)。</Note>
...
<Info>
有关详细的引用与归属设置，请参阅[引用与归属](/cn/documentation/knowledge/retrieval-test-and-citation)。
</Info>

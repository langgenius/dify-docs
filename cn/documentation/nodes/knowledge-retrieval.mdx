...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考[英文原版](/en/documentation/nodes/knowledge-retrieval)。</Note>
...
<Info>
  在使用此节点之前，请先创建并填充知识库。请参阅[知识库创建指南](/cn/documentation/knowledge/create-knowledge)获取设置说明。
</Info>

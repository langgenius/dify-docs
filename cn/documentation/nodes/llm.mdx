...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考[英文原版](/en/documentation/nodes/llm)。</Note>
...
<Info>
  在使用大型语言模型节点之前，请先在**系统设置 → 模型供应商**中配置至少一个模型供应商。请参阅[模型配置指南](/cn/documentation/workspace/model-providers)了解设置说明。
</Info>

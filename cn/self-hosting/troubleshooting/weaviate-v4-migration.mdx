...
---
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考[英文原版](/en/self-hosting/troubleshooting/weaviate-v4-migration)。</Note>
...
- [Dify 自托管指南](/cn/self-hosting/installation/docker-compose)
- [Dify 环境变量](/cn/self-hosting/configuration/environments)

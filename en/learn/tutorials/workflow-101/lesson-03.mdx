...
<Frame>
  ![LLM Node](/images/use-dify/tutorial/workflow-101-lesson-03/llm-node.png)
</Frame>
...
<Steps>
  <Step title="Open Integrations">
    ...
    <Frame>
      ![Model Provider](/images/use-dify/tutorial/workflow-101-lesson-03/llm-node-01.png)
    </Frame>
  </Step>
  <Step title="Install OpenAI Provider">
    ...
    <Frame>
      ![Choose OpenAI](/images/use-dify/tutorial/workflow-101-lesson-03/llm-node-02.png)
    </Frame>
    <Frame>
      ![Install OpenAI](/images/use-dify/tutorial/workflow-101-lesson-03/install.png)
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Add the Node">
    ...
    <Frame>
      ![Add the Node](/images/use-dify/tutorial/workflow-101-lesson-03/add-the-node.png)
    </Frame>
  </Step>
  <Step title="Connect the Nodes">
    ...
    <Frame>
      ![Connect the Nodes](/images/use-dify/tutorial/workflow-101-lesson-03/connect-the-nodes.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![Add Prompt](/images/use-dify/tutorial/workflow-101-lesson-03/prompt.png)
</Frame>
...
<Steps>
  ...
  <Step title="Add User Messages">
    ...
    <Frame>
      ![Add User Message](/images/use-dify/tutorial/workflow-101-lesson-03/add-user-message.png)
    </Frame>
    <Tip>
    ...
    <Frame>
      ![Final Prompt](/images/use-dify/tutorial/workflow-101-lesson-03/final-prompt.png)
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="The Pre-flight Check">
    ...
    <Frame>
      ![Checklist](/images/use-dify/tutorial/workflow-101-lesson-03/checklist.png)
    </Frame>
  </Step>
  ...
  <Step title="Fix the Issue">
    ...
    <Frame>
      ![Fix the Issue](/images/use-dify/tutorial/workflow-101-lesson-03/fix-the-issue.png)
    </Frame>
  </Step>
  <Step title="Make a Test Run">
    ...
    <Frame>
      ![Test Run](/images/use-dify/tutorial/workflow-101-lesson-03/test-run.png)
    </Frame>
    <CodeGroup>
...
<Tip>
  ...
  <Frame>
    ![Prompt Generator](/images/use-dify/tutorial/workflow-101-lesson-03/prompt-generator.png)
  </Frame>
</Tip>
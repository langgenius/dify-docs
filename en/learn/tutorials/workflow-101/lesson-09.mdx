...
<Steps>
  <Step title="Check the Product Support Agent">
    ...
    <Frame>
      ![Add the Body-Only Rule to Agent Task](/images/use-dify/tutorial/workflow-101-lesson-09/update-agent-task.png)
    </Frame>
  </Step>
  <Step title="Add a Template Node">
    ...
    <Frame>
      ![Insert a Template Node Before Output](/images/use-dify/tutorial/workflow-101-lesson-09/template-node.png)
    </Frame>
  </Step>
  <Step title="Set the Input Variables">
    ...
    <Frame>
      ![Add the Customer and Body Variables](/images/use-dify/tutorial/workflow-101-lesson-09/add-input-variable.png)
    </Frame>
  </Step>
  ...
  <Step title="Update the Output Node">
    ...
    <Frame>
      ![Point the Output at the Template](/images/use-dify/tutorial/workflow-101-lesson-09/output-node.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![The Final Workflow with the Template Node](/images/use-dify/tutorial/workflow-101-lesson-09/final-workflow.png)
</Frame>

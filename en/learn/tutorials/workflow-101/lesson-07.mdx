---
title: "Lesson 7: Enhance Workflows (Tools)"
...
<Frame>
  ![Tools](/images/use-dify/tutorial/workflow-101-lesson-07/tools.png)
</Frame>
...
<Steps>
  ...
  <Step title="Add the Judge (LLM Node)">
    ...
    <Frame>
      ![LLM Settings](/images/use-dify/tutorial/workflow-101-lesson-07/llm-settings.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![Workflow Preview](/images/use-dify/tutorial/workflow-101-lesson-07/workflow-preview-01.png)
</Frame>
...
<Steps>
  <Step title="Add If/Else Node">
    ...
    <Frame>
      ![Add if/Else Node](/images/use-dify/tutorial/workflow-101-lesson-07/add-if-else-node.png)
    </Frame>
  </Step>
  <Step title="Add Tool for Searching">
    ...
    <Frame>
      ![Install Tool](/images/use-dify/tutorial/workflow-101-lesson-07/add-tools.png)
    </Frame>
  </Step>
  <Step title="Install Google Search">
    ...
    <Frame>
      ![Install Google Search](/images/use-dify/tutorial/workflow-101-lesson-07/install-google-search.png)
    </Frame>
  </Step>
  <Step title="Get Your API Key">
    ...
    <Frame>
      ![Google Search Setup](/images/use-dify/tutorial/workflow-101-lesson-07/google-search-setup.png)
    </Frame>
    1. Click API Key Authorization Configuration, then click Get your SerpApi API key from SerpApi. Sign in to get your private API key.
       ...
       <Frame>
         ![API Key Authorization Configuration](/images/use-dify/tutorial/workflow-101-lesson-07/api-key-authorization-configuration.png)
       </Frame>
    ...
    <Frame>
      ![Add Query String](/images/use-dify/tutorial/workflow-101-lesson-07/add-query-string.png)
    </Frame>
  </Step>
  <Step title="Configure the Two Paths">
    ...
    **User Message**:
    ...
    <Frame>
      ![Prompt for LLM 2](/images/use-dify/tutorial/workflow-101-lesson-07/llm-02-prompt.png)
    </Frame>
    ...
    **User Message**:
    ...
    <Frame>
      ![Prompt for LLM 3](/images/use-dify/tutorial/workflow-101-lesson-07/prompt-llm-03.png)
    </Frame>
  </Step>
  <Step title="Combine the Information">
    ...
    <Frame>
      ![Variable Aggregator Setup](/images/use-dify/tutorial/workflow-101-lesson-07/variable-aggregator-setup.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![Workflow Preview 2](/images/use-dify/tutorial/workflow-101-lesson-07/workflow-preview-02.png)
</Frame>
...
<Steps>
  <Step title="Configure Iteration Output">
    ...
    <Frame>
      ![Iteration Output](/images/use-dify/tutorial/workflow-101-lesson-07/iteration-output.png)
    </Frame>
  </Step>
  <Step title="Connect the Summary LLM">
    ...
    **User Message**:
    ...
    <Frame>
      ![Prompt for LLM 4](/images/use-dify/tutorial/workflow-101-lesson-07/prompt-for-llm-04.png)
    </Frame>
  </Step>
  <Step title="Finalize with the Output Node">
    ...
    <Frame>
      ![Output Setup](/images/use-dify/tutorial/workflow-101-lesson-07/output-setup.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![Final Workflow Preview](/images/use-dify/tutorial/workflow-101-lesson-07/final-workflow-preview.png)
</Frame>

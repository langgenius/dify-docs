...
<Steps>
  <Step title="sssCreate from Blank">
    Click on **Studio** at the top of the screen. Under Create App on the left, click **Create from Blank**.

    <Frame>
      ![Create the App](/images/use-dify/tutorial/workflow-101-lesson-02/creating-the-app.png)
    </Frame>
  </Step>
  <Step title="Configure App Type">
    ...
    <Frame>
      ![App Name & Icon](/images/use-dify/tutorial/workflow-101-lesson-02/create-workflow.png)
    </Frame>
  </Step>
  <Step title="Choose Start Node Type">
    ...
    <Frame>
      ![Trigger](/images/use-dify/tutorial/workflow-101-lesson-02/trigger.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![Orchestration Studio](/images/use-dify/tutorial/workflow-101-lesson-02/orchestration-studio.png)
</Frame>
...
<Frame>
  ![Start Node](/images/use-dify/tutorial/workflow-101-lesson-02/start-node.png)
</Frame>
...
<Frame>
  ![Output](/images/use-dify/tutorial/workflow-101-lesson-02/output.png)
</Frame>
...
<Steps>
  ...
  <Step title="Configure the Start Node (Prep Ingredients)">
    ...
    <Frame>
      ![User Input Field](/images/use-dify/tutorial/workflow-101-lesson-02/input-field.png)
    </Frame>

    2. In the popup, we will create two variables (two storage boxes):
       **Variable 1 (For the Customer Name)**
       <Frame>
         ![Add First Variable](/images/use-dify/tutorial/workflow-101-lesson-02/variable-01.png)
       </Frame>
       ...
       **Variable 2 (For the Email Content)**
       <Frame>
         ![Add Second Variable](/images/use-dify/tutorial/workflow-101-lesson-02/variable-02.png)
       </Frame>
  ...
  <Step title="Create the End Node (Set the Goal)">
    ...
    <Frame>
      ![Create the End Node](/images/use-dify/tutorial/workflow-101-lesson-02/create-end-node.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![Start Node and Output](/images/use-dify/tutorial/workflow-101-lesson-02/basic-workflow.png)
</Frame>

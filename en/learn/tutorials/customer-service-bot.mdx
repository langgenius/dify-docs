...
After publishing the application, open its **Access Point** tab and select **Embed Into Site** on the **Web App** card. Choose a suitable embedding method, and paste the code into the appropriate location on the webpage.

...
<div className="max-w-5xl mx-auto px-6 py-16">
  ...
  <div className="mt-6">
    <Columns cols={4}>
      <Card title="API Reference" icon="code" href="/en/api-reference/chat-messages/send-chat-message">
        Integrate Dify applications into your own product through the REST API.
      </Card>
      <Card title="CLI" icon="terminal" href="/en/cli/overview">
        Run your Dify apps from terminals, scripts, CI, and AI agents with difyctl.
      </Card>

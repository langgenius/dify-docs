...
The agent acts as whoever signed in, whether an account user or an SSO user, so sign in with the identity it should use:
...
See [Authenticate Where Your Agent Runs](/en/cli/integrate-agents/auth-for-agent-deployments) for details.

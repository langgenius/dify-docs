...
1. Sign in to your company's Dify host. Use the [console API URL](/en/self-host/deploy/configuration/environments#console_api_url) for your instance.
...
- **The everyday commands, copy-paste ready**: [Common Tasks](/en/cli/account-users/common-tasks)
- **Where your token lives and how sessions work**: [Authenticate](/en/cli/account-users/authenticate)

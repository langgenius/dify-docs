...
All commands below assume you're [signed in](/en/cli/account-users/authenticate).
...
List the apps in your active workspace with [`difyctl get app`](/en/cli/reference/apps#list-your-apps). Narrow the list with `--name` or `--mode`.
...
Change your active workspace with [`difyctl use workspace`](/en/cli/reference/workspaces#switch-your-workspace). List available workspaces with `get workspace`.

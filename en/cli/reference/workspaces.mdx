...
<Note>
Workspaces apply to account users only. If you signed in through SSO, you're scoped to a single context with no workspace, and the commands here don't apply. See [Scope and Limitations](/en/cli/sso-users/scope-and-limitations) for details.
</Note>
...
<Tip>
For the everyday invocation, see [Switch Your Workspace](/en/cli/account-users/common-tasks#switch-your-workspace) in Common Tasks.
</Tip>

...
<CardGroup cols={2}>
  <Card title="Account Users" icon="user" href="/en/cli/account-users/quick-start">
    Sign in with an email and password registered directly in Dify.
  </Card>
  <Card title="SSO Users" icon="id-card" href="/en/cli/sso-users/quick-start">
    Sign in through your organization's identity provider (Google Workspace, Okta, Azure AD, etc.).
  </Card>
</CardGroup>

...
<Frame>
  ![Manage Knowledge Documents](/images/use-dify/knowledge/manage-knowledge-documents.png)
</Frame>
...
| Enable / Disable    | Temporarily include or exclude a document from retrieval. <Note>Documents that have not been updated or retrieved for a certain period are automatically disabled to optimize performance. The inactivity period varies by subscription plan:<ul><li>Sandbox: 7 days</li><li>Professional & Team: 30 days</li></ul> On Professional and Team plans, disabled documents can be re-enabled **with one click**.</Note>|
...
<Frame>
  ![Manage Knowledge Chunks](/images/use-dify/knowledge/manage-document-chunks.png)
</Frame>

| Action   | Description          |
|:-------- |:---------------------|
| Add     | Add one or batch add multiple new chunks. <br/><br/>For documents chunked with Parent-child mode, both new parent and child chunks can be added. <Info>Adding chunks is available on <Badge color="blue">Professional</Badge> and <Badge color="blue">Team</Badge>. [Learn more](https://dify.ai/pricing).</Info>|

...
<Tip>
    For more about retrieval settings, see [Configure the Retrieval Settings](/en/cloud/use-dify/knowledge/create-knowledge/setting-indexing-methods#configure-the-retrieval-settings).
</Tip>

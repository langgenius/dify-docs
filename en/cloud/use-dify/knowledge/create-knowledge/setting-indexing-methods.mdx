...
<Tabs>
  <Tab title="High Quality">
    ...
    These vectors count toward your workspace's knowledge storage. See [Knowledge Storage Limit](/en/cloud/use-dify/knowledge/knowledge-storage-limit) for per-plan capacity and what happens at the limit.
...
<Card title="Test Knowledge Retrieval" icon="link" href="/en/cloud/use-dify/knowledge/test-retrieval">

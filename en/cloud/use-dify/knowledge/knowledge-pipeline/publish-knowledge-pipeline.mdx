...
<Info>
**Publish as a Knowledge Pipeline** is available on <Badge color="blue">Professional</Badge> <Badge color="blue">Team</Badge>. Sandbox accounts cannot publish pipelines as reusable templates. [Upgrade your plan](https://dify.ai/pricing) to unlock this feature.
</Info>

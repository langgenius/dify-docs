...
- **Collect input with form fields**
  ...
  | Single File / File List | Single or multiple file uploads.<br></br><br></br>Per-file upload limits: 10 MB for images, 15 MB for documents and other files, 50 MB for audio, and 100 MB for video. A File List field accepts up to 10 files.|

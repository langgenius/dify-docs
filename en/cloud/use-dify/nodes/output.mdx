...
Output nodes are only available in Workflows. Chatflows use the [Answer](/en/cloud/use-dify/nodes/answer) node instead.
</Info>
...
When you [publish a workflow as a tool](/en/cloud/use-dify/workspace/tools#workflow), the tool exposes the output variables from every Output node.

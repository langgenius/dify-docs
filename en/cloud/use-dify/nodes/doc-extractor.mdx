...
**Office Files** - DOCX files parse directly, with tables converted to Markdown. DOC and ODT files require [Unstructured processing](#external-dependencies).
...
- ODT documents (if using API processing)

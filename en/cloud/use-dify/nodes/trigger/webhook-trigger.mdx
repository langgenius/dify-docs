...
<Tip>
    If there's a ready-made trigger integration for your target external system, consider using an [Integration Trigger](/en/cloud/use-dify/nodes/trigger/plugin-trigger) instead.
</Tip>
...
Once the trigger works as expected, click **Publish** > **Publish Update** to make it live. Until the app is published, real requests from the external system won't start the workflow.

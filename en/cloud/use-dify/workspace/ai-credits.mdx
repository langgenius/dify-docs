...
Go to **Integrations** > **Model Provider** to check how many AI credits your workspace has used out of the current total. On Professional and Team plans, the page also shows the exact date of the next renewal. If no credits remain, it shows the date they ran out.

The table below shows the included credits and renewal schedule for each plan:

...
Suppose you index documents in a knowledge base, then test a Workflow that searches it with vector search. Indexing runs a 1-credit Embedding Model three times and uses 3 AI Credits. The Workflow then runs the Embedding Model once and a 5-credit LLM twice, bringing the total to 14 AI Credits.

...
## Configure Model Load Balancing <Badge color="blue">Professional</Badge> <Badge color="blue">Team</Badge>
...
3. Enable at least two credentials in the load balancing pool, then click **Save**. Models with load balancing enabled will be marked with a special icon.
    ...
    <Frame>
      ![Load Balancing Icon](/images/use-dify/workspace/load-balancing-icon.png)
    </Frame>

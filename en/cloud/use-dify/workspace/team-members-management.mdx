...
- **Sandbox**: 1 member (solo development)
...
**Multiple Workspaces**: Each account creates only one workspace, but you can belong to multiple workspaces by invitation. Switch between them using the selector in the top-left corner.

...
- Workflow / Chatflow apps, as standalone [Tool nodes](/en/cloud/use-dify/nodes/tools) or within [Agent nodes](/en/cloud/use-dify/nodes/agent#classic-agent)
- [Agent apps](/en/cloud/use-dify/build/new-agent/build#tools)
- [Legacy Agent apps](/en/cloud/use-dify/build/agent#extend-the-agent-with-dify-tools)
...
<Tabs>
    ...
    <Tab title="Workflow" id="workflow">
        ...
        Creating the tool publishes the workflow first, so the tool matches the workflow as it stands.
    ...
    <Tab title="MCP" id="mcp">
        ...
        <Tip>
          To publish one of your own Dify apps *as* an MCP server instead, see [Publish as an MCP Server](/en/cloud/use-dify/publish/publish-mcp).
        </Tip>

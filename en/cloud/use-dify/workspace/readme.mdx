...
Applications you build can use any model providers configured in the workspace, access all workspace knowledge bases, and utilize installed integrations. Team members see applications based on their workspace permissions.

...
<Tip>
Text Generators support optional features like generating multiple outputs at once, text to speech, and content moderation. See [App Toolkit](/en/cloud/use-dify/build/additional-features) for details.
</Tip>

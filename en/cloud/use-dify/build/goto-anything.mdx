...
description: Search and jump to apps, agents, knowledge bases, integrations, and workflow nodes from anywhere with a keyboard shortcut
---

The **Go to Anything** overlay is a search box for the whole console: type once to find apps, agents, knowledge bases, Marketplace integrations, and nodes on the canvas you're editing, or run quick commands.

...
<Tip>
Chatbots also support optional features like conversation openers, follow-up suggestions, and more. See [App Toolkit](/en/cloud/use-dify/build/additional-features) for details.
</Tip>

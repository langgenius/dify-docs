...
[LLM](/en/cloud/use-dify/nodes/llm), [HTTP](/en/cloud/use-dify/nodes/http-request), [Code](/en/cloud/use-dify/nodes/code), and [Tool](/en/cloud/use-dify/nodes/tools) 
...
- `error_type` - What kind of error happened (see [Error Types](/en/cloud/use-dify/debug/error-type))

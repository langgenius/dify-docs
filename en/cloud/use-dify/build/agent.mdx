...
<Tabs>
    ...
    Use it when your prompt needs dynamic data from an external source, such as live weather conditions or database records. See [API Extension](/en/cloud/use-dify/workspace/api-extension/api-extension) for details.
    </Tab>
</Tabs>

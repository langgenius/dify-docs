...
- A **Chatflow** adds a conversation layer. 
    ...
    <Tip>
        Chatflows support optional features like content moderation, text to speech, and more. See [App Toolkit](/en/cloud/use-dify/build/additional-features) for details.
    </Tip>
...
| | Workflow | Chatflow |
|:---|:---|:---|
| Starts with | [User Input](/en/cloud/use-dify/nodes/user-input) or [Trigger](/en/cloud/use-dify/nodes/trigger/overview) | User Input |
| Ends with | [Output](/en/cloud/use-dify/nodes/output) node (optional) | [Answer](/en/cloud/use-dify/nodes/answer) node (required) |
...
For how to compose either type, see [Orchestration Logic](/en/cloud/use-dify/build/orchestrate-node).

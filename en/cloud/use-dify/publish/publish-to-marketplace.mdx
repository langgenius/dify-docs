...
Choose the language used throughout your template, including its name, overview, setup steps, and app content.
...
The language you select helps users find your template with the language filter.

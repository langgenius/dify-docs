...
- Select the language of your template, and use it for the name, overview, and setup steps.
- If you want to publish your template in multiple languages, submit a separate template for each language.

...
### Choose Who Manages the Template

Before submitting, choose where the template will be managed:

- **Personal account**: Only you can view and manage the template.
- **Organization**: All organization members can view and manage the template. Select the organization before submitting, or create one and invite members if needed.
...
After publication, use these pages in Creator Center:

- [**Template**](https://creators.dify.ai/dashboard/templates): View each template's total uses, overall rating, rating count, and total likes.
- [**Inbox**](https://creators.dify.ai/dashboard/inbox): Review individual ratings, likes, and private feedback.

The selected personal account or organization determines which templates and responses appear on both pages.

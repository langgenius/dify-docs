...
Select the language of your template, and use it for the name, overview, and setup steps. When browsing Marketplace, users can filter the template list by the language you select. Submit a separate template for each translation.

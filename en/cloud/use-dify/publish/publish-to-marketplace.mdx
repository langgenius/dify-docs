...
Once published, view your template's total uses, overall rating, rating count, and total likes on [**Template**](https://creators.dify.ai/dashboard/templates). Review individual ratings, likes, and private feedback in [**Inbox**](https://creators.dify.ai/dashboard/inbox).

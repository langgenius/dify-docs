...
Select the language used in your template. When users filter the Marketplace by that language, your template appears in the results. Use the same language for the template name, overview, setup steps, and app content, including prompts and node names. To offer the template in multiple languages, submit a separate translated version for each language.

...
<CardGroup cols={2}>
  <Card title="Web Apps" icon="globe" href="/en/cloud/use-dify/publish/webapp/chatflow-webapp">
    Instant, shareable applications. Perfect for testing ideas or serving end users directly.
  </Card>
  <Card title="API Integration" icon="code" href="/en/cloud/use-dify/publish/developing-with-apis">
    Build AI into your existing products. Full control over user experience and data flow.
  </Card>
  <Card title="Embed on Websites" icon="window" href="/en/cloud/use-dify/publish/webapp/embedding-in-websites">
    Deploy your web app as chat widgets or inline frames on any website.
  </Card>
  <Card title="MCP Server" icon="plug" href="/en/cloud/use-dify/publish/publish-mcp">

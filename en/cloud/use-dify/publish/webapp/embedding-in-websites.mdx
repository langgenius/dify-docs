...
<Steps>
  <Step title="Get your embed token">
    In your Dify app, open the **Access Point** tab and click **Embed Into Site** on the **Web App** card to find your unique token.
  </Step>
...
- Verify your app token matches what's shown under **Embed Into Site** on the app's **Access Point** tab

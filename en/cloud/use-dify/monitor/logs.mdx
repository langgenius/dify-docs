...
<Info>
Unlimited log retention is available on <Badge color="blue">Professional</Badge> <Badge color="blue">Team</Badge> for the duration of the active subscription. [Learn more](https://dify.ai/pricing).
</Info>

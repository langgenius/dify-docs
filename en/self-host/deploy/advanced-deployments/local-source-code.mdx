...
Start the databases, [sandbox](https://github.com/langgenius/dify-sandbox), and [plugin daemon](https://github.com/langgenius/dify-plugin-daemon) with Docker Compose before starting the backend.
...
- Install NodeJS
  ...
  Please visit [https://nodejs.org/en/download](https://nodejs.org/en/download) and choose the v24 installation package for your respective operating system (24.20.0 or later).

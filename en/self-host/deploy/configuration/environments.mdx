...
| `AGENT_BACKEND_HOME_SNAPSHOT_TIMEOUT_SECONDS` | `45` | Client timeout for agent backend calls that carry a Home Snapshot transfer: snapshot capture and delete, and creating an execution binding that restores one. |

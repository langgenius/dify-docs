...
For deployments that need to restrict access, web app access control adds authentication, member-level restrictions, and external user management.

<Info>
Web app access control is available on <Badge color="blue">Enterprise</Badge>. See [Web App Access](/en/self-host/use-dify/publish/webapp/web-app-access) for the available tiers and configuration steps. [Learn more](https://dify.ai/pricing).
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Website Embedding" icon="window" href="/en/self-host/use-dify/publish/webapp/embedding-in-websites">

...
<Tip>
  On Dify Enterprise, you can restrict who opens a web app with authentication, member-level access, and external-user management. [Contact sales](https://dify.ai/pricing) to learn more.
</Tip>

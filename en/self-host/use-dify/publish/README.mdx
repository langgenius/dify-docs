...
<Frame>
  ![Publish Methods](/images/use-dify/publish/publish-methods.png)
</Frame>
...
<Steps>
  ...
  <Step title="Copy the URL">
    Find your web app link on the app's **Access Point** tab.
  </Step>
...
<CardGroup cols={2}>
  <Card title="Web Apps" icon="globe" href="/en/self-host/use-dify/publish/webapp/chatflow-webapp">
    Instant, shareable applications. Perfect for testing ideas or serving end users directly.
  </Card>
  <Card title="API Integration" icon="code" href="/en/api-reference/guides/get-started">
    Build AI into your existing products. Full control over user experience and data flow.
  </Card>
  <Card title="Embed on Websites" icon="window" href="/en/self-host/use-dify/publish/webapp/embedding-in-websites">
    Deploy your web app as chat widgets or inline frames on any website.
  </Card>
  <Card title="MCP Server" icon="plug" href="/en/self-host/use-dify/publish/publish-mcp">

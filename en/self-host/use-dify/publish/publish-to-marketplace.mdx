...
Select the language of your template, and use it for the name, overview, and setup steps. This helps users discover your template when filtering Marketplace by language. Submit a separate template for each translation.

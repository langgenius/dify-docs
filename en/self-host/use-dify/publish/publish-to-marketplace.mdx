...
To publish a template, submit it through the [Creator Center](https://creators.dify.ai). Submit under your personal account to manage it yourself, or under an organization to manage it with your team. After you submit, the template enters **Pending** status while we review it. Once approved, it's published to Marketplace.
...
Once published, view your template's total uses, overall rating, rating count, and total likes on [**Template**](https://creators.dify.ai/dashboard/templates). Open [**Inbox**](https://creators.dify.ai/dashboard/inbox) to review individual ratings, likes, and private feedback.

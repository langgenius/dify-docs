...
<Tabs>
    ...
    If the exported file exceeds 10 MB, use any of the methods below to simplify the app, and then export it again.

    - Remove unused nodes and connections.
    - Shorten prompts, code, template text, HTTP request bodies, or variable values.
    - For Agent apps, remove unused tools or shorten instructions.
    </Tab>
</Tabs>

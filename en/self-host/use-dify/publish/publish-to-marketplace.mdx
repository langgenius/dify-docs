...
### Submit Under a Personal Account or Organization

You can submit templates under your personal account or an organization.

- **Personal**: For independent creators. In Creator Center, only you can view and manage templates submitted under your personal account. When you first log in to Creator Center, your personal account is selected by default.

- **Organization**: For teams that want to build and manage templates together. Organization members can view and manage all templates submitted under the organization, including templates submitted by other members. To get started, click your avatar in the top-left corner, select **Create an organization**, then invite members.

Before submitting, use the account switcher in the top-left corner of Creator Center to select the personal account or organization that should own the template.
...
After publication, use the **Template** page in Creator Center to view usage, overall rating, and total likes. In **Inbox**, review ratings, likes, and private feedback for templates owned by the selected personal account or organization.

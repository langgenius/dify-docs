...
- **Organization**: For teams that want to manage templates together. Create an organization and invite members, then select the organization before submitting a template. All organization members can manage templates submitted under it.

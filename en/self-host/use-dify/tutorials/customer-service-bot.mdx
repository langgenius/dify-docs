...
A Q&A chunking mode is also available for self-hosted deployments. Selecting the corresponding language can organize the text content into a Q&A format, which requires additional token consumption.

...
Open your Dify instance in a browser and sign in. If you don't have one running yet, see [Deploy Dify with Docker Compose](/en/self-host/deploy/ce/quick-start/docker-compose) to bring an instance up.

### Configure LLM Providers

Go to **Settings** > **Model Provider** and install at least one LLM plugin (for example, OpenAI), then add your API key in the plugin configuration. Local model providers such as Ollama also work; point the corresponding plugin at your endpoint.

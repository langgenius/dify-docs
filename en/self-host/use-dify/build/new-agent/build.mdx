...
After you create an agent, you shape it in the **Configure** editor. Set up each capability by hand, or describe what you want and build it by chatting in [Build mode](#build-by-chatting).

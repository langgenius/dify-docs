...
From **Roster**, select **Create agent** and give it a name; optionally add a role such as *Research Assistant* and a description. Then you shape everything else in **Configure**.
...
<Note>
Agent performance rises and falls with the model, so pick a recent one. With an older model, the agent may not live up to expectations.
</Note>

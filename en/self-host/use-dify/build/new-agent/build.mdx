...
After you apply, open the build note and read what the agent captured. If it covers what you want, you're set. To change what it says, have the agent revise it in Build mode; if anything's missing, add it to the **Prompt**.

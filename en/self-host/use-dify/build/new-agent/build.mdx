...
To share the agent across workspaces, export it as a DSL file. Share its skill packages and files alongside the DSL so others can set up the agent in their workspaces.

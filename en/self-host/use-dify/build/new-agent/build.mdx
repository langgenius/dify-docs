...
A skill comes as a `.zip` or `.skill` package: select **Add** and upload it. To learn more about the format and how to build one, see [Agent Skills](https://agentskills.io/home).
...
Files you add here are saved as part of the agent's capabilities. Files the agent creates while working are not: they live in its sandbox *working directory* and are cleared once the task is done.

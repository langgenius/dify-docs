...
<Tip>
Chatbots also support optional features like conversation openers, follow-up suggestions, and more. See [App Toolkit](/en/self-host/use-dify/build/additional-features) for details.
</Tip>

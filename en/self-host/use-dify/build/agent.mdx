...
<Tip>
[A new kind of Agent](/en/self-host/use-dify/build/new-agent/overview) is in beta: it works in a sandbox of its own, and you build it once to use as a chat app or inside workflows.
</Tip>

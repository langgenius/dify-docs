...
<Tip>
Text Generators support optional features like generating multiple outputs at once, text to speech, and content moderation. See [App Toolkit](/en/self-host/use-dify/build/additional-features) for details.
</Tip>
...
See [Environment Variables](/en/self-host/deploy/ce/configuration/environments) for details.
</Info>

...
[LLM](/en/self-host/use-dify/nodes/llm), [HTTP](/en/self-host/use-dify/nodes/http-request), [Code](/en/self-host/use-dify/nodes/code), and [Tool](/en/self-host/use-dify/nodes/tools) 
...
- `error_type` - What kind of error happened (see [Error Types](/en/self-host/use-dify/debug/error-type))

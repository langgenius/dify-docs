...
<Frame>
  ![Plugins Tab](/images/use-dify/workspace/plugins-tab.png)
</Frame>
...
<Frame>
  ![Plugin Management](/images/use-dify/workspace/plugin-management.png)
</Frame>
...
## Plugin Installation Restrictions <Badge color="blue">Enterprise</Badge>

Admins can restrict which plugins members install. When restrictions are active, you may see:

- The **Install Plugin** dropdown in Plugins → Explore Marketplace showing limited options
- Installation confirmation dialogs indicating that a plugin is blocked by policy
- Notices about restricted plugins when importing apps from DSL files

**Plugin badges in the marketplace**:

<Frame>
  ![Plugin Badges in Marketplace](https://assets-docs.dify.ai/2025/06/c2bfdfbb2132848e589073600e55ffab.png)
</Frame>

Badges identify plugin types. Your workspace may only allow certain types based on admin settings.

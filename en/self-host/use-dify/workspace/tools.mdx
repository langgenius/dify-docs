...
- Workflow / Chatflow apps, as standalone [Tool nodes](/en/self-host/use-dify/nodes/tools) or within [Agent nodes](/en/self-host/use-dify/nodes/agent#classic-agent)
- [Agent apps](/en/self-host/use-dify/build/new-agent/build#tools)
- [Legacy Agent apps](/en/self-host/use-dify/build/agent#extend-the-agent-with-dify-tools)

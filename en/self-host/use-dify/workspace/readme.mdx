...
└── 📁 Workspace
    ...
    └── 🔧 Integrations (tools, model providers, triggers, custom endpoints)
```
...
Dify organizes everything around the workspace concept. The main navigation gives you access to Studio (your apps), Knowledge, Integrations (model providers, tools, triggers, and other extensions), and Marketplace. Settings holds workspace preferences such as members and language.
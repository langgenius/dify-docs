...
<Tip>
  On Dify Enterprise, you can run multiple workspaces for complete isolation between legal entities, regulatory environments, or client projects. [Contact sales](https://dify.ai/pricing) to learn more.
</Tip>

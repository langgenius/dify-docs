...
<Info>
Seat-based licensing and additional role controls may apply on <Badge color="blue">Enterprise</Badge>. Check your license terms for specifics.
</Info>
...
<AccordionGroup>
  ...
  <Accordion title="Admin">
    **Team and resource management.** Can add/remove team members, configure model providers, manage all applications, and install plugins. Cannot change member roles.
  </Accordion>
...
**Multiple Workspaces**: Team members can belong to multiple workspaces. They switch between workspaces using the selector in the top-left corner. Creating additional workspaces beyond the one provisioned at install time is available on <Badge color="blue">Enterprise</Badge>.

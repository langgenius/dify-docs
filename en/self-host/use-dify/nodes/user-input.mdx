...
## Hide and Pre-Fill Input Fields {#hide-and-pre-fill-input-fields}
...
<Warning>
    Hidden fields are **not secret**. Values travel in the URL query string and are visible in the browser address bar, browser history, and network traffic. For credentials and API keys, use [Environment Variables](/en/learn/key-concepts#variables) instead.
</Warning>
    ...
    2. Choose the method that fits how your end users reach the app.
        ...
        <Tabs>
          <Tab title="Shareable Link">
            ...
            1. On the app's **Access Point** tab, click **Configure** on the **Web App** card.
            2. Fill in the hidden fields and click **Launch**. The web app opens with your values applied as URL query parameters.
            3. Copy the URL from the address bar to share the web app.
          ...
          <Tab title="Embed on Your Site">
            ...
            <Tabs>
              <Tab title="Same Value for Every Visitor">
                ...
                1. On the app's **Access Point** tab, click **Embed Into Site** > **Pre-Fill Hidden Fields** on the **Web App** card.

                2. Fill in the hidden fields. Entered values are baked into the iframe URL and the `inputs` object of the script snippet.

                3. Copy the updated snippet into your site.
              </Tab>

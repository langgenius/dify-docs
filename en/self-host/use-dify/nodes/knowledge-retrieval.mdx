...
Before using a Knowledge Retrieval node, ensure that you have at least one available knowledge base. To learn about creating knowledge bases, see [Knowledge](/en/self-host/use-dify/knowledge/readme#create-knowledge).
...
You can click the **Edit** icon next to any added knowledge base to modify its [settings](/en/self-host/use-dify/knowledge/manage-knowledge/introduction).
...
In chatflows, citations are shown alongside responses that reference knowledge by default. You can turn this off by disabling **[Citation and Attributions](/en/self-host/use-dify/build/additional-features#citations-and-attributions)** in **Features** at the top right corner of the canvas.
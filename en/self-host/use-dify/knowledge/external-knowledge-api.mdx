...
This page defines the API contract your external knowledge service must implement for Dify to retrieve content from it. Once your API is ready, see [Connect to External Knowledge Base](/en/self-host/use-dify/knowledge/connect-external-knowledge-base) to register it in Dify.

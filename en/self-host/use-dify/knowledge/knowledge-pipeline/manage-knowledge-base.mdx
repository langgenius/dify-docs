...
<Tip>
Find more information in [Manage Knowledge](/en/self-host/use-dify/knowledge/manage-knowledge/maintain-knowledge-documents).
</Tip>

<Frame>
  ![Knowledge Management](/images/use-dify/knowledge/create-knowledge-pipeline-21.png)
</Frame>
...
- **[Create from a knowledge pipeline](/en/self-host/use-dify/knowledge/knowledge-pipeline/readme)**: Orchestrate more complex, flexible data processing workflows with custom steps and various plugins.

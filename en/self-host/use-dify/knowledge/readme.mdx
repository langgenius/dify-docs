...
- **[Create a ready-to-use knowledge base](/en/self-host/use-dify/knowledge/create-knowledge/introduction)**: Import data, define processing rules, and let Dify handle the rest. Fast and beginner-friendly. 

- **[Build a custom knowledge base](/en/self-host/use-dify/knowledge/knowledge-pipeline/readme)**: Orchestrate more complex, flexible data processing workflows with custom steps and various integrations.

- **[Connect to an external knowledge base](/en/self-host/use-dify/knowledge/connect-external-knowledge-base)**: Sync directly from external knowledge bases via APIs to leverage existing data without migration.

## Manage & Optimize Knowledge

- **[Manage content](/en/self-host/use-dify/knowledge/manage-knowledge/maintain-knowledge-documents)**: View, add, modify, or delete documents and chunks to keep your knowledge current, accurate, and retrieval-ready.

- **[Test and validate retrieval](/en/self-host/use-dify/knowledge/test-retrieval)**: Simulate user queries to test how well your knowledge base retrieves relevant information.

- **[Enhance retrieval with metadata](/en/self-host/use-dify/knowledge/metadata)**: Add metadata to documents to enable filter-based searches and further improve retrieval precision.

- **[Adjust knowledge base settings](/en/self-host/use-dify/knowledge/manage-knowledge/introduction)**: Modify the index method, embedding model, and retrieval strategy at any time.

## Use Knowledge

**[Integrate into applications](/en/self-host/use-dify/knowledge/integrate-knowledge-within-application)**: Ground your AI app in your own knowledge.

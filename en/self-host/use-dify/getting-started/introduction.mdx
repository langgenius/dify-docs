...
<CardGroup cols={3}>
  <Card title="Quick Start" icon="play" href="/en/quick-start">
    Start shipping powerful apps in minutes
  </Card>
  <Card title="Concepts" icon="highlighter" iconType="regular" href="/en/key-concepts">
    Core Dify building blocks explained
  </Card>
  <Card title="Deploy with Docker Compose" icon="arrow-down-to-line" href="/en/self-host/deploy/quick-start/docker-compose">
    Stand up Dify on your laptop or server
  </Card>
  <Card title="Tutorials" icon="lightbulb" href="/en/tutorials/customer-service-bot">

...
<Frame>
  ![Workflow Overview](/images/use-dify/get-started/deeper-dive-workflow-overview.png)
</Frame>

## Before You Start

<Steps>
  <Step title="Deploy Dify">

    If you don't already have a running instance, follow [Deploy Dify with Docker Compose](/en/self-host/deploy/ce/quick-start/docker-compose) to bring one up locally. Source-code installation and AMI-based deployment are also supported; see the [Deploy](/en/self-host/deploy/ce/quick-start/docker-compose) section for alternatives.

  </Step>

  <Step title="Sign In">

    Open your Dify instance in a browser and sign in with the administrator account created during installation. Once signed in, you'll land in the default workspace.
  ...
  <Step title="Set Up the Model Provider">
    ...
    Add your own OpenAI API key in the plugin configuration. The plugin won't be usable until at least one valid credential is added.

    <Tip>
      You can install any LLM plugin from the [Marketplace](https://marketplace.dify.ai/) and bring your own API key. Local model providers such as Ollama also work; configure the endpoint in the corresponding plugin.
    </Tip>
  ...
  <Step title="Configure the Default Model">
    ...
    2. Set the **System Reasoning Model** to `gpt-5.2`, or another model with comparable capability. This becomes the default model in the workflow.
  </Step>
...
<Frame>
  ![User Input](/images/use-dify/get-started/deeper-dive-start.png)
</Frame>
...
<Frame>
  ![Parameter Extractor](/images/use-dify/get-started/deeper-dive-parameter-extractor.png)
</Frame>
...
<Frame>
  ![IF Branch](/images/use-dify/get-started/deeper-dive-if.png)
</Frame>
...
<Frame>
  ![List Operator](/images/use-dify/get-started/deeper-dive-list-operator.png)
</Frame>
...
<Frame>
  ![Doc Extractor](/images/use-dify/get-started/deeper-dive-doc-extractor.png)
</Frame>
...
<Frame>
  ![Integrate Information](/images/use-dify/get-started/deeper-dive-info-integrate.png)
</Frame>
...
3. Click the LLM node to configure it:
    ...
    5. Click **Add Message** to add a user message, then paste the following. Type `{` or `/` to replace `Doc Extractor/text` and `User Input/draft` with the corresponding variables from the list.
        ...
        <Frame>
          ![User Message](/images/use-dify/get-started/deeper-dive-user-message.png)
        </Frame>
...
<Frame>
  ![Iteration Node](/images/use-dify/get-started/deeper-dive-iteration.png)
</Frame>
...
3. After the Identify Style node, add another LLM node and configure it:
    ...
    4. Enable structured output. 
        ...
        <Frame>
          ![Structured Output](/images/use-dify/get-started/deeper-dive-structured-output.png)
        </Frame>
        ...
        2. In the pop-up schema editor, click **Import From JSON** in the top-right corner, and paste the following:
            ...
            ```
            <Frame>
              ![Import from JSON](/images/use-dify/get-started/deeper-dive-import-from-json.png)
            </Frame>
...
4. Click the Iteration node to configure it:
    ...
    <Frame>
      ![Iteration Configuration](/images/use-dify/get-started/deeper-dive-iteration-config.png)
    </Frame>
...
<Frame>
  ![Template Node](/images/use-dify/get-started/deeper-dive-template.png)
</Frame>
...
1. Make sure your Checklist is clear.
    ...
    <Frame>
      ![Check Checklist](/images/use-dify/get-started/deeper-dive-checklist-clear.png)
    </Frame>
...
<Frame>
  ![Test Output](/images/use-dify/get-started/deeper-dive-test-output.png)
</Frame>

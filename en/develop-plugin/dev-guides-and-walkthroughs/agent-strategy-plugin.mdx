...
You can now submit the package to the [Dify Plugins repository](https://github.com/langgenius/dify-plugins). Before doing so, ensure it meets the [Marketplace preparation and validation requirements](/en/develop-plugin/publishing/marketplace-listing/prepare-plugin-for-marketplace). Once approved, the package merges into the main branch and is released through the Marketplace pipeline.

...
Endpoints are HTTP interfaces exposed by a plugin for integration with external systems. This guide explains their structure using the [Neko Cat](https://github.com/langgenius/dify-plugin-sdks/tree/739b16ebd300e0b0c5e8c977f70d9c43094b1af7/python/examples/neko) project as an example.

<Info>
The example was removed from the SDK repository, so the link opens the last revision that carried it. For maintained plugin samples, see the [official plugin examples](https://github.com/langgenius/dify-official-plugins).
</Info>

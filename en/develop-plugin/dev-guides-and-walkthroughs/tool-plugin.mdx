...
To publish the plugin to Dify Marketplace, make sure it meets the [Marketplace preparation and validation requirements](/en/develop-plugin/publishing/marketplace-listing/submit-plugin-to-marketplace#prepare-the-package). After review, the package is merged into the main branch and released through the Marketplace pipeline.

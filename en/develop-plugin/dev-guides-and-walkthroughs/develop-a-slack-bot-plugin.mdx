...
You can now submit it to the [Dify Marketplace repository](https://github.com/langgenius/dify-plugins) for public release. Before publishing, ensure your plugin meets the [Marketplace preparation and validation requirements](/en/develop-plugin/publishing/marketplace-listing/submit-plugin-to-marketplace#prepare-the-package). Once approved, the package is merged into the main branch and released through the Marketplace pipeline.
...
- [Publish a Plugin to Marketplace](/en/develop-plugin/publishing/marketplace-listing/submit-plugin-to-marketplace): Package preparation, validation, and submission guide

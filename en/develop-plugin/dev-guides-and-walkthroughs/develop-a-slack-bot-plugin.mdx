...
You can now submit it to the [Dify Marketplace repository](https://github.com/langgenius/dify-plugins) for public release. Before publishing, ensure your plugin meets the [Marketplace preparation and validation requirements](/en/develop-plugin/publishing/marketplace-listing/prepare-plugin-for-marketplace). Once approved, the package is merged into the main branch and released through the Marketplace pipeline.
...
- [Prepare a Marketplace Submission](/en/develop-plugin/publishing/marketplace-listing/prepare-plugin-for-marketplace): Package preparation and validation guide

...
For the complete model provider YAML specification, see [Model Schema](/en/develop-plugin/features-and-specs/plugin-types/model-schema).
...
- [Model Schema](/en/develop-plugin/features-and-specs/plugin-types/model-schema): Detailed model configuration specifications.
- [General Specifications](/en/develop-plugin/features-and-specs/plugin-types/general-specifications): Plugin manifest file configuration.

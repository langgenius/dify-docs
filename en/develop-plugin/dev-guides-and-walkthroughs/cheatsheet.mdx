...
Category tags are defined in [`ToolLabelEnum`](https://github.com/langgenius/dify-plugin-sdks/blob/main/src/dify_plugin/entities/tool.py):
...
- **Extension plugin**: Extend Dify platform functionality, such as Endpoints and web apps. See [Extension Plugin](/en/develop-plugin/dev-guides-and-walkthroughs/endpoint).

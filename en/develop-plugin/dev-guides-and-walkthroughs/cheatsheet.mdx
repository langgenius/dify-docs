...
- **Extension plugin**: Extend Dify platform functionality, such as Endpoints and web app. See [Extension Plugin](/en/develop-plugin/dev-guides-and-walkthroughs/endpoint).

...
- [Prepare a Marketplace submission](/en/develop-plugin/publishing/marketplace-listing/prepare-plugin-for-marketplace): Validate a package for the official Marketplace.

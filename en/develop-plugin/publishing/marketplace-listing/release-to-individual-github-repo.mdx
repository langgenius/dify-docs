...
- [Submit a plugin to Marketplace](/en/develop-plugin/publishing/marketplace-listing/submit-plugin-to-marketplace#prepare-the-package): Prepare and validate a package for the official Marketplace.

...
Once the organization is verified as the publisher, its published plugins appear on the **Plugin** page. Invite teammates to view the same plugins without connecting their own GitHub accounts.

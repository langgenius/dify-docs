...
language: en
title: Publish a Plugin to Marketplace
...
After your plugin appears in Marketplace, find and manage it on the **Plugin** page in [Creator Center](https://creators.dify.ai/). Review individual ratings, likes, and private feedback in **Inbox**.
...
Select **Claim plugin** to verify your right to manage a published organization plugin that is not listed in Creator Center. Provide its Plugin ID and original publication PR for review.

...
Once Creator Center verifies the organization as the publisher, its published plugins appear on the **Plugin** page. Invite teammates to view the same plugins without connecting their own GitHub accounts.
...
Track the request in **Claim history**. After approval, you can view all plugins from the claimed publisher. If the claim is rejected, review the reason and select **New Claim** to update the evidence and resubmit it.

...
If a plugin published under your organization's name does not appear on the organization's **Plugin** page, open **Claim plugin** to request access to manage it.

...
See [Checks, Review, and Marketplace Release](/en/develop-plugin/publishing/marketplace-listing/marketplace-review-and-release#automated-pr-checks) for the current check categories and how to interpret errors and warnings.

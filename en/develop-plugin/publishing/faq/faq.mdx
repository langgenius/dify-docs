...
See [After You Submit](/en/develop-plugin/publishing/marketplace-listing/submit-plugin-to-marketplace#after-you-submit) to interpret the result and decide whether you need to act.

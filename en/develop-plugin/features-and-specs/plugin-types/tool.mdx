...
language: en
title: Tool Return
description: How tool plugins return messages (text, links, images, files, JSON), create standard and streaming variables, and define output schemas for workflow references
---

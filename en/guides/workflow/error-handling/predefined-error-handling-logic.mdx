...
<table>
  ...
  <tbody>
    <tr>
      <td>`error_type`</td>
      <td>Error Types. Different types of nodes come with distin<a href="error-type.md">ct error types</a>. Developers can design tailored solutions based on these error identifiers.</td>
    </tr>
    <tr>
      <td>`error_message`</td>

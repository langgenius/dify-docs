...
<Tip>
    A workflow can start with multiple schedule triggers running in parallel.
</Tip>

## Configure a Schedule Trigger

You can configure the trigger schedule using either the default visual picker or a cron expression.

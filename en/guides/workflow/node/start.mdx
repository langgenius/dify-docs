...
* **Checkbox:** Presented as a checkbox for users to choose between True or False.
* **Object:** Provides a JSON editor for users to input structured data. Available in both Workflow and Chatflow applications.

...
The variable assigner node is used to assign values to writable variables. This node supports all data types including strings, numbers, booleans, objects, and arrays. Currently supported writable variables include:

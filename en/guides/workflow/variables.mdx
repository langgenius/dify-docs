...
A variable is a labeled container that stores information in your workflow or chatflow. Each container can hold a piece of data—whether it's user input, system-generated values, or outputs from previous nodes. When you need to use this information later, you simply reference it by its name.
...
<Tabs>
  <Tab title="Workflow">
    ...
    | `sys.timestamp` | String | Records the start time of each workflow execution. | |

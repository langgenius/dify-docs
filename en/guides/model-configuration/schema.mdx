...
[Edit this page](https://github.com/langgenius/dify-docs/edit/main/en/guides/model-configuration/schema.mdx) | [Report an issue](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)

...
5. Once finished, link the knowledge base to your application and start using it. You can then [integrate it into your application](/en/../integrate-knowledge-within-application) to build an LLM that are capable of Q\&A based on knowledge-bases. If you want to modify and manage the knowledge base further, take refer to [Knowledge Base and Document Maintenance](/en/[knowledge-and-documents-maintenance](/en/guides/knowledge-base/knowledge-and-documents-maintenance)).
...
For managing the knowledge base with metadata, see *[Metadata](/en/../metadata)*.

...
<Tabs>
  <Tab title="High Quality">
    ...
    Once chunked and embedded, the content can be retrieved using one of three strategies: vector search, full-text search, or hybrid search. Learn more in [Configure the Retrieval Settings](#configure-the-retrieval-settings).

...
<Tip>
  ...
  To enable image-based retrieval, choose an embedding model that supports image vectorization (marked with an **Image** icon). 
  
  Knowledge bases created with such embedding models also have the same icon on their card, indicating support for image-based retrieval.
...
<Info>
  For more details, see [Select the Indexing Method and Retrieval Setting](/en/guides/knowledge-base/create-knowledge-and-upload-documents/setting-indexing-methods).
</Info>
...
- **Name & Icon**\
  Pick a name for your knowledge base.\  To enable image-based retrieval, choose an embedding model that supports image vectorization (marked with an **Image** icon). Knowledge bases created with such embedding models also have the same icon on their cards as well, indicating support for image-based retrieval.

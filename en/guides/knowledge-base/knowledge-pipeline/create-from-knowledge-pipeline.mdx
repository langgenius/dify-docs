...
<Warning>
Explore [Knowledge Pipeline Orchestration](/en/guides/knowledge-base/knowledge-pipeline/knowledge-pipeline-orchestration) for step-by-step instructions.
</Warning>

### User Input Field

![User Input Field](/images/knowledge-base/create-knowledge-pipeline-10.png)

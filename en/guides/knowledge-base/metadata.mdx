...
See **Metadata Filtering** in *[Integrate Knowledge Base within Application](/guides/knowledge-base/integrate-knowledge-within-application)*.

## API Documentation

See *[Maintaining Dataset via API](/guides/knowledge-base/knowledge-and-documents-maintenance/maintain-dataset-via-api)*.

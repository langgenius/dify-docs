...
Chatbot apps (`chat` mode) and Agent apps (`agent-chat` mode) share this API surface: the same endpoints send messages, manage conversations, handle files, and retrieve app settings. 

...
- **Web app**: Displays the request form directly in the web app interface for the current user to respond.
  ...
  <Info>
    External clients can also retrieve and submit Web app forms through the Service API. See [Get Human Input Form](/api-reference/human-input/get-human-input-form).
  </Info>

...
- **Rerank Settings**
    ...
    <Note>
        If any multimodal knowledge bases are added, select a multimodal rerank model (indicated by the **Vision** icon). Otherwise, retrieved images will be excluded from reranking and the final output.
    </Note>

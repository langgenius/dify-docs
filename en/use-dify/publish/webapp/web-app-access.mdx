...
<Info>
- The Workspace Owner, Admin, and Editor roles can create and publish web apps, along with custom roles that include the necessary app permissions.
- Web app access is separate from [resource access](/en/use-dify/workspace/roles-and-permissions), which controls who can reach and edit an app inside the workspace. 
</Info>
...
<Info>
Being able to edit an app in the workspace doesn't grant access to its published web app. Even members who can edit the app must be added to this access list to use it.
</Info>

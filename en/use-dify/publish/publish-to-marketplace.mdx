...
<Tabs>
    ...
    <Tab title="In the Creators Platform">
    Export your app, then go to the [Creators Platform]() and upload the export file. Fill in the template details and submit for review.
    </Tab>
</Tabs>

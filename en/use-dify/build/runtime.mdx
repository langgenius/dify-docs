...
<Frame>
    <img src="/images/workflow_runtime.png" alt="Workflow Runtime"/>
</Frame>
...
You can upgrade a classic-runtime application to sandboxed runtime. A copy of your application is created and upgraded—your original application remains unchanged.

<Frame>
    <img src="/images/upgrade_to_sandboxed_runtime.png" alt="Upgrade to Sandboxed Runtime"/>
</Frame>

During the upgrade, all classic Agent and LLM nodes are converted to the sandboxed [Agent node](/en/use-dify/nodes/agent) and will need reconfiguration. All other nodes and their positions in the workflow stay the same.

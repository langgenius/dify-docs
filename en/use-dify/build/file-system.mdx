...
The Agent node's `files` output variable automatically captures all artifacts produced during execution. Reference this variable in an Answer or Output node to deliver artifacts to end users.

...
### Output Only Artifacts to End Users

To deliver only the generated artifacts to end users without the model's response or reasoning, reference the Agent node's `files` output variable in an Answer or Output node.

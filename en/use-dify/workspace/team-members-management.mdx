...
- **Owner**: Full control of the workspace, including transferring ownership. One per workspace.
...
<Info>
The Owner, Admin, and Editor roles can create knowledge bases. Who can see and use an existing knowledge base is configured in its own settings, not by workspace role. See [Manage Knowledge Settings](/en/use-dify/knowledge/manage-knowledge/introduction) for details.
</Info>

<Tip>
On Dify Enterprise, you can create custom roles and grant members granular access to apps and knowledge bases. [**Contact sales**](https://dify.ai/contact) to learn more.
</Tip>

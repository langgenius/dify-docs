...
<Steps>
  ...
  <Step title="Configure Query Text">
    ...
    By doing this, we are telling AI: _Take the customer's message and use it as a search keyword to flip through our cookbook and find the matching info._ Without a query, the AI is just staring at a closed book.
...
<Frame>
  ![Test Result](/images/difyworkflow101-lesson04-testresule.png)
</Frame>

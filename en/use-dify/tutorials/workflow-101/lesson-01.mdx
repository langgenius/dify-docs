...
<Frame>
  ![Workflow Example](/images/use-dify/tutorial/workflow-101-lesson-01/workflow-example.png)
</Frame>
...
2. Click on Explore. This is a library which collects different workflow of different scenarios.
   ...
   <Frame>
     ![Explore](/images/use-dify/tutorial/workflow-101-lesson-01/explore.png)
   </Frame>

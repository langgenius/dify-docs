...
Our email assistant can now flip through our knowledge base. But what if a customer asks a beyond-knowledge-base question, like: _What is in the latest Dify release?_

If the knowledge base hasn't been updated yet, the workflow will be at lost. To fix this, we need to equip it with a Live Search skill!
...
<Steps>
  <Step title="Enter the Iteration">
    ...
    2. Keep Knowledge Retrieval node, and make sure the query variable as `{x} item`.

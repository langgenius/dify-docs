...
Every user provides different content, so every time the app runs, the stuff inside these _boxes_ changes.
...
<Steps>
  <Step title="Create the App">
    ...
    - Go back to Studio → Create Blank App → select Workflow, and name it _Email Assistant_ (Remember to select **User Input** in the popup!)
  </Step>

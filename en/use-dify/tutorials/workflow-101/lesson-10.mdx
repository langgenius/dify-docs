...
1. Move your mouse to the top right corner of the canvas and click the **Publish** button. You'll see other buttons light up.
   ...
   <Frame>
     ![Publish](/images/difyworkflow101-lesson10-ublish.png)
   </Frame>
...
- **Debugging**: User says _It doesn't work_? Check the logs to replay the _crime scene_ and see exactly which node failed.

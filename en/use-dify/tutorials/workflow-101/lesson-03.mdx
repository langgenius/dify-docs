...
<Steps>
  ...
  <Step title="Add User Messages">
    ...
    <Frame>
      <img
        src="/images/difyworkflow101-lesson03-addusermessage-1.png"
        alt="Add User Message"
        className="hidden dark:block"
      />
      <img
        src="/images/difyworkflow101-lesson03-addusermessage.png"
        alt="Add User Message"
    ...
    <Frame>
      <img
        src="/images/difyworkflow101-lesson03-finalprompt-1.png"
        alt="Final Prompt"
        className="hidden dark:block"
      />
      <img
        src="/images/difyworkflow101-lesson03-finalprompt.png"
        alt="Final Prompt"
        className="dark:hidden"
      />
    </Frame>
  ...
  <Step title="Fix the Issue">
    ...
    <Info>
      **Why we choose text here?**
      ...
      The LLM Node produces a few different pieces of data (like how many _tokens_ it used or how long it took), but the `text` variable holds the actual answer—the drafted email itself. By selecting `text`, we are telling the Output Node: _Ignore the technical stats, just show me the message!_
    </Info>
  </Step>

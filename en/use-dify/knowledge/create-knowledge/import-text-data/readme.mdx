...
<Accordion title="For images in Uploaded Files">
    ...
    <Note>
        Images embedded in other document types (e.g., PDF) can only be extracted by using appropriate document extractor plugins (e.g., MinerU) in [knowledge pipelines](/en/use-dify/knowledge/knowledge-pipeline/readme).
    </Note>

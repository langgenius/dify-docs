...
<Tip>
  To develop a custom data processing plugin that extracts multimodal data for embedding and cross-modal retrieval, see [Multimodal Plugin Development Guide]().
</Tip>

...
- **Customer support chatbots**: Build smarter support bots that provide accurate answers from your up-to-date product documentation, FAQs, troubleshooting guides, and support ticket history.
...
- **[Manage content](/en/use-dify/knowledge/manage-knowledge/maintain-knowledge-documents)**: View, add, modify, or delete documents and text chunks to keep your knowledge current, accurate, and retrieval-ready.
...
- **[Adjust settings](/en/use-dify/knowledge/manage-knowledge/introduction)**: Modify the index method, embedding model, and retrieval strategy at any time.

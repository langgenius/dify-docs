...
Navigate to the knowledge base page, and you can see the ***Service API*** button in the upper right corner. Click the  button and then click ***API Key*** for key management.
![](/images/knowledge_api_key_management.png)

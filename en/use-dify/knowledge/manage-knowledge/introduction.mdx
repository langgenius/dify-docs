...
| Summary Auto-Gen        | Uses an LLM to automatically generate summaries for document chunks. For more details, see [Summary Auto-Gen]().<Info>Once enabled, summaries are automatically generated only for newly added document chunks.</Info>|

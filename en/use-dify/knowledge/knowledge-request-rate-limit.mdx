...
Knowledge Request Rate Limit refers to the maximum number of actions that a workspace on Dify Cloud can perform in the knowledge base within one minute. These actions include creating datasets, managing documents, and running queries in apps or workflows.

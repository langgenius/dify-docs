...
- **The everyday commands, copy-paste ready**: [Common Tasks](/en/3.14.x/develop/cli/sso-users/common-tasks)
- **What your session can and can't do**: [Scope and Limitations](/en/3.14.x/develop/cli/sso-users/scope-and-limitations)

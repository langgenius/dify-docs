...
See the [help reference](/en/3.14.x/develop/cli/reference/help#machine-readable-help) for that discovery surface, and [Install the difyctl Skill](/en/3.14.x/develop/cli/integrate-agents/install-the-difyctl-skill) for the full integration.

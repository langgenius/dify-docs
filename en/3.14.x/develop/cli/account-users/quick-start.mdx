...
Before you start, make sure `difyctl` is [installed](/en/3.14.x/develop/cli/install).
...
1. Sign in to your company's Dify host. Use the [console API URL](/en/3.14.x/deploy/advanced-configuration/environment-variables#console_api_url) for your instance.
...
- **The everyday commands, copy-paste ready**: [Common Tasks](/en/3.14.x/develop/cli/account-users/common-tasks)
- **Where your token lives and how sessions work**: [Authenticate](/en/3.14.x/develop/cli/account-users/authenticate)
- **Everything else you can do with `difyctl`**: [Command Index](/en/3.14.x/develop/cli/reference/command-index)

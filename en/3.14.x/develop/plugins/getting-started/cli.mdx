...
<Note>
This is the Dify Plugin CLI (the `dify` command) for building plugins. It is not the Dify CLI ([difyctl](/en/3.14.x/develop/cli/introduction)), which runs and manages Dify apps from the command line.
</Note>

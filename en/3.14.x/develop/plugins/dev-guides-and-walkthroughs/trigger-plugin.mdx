...
<Frame>
  ![Trigger Plugin Intro](/images/develop-plugin/dev-guide/trigger-plugin-intro.png)
</Frame>
...
<Frame>
  ![Paste URL to Create a New Subscription](/images/develop-plugin/dev-guide/trigger-plugin-manual-webhook-setup.png)
</Frame>
...
<Tabs>
    ...
    <Tab title="github.py">
        ...
        <Frame>
          ![Manual Setup](/images/develop-plugin/dev-guide/trigger-plugin-manual-webhook-setup-config.png)
        </Frame>
...
<Tabs>
    <Tab title="github.yaml">
        ...
        - `oauth_schema` (optional): Required for subscription creation via OAuth. For details on how to define it, see [Add OAuth Support to Your Tool Plugin](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/tool-oauth).
    </Tab>
    <Tab title="github.py">
...
<Frame>
  ![OAuth & API Key Options](/images/develop-plugin/dev-guide/trigger-plugin-oauth-apikey.png)
</Frame>

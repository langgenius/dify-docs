...
description: Build a Dify 1.9.0+ data source plugin that feeds documents into the knowledge pipeline
---
...
- [Step 2: Knowledge Pipeline Orchestration](/en/3.14.x/use/knowledge/knowledge-pipeline/knowledge-pipeline-orchestration)
- [Dify Plugin Development: Hello World Guide](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/tool-plugin)
...
<Info>
  To learn how to inherit from a parent class to implement plugin functionality, see [Tool Plugin: Write the Tool Code](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/tool-plugin#4-write-the-tool-code).
</Info>
...
<Info>
  For more about creating a provider YAML file, see [Tool Plugin: Add Third-Party Service Credentials](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/tool-plugin#2-add-third-party-service-credentials).
</Info>

<Info>
  Data source plugins support authentication via OAuth 2.0 or API Key.

  To configure OAuth, see [Add OAuth Support to Your Tool Plugin](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/tool-oauth).
</Info>
...
<Info>
  For the plugin publishing process, see [Publishing Plugins](/en/3.14.x/develop/plugins/publishing/marketplace-listing/release-overview).
</Info>

...
In this guide, you'll build an AI-powered Slack Bot that answers user questions right inside Slack. If you haven't developed a plugin before, read the [Plugin Development Quick Start Guide](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/tool-plugin) first.
...
- **Dify plugin development tool**: See [Initializing the Development Tool](/en/3.14.x/develop/plugins/getting-started/cli).
...
Before you start coding, make sure you've read [Quick Start: Developing an Extension Plugin](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/endpoint) or have built a Dify plugin before.
...
For additional details on reverse-invoking Dify services within a plugin, see [Reverse Invocation: App](/en/3.14.x/develop/plugins/features-and-specs/advanced-development/reverse-invocation-app).
...
You can now upload it to the [Dify Marketplace repository](https://github.com/langgenius/dify-plugins) for public release. Before publishing, ensure your plugin meets the [Publishing to Dify Marketplace Guidelines](/en/3.14.x/develop/plugins/publishing/marketplace-listing/release-to-dify-marketplace). Once approved, your code is merged into the main branch, and the plugin goes live on the [Dify Marketplace](https://marketplace.dify.ai/).

---

## Related Resources

- [Plugin Development Basics](/en/3.14.x/develop/plugins/getting-started/getting-started-dify-plugin): Comprehensive overview of Dify plugin development
- [Plugin Development Quick Start Guide](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/tool-plugin): Start developing plugins from scratch
- [Develop an Extension Plugin](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/endpoint): Extension plugin development
- [Reverse Invocation of Dify Services](/en/3.14.x/develop/plugins/features-and-specs/advanced-development/reverse-invocation): How to call Dify platform capabilities
- [Reverse Invocation: App](/en/3.14.x/develop/plugins/features-and-specs/advanced-development/reverse-invocation-app): How to call apps within the platform
- [Publishing Plugins](/en/3.14.x/develop/plugins/publishing/marketplace-listing/release-overview): The publishing process
- [Publishing to Dify Marketplace](/en/3.14.x/develop/plugins/publishing/marketplace-listing/release-to-dify-marketplace): Marketplace publishing guide
- [Endpoint Detailed Definition](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/endpoint): Endpoint reference
...
- [Develop an Extension Plugin](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/endpoint)
- [Develop a Model Plugin](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/creating-new-model-provider)
- [Bundle Plugins: Packaging Multiple Plugins](/en/3.14.x/develop/plugins/features-and-specs/advanced-development/bundle)

**Plugin Interface Docs**:

- [Defining Plugin Information via Manifest File](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/plugin-info-by-manifest): Manifest structure
- [Endpoint](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/endpoint): Endpoint reference
- [Reverse Invocation](/en/3.14.x/develop/plugins/features-and-specs/advanced-development/reverse-invocation): Calling Dify capabilities from a plugin
- [General Specifications](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/general-specifications): Tool specifications
- [Model Schema](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/model-schema): Model schema reference

...
To set up the scaffolding tool, see [Initializing Development Tools](/en/3.14.x/develop/plugins/getting-started/cli).
...
<Tip>
If you are already familiar with plugin development and don't need a template, see the [General Specifications](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/general-specifications) guide to build any plugin type.
</Tip>
...
- The sub-level structure of `credentials_for_provider` must meet the requirements in [General Specifications](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/general-specifications).
...
This code sends a request to `serpapi` and uses `self.create_json_message` to return formatted JSON data. To learn more about return data types, see [Remote Debugging Plugins](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/remote-debug-a-plugin) and [Persistent Storage KV](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/persistent-storage-kv).
...
To publish the plugin to the Dify Marketplace, make sure it follows the specifications in [Publish to Dify Marketplace](/en/3.14.x/develop/plugins/publishing/marketplace-listing/release-to-dify-marketplace). After the review passes, the code is merged into the main branch and automatically released on the [Dify Marketplace](https://marketplace.dify.ai/).

For the full process, see the [Publishing Overview](/en/3.14.x/develop/plugins/publishing/marketplace-listing/release-overview).

## Explore More

### Quick Start

- [Developing Extension Plugins](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/endpoint)
- [Developing Model Plugins](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/creating-new-model-provider)
...
- [General Specifications](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/general-specifications): Manifest structure and tool specifications.
- [Endpoint](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/endpoint): Detailed Endpoint definition.
- [Reverse Invocation](/en/3.14.x/develop/plugins/features-and-specs/advanced-development/reverse-invocation): Reverse invocation of Dify capabilities.
- [Model Schema](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/model-schema): Models.
- [Agent Plugins](/en/3.14.x/develop/plugins/features-and-specs/advanced-development/reverse-invocation): Extending Agent strategies.

## Next Steps

- [Remote Debugging Plugins](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/remote-debug-a-plugin): Learn more advanced debugging techniques.
- [Persistent Storage](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/persistent-storage-kv): Use data storage in plugins.
- [Slack Bot Plugin Development Example](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/develop-a-slack-bot-plugin): A more complex plugin development case.
- [Tool Plugin](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/tool): Advanced features of tool plugins.

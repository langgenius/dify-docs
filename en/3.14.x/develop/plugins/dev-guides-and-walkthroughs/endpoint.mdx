...
- **`settings`** (map[string] [ProviderConfig](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/general-specifications#providerconfig)): Endpoint configuration definition.
...
If you're new to plugin development, start with [Getting Started with Plugin Development](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/tool-plugin) and the [Developer Cheatsheet](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/cheatsheet).

## Related Resources

- [Basic Concepts of Plugin Development](/en/3.14.x/develop/plugins/getting-started/getting-started-dify-plugin): The overall architecture of plugin development.
- [Neko Cat Example](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/endpoint): An example of extension plugin development.
- [General Specifications Definition](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/general-specifications): Common structures like ProviderConfig.
- [Develop a Slack Bot Plugin Example](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/develop-a-slack-bot-plugin): Another plugin development example.
- [Getting Started with Plugin Development](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/tool-plugin): Develop a plugin from scratch.
- [Reverse Invocation of Dify Services](/en/3.14.x/develop/plugins/features-and-specs/advanced-development/reverse-invocation-app): Use the reverse invocation feature.

...
If you have not built a plugin yet, start with the [Tool Plugin walkthrough](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/tool-plugin).
...
<Tabs>
  <Tab title="Project files">
    ...
    See [General Specifications](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/general-specifications) for manifest fields and [Privacy Guidelines](/en/3.14.x/develop/plugins/publishing/standards/privacy-protection-guidelines) for the privacy policy.
  </Tab>
  ...
  <Tab title="Language">
    ...
    - **`README.md`** must contain no Chinese characters. Add translations as `readme/README_<lang>.md` instead. See [Multilingual README](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/multilingual-readme).
  </Tab>
</Tabs>
...
<Steps>
  <Step title="Read the Plugin Development Guidelines">
    Skim the [Plugin Development Guidelines](/en/3.14.x/develop/plugins/publishing/standards/contributor-covenant-code-of-conduct). Reviewers use them to judge non-mechanical concerns: uniqueness, brand alignment, content quality, IP, and maintenance commitment.
  </Step>
  <Step title="Write your privacy policy">
    Create `PRIVACY.md` in the plugin root (or host it and put the URL in the manifest). Follow [Privacy Guidelines](/en/3.14.x/develop/plugins/publishing/standards/privacy-protection-guidelines): declare what data the plugin and any third-party services it calls collect.
  </Step>
...
- **Versioning.** Bump `version` in `manifest.yaml`, repackage, open a new PR with the new `.difypkg`. The [Auto-publish PR workflow](/en/3.14.x/develop/plugins/publishing/marketplace-listing/plugin-auto-publish-pr) automates this from a GitHub Action.
...
<CardGroup cols={2}>
  <Card title="Publishing Overview" icon="signs-post" href="/en/3.14.x/develop/plugins/publishing/marketplace-listing/release-overview">
    Compare Marketplace, GitHub, and local-file distribution.
  </Card>
  <Card title="Plugin Development Guidelines" icon="clipboard-check" href="/en/3.14.x/develop/plugins/publishing/standards/contributor-covenant-code-of-conduct">
    The full content and quality bar reviewers apply.
  </Card>
  <Card title="Privacy Guidelines" icon="shield-halved" href="/en/3.14.x/develop/plugins/publishing/standards/privacy-protection-guidelines">
    How to write a `PRIVACY.md` that passes review.
  </Card>
  <Card title="Auto-publish PR Workflow" icon="robot" href="/en/3.14.x/develop/plugins/publishing/marketplace-listing/plugin-auto-publish-pr">
    GitHub Action that packages and opens the PR for you on every push.
  </Card>
  <Card title="Multilingual README" icon="language" href="/en/3.14.x/develop/plugins/features-and-specs/plugin-types/multilingual-readme">
    Add `readme/README_<lang>.md` files for non-English users.
  </Card>
  <Card title="General Specifications" icon="file-code" href="/en/3.14.x/develop/plugins/features-and-specs/plugin-types/general-specifications">

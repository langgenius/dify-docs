...
- **Works end-to-end.** Tested via [remote debugging](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/remote-debug-a-plugin); production-ready.
...
- **Privacy policy ready.** See [Privacy Guidelines](/en/3.14.x/develop/plugins/publishing/standards/privacy-protection-guidelines).
...
You **must** declare whether your plugin collects personal data and, if so, what types. The full guidelines are in [Privacy Guidelines](/en/3.14.x/develop/plugins/publishing/standards/privacy-protection-guidelines).
...
- [Publishing Overview](/en/3.14.x/develop/plugins/publishing/marketplace-listing/release-overview)
- [Publish to Dify Marketplace](/en/3.14.x/develop/plugins/publishing/marketplace-listing/release-to-dify-marketplace)
- [Privacy Guidelines](/en/3.14.x/develop/plugins/publishing/standards/privacy-protection-guidelines)
- [Remote Debugging](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/remote-debug-a-plugin)

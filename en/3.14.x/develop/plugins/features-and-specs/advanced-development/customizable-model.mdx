...
Unlike [predefined models](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/model-schema), no YAML file defines which parameters a model supports, so you must generate the parameter schema dynamically.
...
<Card title="Debug Plugin" icon="link" href="/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/cheatsheet">
</Card>
...
- [Develop Extension Plugin](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/general-specifications)
- [Develop Tool Plugin](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/tool-plugin)
- [Bundle Plugins: Package Multiple Plugins](/en/3.14.x/develop/plugins/features-and-specs/advanced-development/bundle)

**Plugins Endpoint Docs**:

- [Manifest](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/plugin-info-by-manifest) Structure
- [Endpoint](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/endpoint) Definitions
- [Reverse-Invocation of the Dify Service](/en/3.14.x/develop/plugins/features-and-specs/advanced-development/reverse-invocation)
- [Tools](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/tool)
- [Models](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/model-schema)

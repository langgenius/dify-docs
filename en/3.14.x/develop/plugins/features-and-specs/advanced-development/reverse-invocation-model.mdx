...
A plugin can reverse invoke Dify's internal LLM capabilities, including all model types and functions within the platform, such as TTS and Rerank. If you are unfamiliar with the basics of reverse invocation, first read [Reverse Invocation of Dify Services](/en/3.14.x/develop/plugins/features-and-specs/advanced-development/reverse-invocation).

Every model invocation takes a `ModelConfig` type parameter. Its structure is defined in the [General Specifications Definition](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/general-specifications) and varies slightly by model type.
...
- [Reverse Invocation of Dify Services](/en/3.14.x/develop/plugins/features-and-specs/advanced-development/reverse-invocation) - Understand the fundamental concepts of reverse invocation
- [Reverse Invocation of App](/en/3.14.x/develop/plugins/features-and-specs/advanced-development/reverse-invocation-app) - Learn how to invoke Apps within the platform
- [Reverse Invocation of Tool](/en/3.14.x/develop/plugins/features-and-specs/advanced-development/reverse-invocation-tool) - Learn how to invoke other plugins
- [Model Plugin Development Guide](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/creating-new-model-provider) - Learn how to develop custom model plugins
- [Model Designing Rules](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/model-designing-rules) - Understand the design principles of model plugins

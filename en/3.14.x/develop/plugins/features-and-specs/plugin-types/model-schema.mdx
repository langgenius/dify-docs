...
description: Interfaces and data structures for implementing Dify model plugins, covering LLM, TextEmbedding, Rerank, Speech2Text, Text2Speech, and Moderation models
---
...
<Note>
Before diving into this API reference, we recommend reading [Model Design Rules](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/model-designing-rules) for the conceptual model and [Creating a New Model Provider](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/creating-new-model-provider) for a step-by-step walkthrough.
</Note>
...
- [Model Plugin Introduction](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/model-designing-rules): core concepts of model plugins.
- [Quickly Integrate a New Model](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/creating-new-model-provider): add new models to existing providers.
- [Create a New Model Provider](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/creating-new-model-provider): develop a new model provider from scratch.

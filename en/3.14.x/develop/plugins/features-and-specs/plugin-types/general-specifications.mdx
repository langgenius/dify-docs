...
language: en
title: General Specs
description: Common data structures shared across plugin types, including I18nObject, ProviderConfig, ModelConfig, NodeResponse, and ToolSelector
---

This page covers structures common to all plugin types. Read it alongside [Basic Concepts of Plugin Development](/en/3.14.x/develop/plugins/getting-started/getting-started-dify-plugin) and the [Developer Cheatsheet](/en/3.14.x/develop/plugins/getting-started/cli) for a picture of the overall architecture.
...
<ParamField path="model_type" type="enum">
  Model type enumeration; see [Model Design Rules](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/model-designing-rules#modeltype).
</ParamField>
...
- [Basic Concepts of Plugin Development](/en/3.14.x/develop/plugins/getting-started/getting-started-dify-plugin)—an overview of Dify plugin development
- [Developer Cheatsheet](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/cheatsheet)—quick reference for common commands and concepts
- [Tool Plugin Development Details](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/tool-plugin)—defining plugin information and the tool plugin development process
- [Model Design Rules](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/model-designing-rules)—standards for model configuration

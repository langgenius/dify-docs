...
For the overall plugin architecture, see [Basic Concepts of Plugin Development](/en/3.14.x/develop/plugins/getting-started/getting-started-dify-plugin) and the [Developer Cheatsheet](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/cheatsheet).
...
<ParamField path="plugins" type="object" required>
  ...
  <ParamField path="tools" type="array[string]">
    Plugin extension for [Tool](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/tool-plugin) providers.
  </ParamField>
  
  <ParamField path="models" type="array[string]">
    Plugin extension for [Model](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/model-designing-rules) providers.
  </ParamField>
  
  <ParamField path="endpoints" type="array[string]">
    Plugin extension for [Endpoints](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/develop-a-slack-bot-plugin) providers.
  </ParamField>
  
  <ParamField path="agent_strategies" type="array[string]">
    Plugin extension for [Agent Strategy](/en/3.14.x/develop/plugins/features-and-specs/advanced-development/reverse-invocation) providers.
  </ParamField>
</ParamField>

...
<CardGroup cols={2}>
  ...
  <Card title="User-supplied models" icon="user-pen">
    User configures their own model name and base URL (OpenAI-compatible endpoints, custom deployments). Use `configurate_methods: [customizable-model]` and see [Customizable Model](/en/3.14.x/develop/plugins/features-and-specs/advanced-development/customizable-model).
  </Card>
  ...
  <Card title="Walkthrough" icon="route">
    For an end-to-end example, see [Creating a New Model Provider](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/creating-new-model-provider).
  </Card>
</CardGroup>
...
- [Model Architecture Details](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/model-schema)—architecture specifications for model plugins
- [Quickly Integrate a New Model](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/creating-new-model-provider)—apply these rules to add new models
- [General Specifications](/en/3.14.x/develop/plugins/features-and-specs/plugin-types/general-specifications)—plugin manifest configuration
- [Create a New Model Provider](/en/3.14.x/develop/plugins/dev-guides-and-walkthroughs/creating-new-model-provider)—develop a new model provider plugin

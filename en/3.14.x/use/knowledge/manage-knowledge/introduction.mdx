...
| Permissions             | Defines which workspace members can access the knowledge base.<Note>Members granted access to a knowledge base have all the permissions listed in [Manage Knowledge Content](/en/3.14.x/use/knowledge/manage-knowledge/maintain-knowledge-documents).</Note>|
| Index Method            | Defines how document chunks are processed and organized for retrieval. For more details, see [Select the Index Method](/en/3.14.x/use/knowledge/create-knowledge/setting-indexing-methods#select-the-index-method).|
...
| Retrieval Settings      | Defines how the knowledge base retrieves relevant content. For more details, see [Configure the Retrieval Settings](/en/3.14.x/use/knowledge/create-knowledge/setting-indexing-methods#configure-the-retrieval-settings).|
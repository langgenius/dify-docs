...
<Tip>
    For more about retrieval settings, see [Configure the Retrieval Settings](/en/3.14.x/use/knowledge/create-knowledge/setting-indexing-methods#configure-the-retrieval-settings).
</Tip>

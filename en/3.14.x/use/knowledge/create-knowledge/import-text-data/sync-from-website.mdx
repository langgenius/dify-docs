...
Go to **Settings -- Data Source** and add your Firecrawl API key on the **Firecrawl** card. If the card is missing, install the Firecrawl data source plugin from the Dify Marketplace first.
...
Go to **Settings -- Data Source** and add your Jina Reader API key on the **Jina Reader** card. If the card is missing, install the Jina Reader data source plugin from the Dify Marketplace first.

...
| Compatible [Index Method](/en/3.14.x/use/knowledge/create-knowledge/setting-indexing-methods) | High Quality, Economical | High Quality only |
...
If the results don't perfectly match your expectations, choose the closest configuration; you can manually fine-tune chunks later. See [Manage Knowledge Content](/en/3.14.x/use/knowledge/manage-knowledge/maintain-knowledge-documents) for details.

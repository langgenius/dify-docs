...
- [Agent apps](/en/3.14.x/use/build/new-agent/build#skills)
- [New Agent nodes](/en/3.14.x/use/nodes/agent#new-agent) in Workflow apps

<Info>
By default, every system role except [Restricted Member](/en/3.14.x/use/workspace/roles-and-permissions#system-roles) can view and export library skills. The Owner, Admin, and Editor roles can also create, import, duplicate, edit, and delete them. Only the Owner and Admin roles can publish and restore versions.

Administrators can grant **View Skills**, **Edit Skills**, **Publish Skills**, and **Delete Skills** independently through custom roles. See [Permission Reference](/en/3.14.x/use/workspace/permission-reference#skills) for details.
</Info>
...
<Note>
Restoring a version replaces the current draft with that version. It does not publish the skill or create a new version. Publish the restored draft to make it the latest version.
</Note>

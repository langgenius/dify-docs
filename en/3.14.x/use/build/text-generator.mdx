...
<Tip>
Text Generators support optional features like generating multiple outputs at once, text to speech, and content moderation. See [App Toolkit](/en/3.14.x/use/build/additional-features) for details.
</Tip>
...
See [Environment Variables](/en/3.14.x/deploy/advanced-configuration/environment-variables) for details.
</Info>
...
<Frame>
    ![Save Output](/images/use-dify/workflow/text-generator-save-output.png)
</Frame>
...
<Tip>
Chatbots also support optional features like conversation openers, follow-up suggestions, and more. See [App Toolkit](/en/3.14.x/use/build/additional-features) for details.
</Tip>

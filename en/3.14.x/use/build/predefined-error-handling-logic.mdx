---
title: Handle Errors
description: Choose how LLM, HTTP, Code, and Tool nodes respond when they fail
---

<Frame>
  ![Error Handling Options for Failed Nodes](https://assets-docs.dify.ai/2024/12/6e2655949889d4d162945d840d698649.png)
</Frame>

[LLM](/en/3.14.x/use/nodes/llm), [HTTP](/en/3.14.x/use/nodes/http-request), [Code](/en/3.14.x/use/nodes/code), and [Tool](/en/3.14.x/use/nodes/tools) 
...
- `error_type`: What kind of error happened (see [Error Types](/en/3.14.x/use/debug/error-type))

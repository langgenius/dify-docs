...
- **Web app**: Displays the request form to the web app end user. Not available in workflows started by a Trigger.
  ...
  <Info>
    External clients can drive the web app form lifecycle through the Service API. See [API Integration Flow](/en/3.14.x/develop/api/guides/human-input-flow).
  </Info>

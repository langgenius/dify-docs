...
description: Start workflows automatically on a schedule or in response to external events
---
...
- [Schedule Trigger](/en/3.14.x/use/nodes/trigger/schedule-trigger)
...
- [Integration Trigger](/en/3.14.x/use/nodes/trigger/plugin-trigger)
...
- [Webhook Trigger](/en/3.14.x/use/nodes/trigger/webhook-trigger)

...
<Warning>
    Hidden fields are **not secret**. Values travel in the URL query string and are visible in the browser address bar, browser history, and network traffic. For credentials and API keys, use [Environment Variables](/en/3.14.x/learn/key-concepts#variables) instead.
</Warning>

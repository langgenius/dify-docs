...
If you need the full-featured platform built for production teams, AI-native companies, and enterprises, set up [Arize AX](https://arize.com/products/ax/) through the [Arize integration](/en/3.14.x/use/monitor/integrations/integrate-arize) instead.

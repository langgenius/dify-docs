...
If you'd rather run an open-source stack for local development, experimentation, or single-container self-hosting, set up the [Phoenix integration](/en/3.14.x/use/monitor/integrations/integrate-phoenix) instead.

...
- Workflow / Chatflow apps, as standalone [Tool nodes](/en/3.14.x/use/nodes/tools) or within [Agent nodes](/en/3.14.x/use/nodes/agent#classic-agent)
- [Agent apps](/en/3.14.x/use/build/new-agent/build#tools)
- [Legacy Agent apps](/en/3.14.x/use/build/agent#extend-the-agent-with-dify-tools)
...
<Tabs>
    ...
    <Tab title="MCP" id="mcp">
        ...
        <Tip>
          To publish one of your own Dify apps *as* an MCP server instead, see [Publish as an MCP Server](/en/3.14.x/use/publish/publish-mcp).
        </Tip>

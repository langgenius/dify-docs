...
<CardGroup cols={2}>
  <Card title="Web Apps" icon="globe" href="/en/3.14.x/use/publish/webapp/chatflow-webapp">
    Instant, shareable applications. Perfect for testing ideas or serving end users directly.
  </Card>
  <Card title="API Integration" icon="code" href="/en/3.14.x/develop/api/guides/get-started">
    Build AI into your existing products. Full control over user experience and data flow.
  </Card>
  <Card title="Embed on Websites" icon="window" href="/en/3.14.x/use/publish/webapp/embedding-in-websites">
    Deploy your web app as chat widgets or inline frames on any website.
  </Card>
  <Card title="MCP Server" icon="plug" href="/en/3.14.x/use/publish/publish-mcp">

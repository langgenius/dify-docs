...
When an app should not be open to everyone, you can require authentication and limit who can sign in. Access can be scoped to specific workspace members, or opened to external users who authenticate without a full Dify account. For how external access is set up and administered, see [Web App External User Authentication](/en/3.14.x/administer/authentication/webapp-external-user-auth).
...
<CardGroup cols={2}>
  ...
  <Card title="Website Embedding" icon="window" href="/en/3.14.x/use/publish/webapp/embedding-in-websites">

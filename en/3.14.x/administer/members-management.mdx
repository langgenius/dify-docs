...
If your team doesn't use SSO authentication, members can log in with username and password. Click the **Add** button in the top right corner, then enter the username and email. The system displays the default login password when adding a member for the first time. To add administrators to your team, see [System Administrator Settings](/en/3.14.x/administer/systems/users).

![](https://assets-docs.dify.ai/2025/05/3e4c5dad9b527e2bada27aa0ecaed5a6.png)

#### Add New Members to Workspaces

To add members to a specific workspace, check out [Workspace Management](/en/3.14.x/administer/workspace-management).
...
In the member list, click the dropdown menu on the right side of the member and select **Delete** to remove that member. The deleted member will no longer be able to log in to the workspace, and any resources they previously created (such as apps/knowledge bases) will be automatically transferred to the workspace owner.

![](https://assets-docs.dify.ai/2025/05/2a40fc714d72bfff8af6571b3b395fa5.png)

> **Note:** If the member is an owner of one or more workspaces, they cannot be deleted directly. Please go to the edit page of the respective workspace, assign a new owner, and then proceed with the deletion.
...
<Card title="Automatic Member Sync" icon="user" href="/en/3.14.x/administer/members/synchronization/sync-team-members">
...
Users added from the Settings page have system administrator permissions by default. For more about system administrator operations, see [System Settings](/en/3.14.x/administer/systems/users).
...
Workspaces have four permission groups: Owner, Admin, Editor, Normal.
...
After assigning users to groups, see [Application Publishing: Access Permission Management](/en/3.14.x/use/publish/webapp/web-app-access) to learn how to control Web App access permissions.

### Automatic Sync Group

<Info>
  Automatic department synchronization requires Dify Enterprise Edition version ≥v2.7.0.
</Info>
...
<CardGroup cols={2}>
  <Card title="Azure" icon="microsoft" href="/en/3.14.x/administer/members/synchronization/azure#6-sync-user-groups">
    Automatically sync user groups through Azure.
  </Card>

  <Card title="Okta" icon="key" href="/en/3.14.x/administer/members/synchronization/okta#5-assign-users-and-groups">

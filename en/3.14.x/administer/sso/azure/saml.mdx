...
<Tabs>
  <Tab title="Workspace">
  Click **Admin Backend** → **Authentication** → **Members** → **SSO Identity Provider** → **New Identity Provider** → **New SAML Provider**, and get the Callback URL at the bottom.
  ...
  Click **Admin Backend** → **Authentication** → **Web App** → **SSO Identity Provider** → **New Identity Provider** → **New SAML Provider**, and get the Callback URL at the bottom.
...
<Tabs>
  ...
  <Tab title="WebApp External Users (For External Users)">
  Click **Admin Backend** → **Authentication** → **Web App External User Authentication** → **SSO Identity Provider** → **New Identity Provider** → **New SAML Provider**, and get the Callback URL at the bottom.

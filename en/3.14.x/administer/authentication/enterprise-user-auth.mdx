...
System administrators can navigate to **Admin Console** → **Authentication** → **Members** to centrally configure authentication methods for internal users accessing workspaces and Web Apps.
...
**Configuration Steps:**
1. **Authentication** → **Members** → **Email and Password**
2. Enable the toggle
...
2. Enable "Email and Verification Code" on **Authentication** → **Members** page
...
**Configuration Steps:**
1. Enable "Single Sign-On (SSO)" on **Authentication** → **Members** page
...
For detailed SSO configuration instructions, please refer to [Enterprise SSO Configuration Guide](/en/3.14.x/administer/sso/introduction).

## Access Permission Management

### Workspace

System administrators can enable email and password authentication, email and verification code authentication, and Single Sign-On (SSO) authentication methods in **System Settings** → **Authentication** → **Members**.
...
**Solutions:**
Contact your system administrator to verify SSO configuration at **System Settings** → **Authentication** → **Web App External User Verification**.
</Accordion>
...
**Solutions:**
1. Check **Authentication** → **Members** configuration

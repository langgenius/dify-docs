...
| Compatible [Index Method](/en/self-hosted/use-dify/knowledge/create-knowledge/setting-indexing-methods) | High Quality, Economical | High Quality only |
...
If the results don't perfectly match your expectations, choose the closest configuration; you can manually fine-tune chunks later. See [Manage Knowledge Content](/en/self-hosted/use-dify/knowledge/manage-knowledge/maintain-knowledge-documents) for details.

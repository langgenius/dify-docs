...
<Frame>
  ![Blank Pipeline](/images/use-dify/knowledge/create-knowledge-pipeline-08.png)
</Frame>
...
<Frame>
  ![Template Pipeline](/images/use-dify/knowledge/create-knowledge-pipeline-09.png)
</Frame>
...
<Frame>
  ![Knowledge Pipeline Orchestration 01](/images/use-dify/knowledge/knowledge-pipeline-orchestration-01.png)
</Frame>
...
<Frame>
  ![Notion](/images/use-dify/knowledge/knowledge-pipeline-orchestration-02.png)
</Frame>
...
<Frame>
  ![Jina Reader](/images/use-dify/knowledge/knowledge-pipeline-orchestration-03.png)
</Frame>
...
<Frame>
  ![Knowledge Pipeline Orchestration 04](/images/use-dify/knowledge/knowledge-pipeline-orchestration-04.png)
</Frame>
...
<Tip>
  Need help with authorization? Please check [Authorize Data Source](/en/self-hosted/use-dify/knowledge/knowledge-pipeline/authorize-data-source) for detailed guidance on authorizing different data sources.
</Tip>
...
<Tip>
  To develop a custom data processing plugin that extracts multimodal data for multimodal embedding and retrieval, see [Build Tool Plugins for Multimodal Data Processing in Knowledge Pipelines](/en/self-hosted/develop-plugin/dev-guides-and-walkthroughs/develop-multimodal-data-processing-tool).
</Tip>
...
<Frame>
  ![Knowledge Pipeline Orchestration 4 01](/images/use-dify/knowledge/knowledge-pipeline-orchestration-4-01.png)
</Frame>
...
<Tip>
  For more information, please refer to the [Document Extractor](/en/self-hosted/use-dify/nodes/doc-extractor).
</Tip>
...
<Frame>
  ![Dify Extractor](/images/use-dify/knowledge/knowledge-pipeline-orchestration-05.png)
</Frame>
...
<Frame>
  ![Unstructured](/images/use-dify/knowledge/knowledge-pipeline-orchestration-07.png)
</Frame>
...
<Frame>
  ![Chunk Structure](/images/use-dify/knowledge/knowledge-pipeline-orchestration-08.png)
</Frame>
...
<Tip>
  ...
  <Frame>
    ![Multimodal Knowledge Base](/images/use-dify/knowledge/multimodal-knowledge-base.png)
  </Frame>
...
<Info>
  For more details, see [Specify the Index Method and Retrieval Settings](/en/self-hosted/use-dify/knowledge/create-knowledge/setting-indexing-methods).
</Info>
...
You can manually edit auto-generated summaries or regenerate them for specific documents later. See [Manage Knowledge Content](/en/self-hosted/use-dify/knowledge/manage-knowledge/maintain-knowledge-documents) for details.
...
User input forms are essential for collecting the initial information your pipeline needs to run effectively. Similar to [the User Input node](/en/self-hosted/use-dify/nodes/user-input) in workflow, this form gathers necessary details from users - such as files to upload, specific parameters for document processing - ensuring your pipeline has all the information it needs to deliver accurate results.
...
1. **Pipeline Orchestration Interface**\
   ...
   <Frame>
     ![](/images/use-dify/knowledge/knowledge-pipeline-orchestration-09.png)
   </Frame>
...
<Frame>
  ![Knowledge Pipeline Orchestration 11](/images/use-dify/knowledge/knowledge-pipeline-orchestration-11.png)
</Frame>
...
**How to create**: Click the `+` button on the right side of a data source to add fields for that specific data source. These fields can only be referenced by that data source and its subsequently connected nodes. ![These Inputs Are Specific to Each Data Source and Its Downstream Nodes](/images/use-dify/knowledge/knowledge-pipeline-orchestration-12.png)

#### Global Inputs for All Entrances

<Frame>
  ![Knowledge Pipeline Orchestration 13](/images/use-dify/knowledge/knowledge-pipeline-orchestration-13.png)
</Frame>
...
<Frame>
  ![Knowledge Pipeline Orchestration 14](/images/use-dify/knowledge/knowledge-pipeline-orchestration-14.png)
</Frame>
...
<Tip>
  For more information about supported field types, see [User Input](/en/self-hosted/use-dify/nodes/user-input).
</Tip>
...
<Frame>
  ![Knowledge Pipeline Orchestration 15](/images/use-dify/knowledge/knowledge-pipeline-orchestration-15.png)
</Frame>
...
<Frame>
  ![Name Knowledge Base](/images/use-dify/knowledge/create-knowledge-pipeline-11.png)
</Frame>
...
<Frame>
  ![Knowledge Pipeline Orchestration 16](/images/use-dify/knowledge/knowledge-pipeline-orchestration-16.png)
</Frame>
...
<Frame>
  ![Knowledge Pipeline Orchestration 17](/images/use-dify/knowledge/knowledge-pipeline-orchestration-17.png)
</Frame>
...
During testing, you can access [History Logs](/en/self-hosted/use-dify/monitor/logs) (track all run records with timestamps, execution status, and input/output summaries) and [Variable Inspector](/en/self-hosted/use-dify/debug/variable-inspect) (a dashboard at the bottom showing input/output data for each node to help identify issues and verify data flow) for efficient troubleshooting and error fixing.

<Frame>
  ![Testing Tools](/images/use-dify/knowledge/knowledge-pipeline-orchestration-18.png)
</Frame>

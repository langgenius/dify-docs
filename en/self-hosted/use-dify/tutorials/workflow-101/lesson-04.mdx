...
<Steps>
  <Step title="Enter the Library">
    ...
    <Frame>
      ![Create Knowledge](/images/use-dify/tutorial/workflow-101-lesson-04/create-knowledge.png)
    </Frame>
  ...
  <Step title="Upload the File">
    ...
    <Frame>
      ![Import from File](/images/use-dify/tutorial/workflow-101-lesson-04/import-from-file.png)
    </Frame>
  </Step>
  <Step title="The 'Chopping' Step (Text Segmentation)">
    ...
    **Chunk Structure**
    ...
    <Frame>
      ![Chunk Structure](/images/use-dify/tutorial/workflow-101-lesson-04/chunk-structure.png)
    </Frame>
    **Index Method**
    ...
    <Frame>
      ![Index Method](/images/use-dify/tutorial/workflow-101-lesson-04/index-method.png)
    </Frame>
  </Step>
  <Step title="Retrieval Settings">
    ...
    <Frame>
      ![Retrieval Setting](/images/use-dify/tutorial/workflow-101-lesson-04/retrieval-setting.png)
    </Frame>
    - **Inverted Index**
    ...
    <Frame>
      ![Document Processing](/images/use-dify/tutorial/workflow-101-lesson-04/document-processing.png)
    </Frame>
  </Step>
...
<Steps>
  <Step title="Add the Node">
    ...
    <Frame>
      ![Add Knowledge Retrieval Node](/images/use-dify/tutorial/workflow-101-lesson-04/add-knowledge-retrieval-node.png)
    </Frame>
  </Step>
  <Step title="Connect Knowledge Base">
    ...
    2. Click the **plus (+)** button next to **Knowledge** to add knowledge.
       ...
       <Frame>
         ![Add Knowledge](/images/use-dify/tutorial/workflow-101-lesson-04/add-knowledge.png)
       </Frame>
    3. Choose **What's Dify**, and click **Add**.

       <Frame>
         ![Select Knowledge](/images/use-dify/tutorial/workflow-101-lesson-04/select-knowledge.png)
       </Frame>
  </Step>
  <Step title="Configure Query Text">
    ...
    <Frame>
      ![Query Text](/images/use-dify/tutorial/workflow-101-lesson-04/query-text.png)
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Add Context">
    ...
    2. Click it and select **result** from the Knowledge Retrieval node.
       ...
       <Frame>
         ![Add Context](/images/use-dify/tutorial/workflow-101-lesson-04/add-context.png)
       </Frame>
  </Step>
  <Step title="Update the Prompt">
    ...
    <Frame>
      ![Update Prompt](/images/use-dify/tutorial/workflow-101-lesson-04/update-prompt.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![Test Result](/images/use-dify/tutorial/workflow-101-lesson-04/test-result.png)
</Frame>

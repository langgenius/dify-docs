...
<Frame>
  ![Parameter Extractor](/images/use-dify/tutorial/workflow-101-lesson-06/parameter-extractor.png)
</Frame>
...
<Steps>
  <Step title="Add the Node">
    ...
    <Frame>
      ![Add Parameter Extractor](/images/use-dify/tutorial/workflow-101-lesson-06/add-parameter-extractor.png)
    </Frame>
  </Step>
  <Step title="Set the Input">
    ...
    <Frame>
      ![Set the Input](/images/use-dify/tutorial/workflow-101-lesson-06/set-the-input.png)
    </Frame>
  ...
  <Step title="Add Extract Parameter">
    ...
    <Frame>
      ![Add Extract Parameter](/images/use-dify/tutorial/workflow-101-lesson-06/add-extract-parameter.png)
    </Frame>
    <Info>
      **Parameter Types**
  ...
  <Step title="Finish Adding Extract Parameter">
    ...
    <Frame>
      ![Finish Adding Extract Parameter](/images/use-dify/tutorial/workflow-101-lesson-06/finish-add-extract-parameter.png)
    </Frame>
  </Step>
...
<Frame>
  ![Iteration](/images/use-dify/tutorial/workflow-101-lesson-06/iteration.png)
</Frame>
...
<Steps>
  <Step title="Add the Node">
    ...
    <Frame>
      ![Add Iteration Node](/images/use-dify/tutorial/workflow-101-lesson-06/add-iteration.png)
    </Frame>
    **Advanced Options in Iteration**
    ...
    <Frame>
      ![Advanced Options in Iteration](/images/use-dify/tutorial/workflow-101-lesson-06/advanced-iteration-options.png)
    </Frame>
  ...
  <Step title="Add Knowledge Retrieval Node">
    ...
    <Frame>
      ![Add Knowledge Retrieval Node and Set Query Text](/images/use-dify/tutorial/workflow-101-lesson-06/knowledge-retrieval-query-text.png)
    </Frame>
  </Step>
  <Step title="Add LLM Node">
    ...
    **User**:
    ...
    <Frame>
      ![Add LLM Prompt](/images/use-dify/tutorial/workflow-101-lesson-06/add-llm-and-prompt.png)
    </Frame>
  ...
  <Step title="Set Iteration Output">
    ...
    <Frame>
      ![Set Iteration Output](/images/use-dify/tutorial/workflow-101-lesson-06/set-iteration-output.png)
    </Frame>
  </Step>
  <Step title="Add Final LLM Node">
    ...
    **User**:
    ...
    <Frame>
      ![Add Final LLM Node](/images/use-dify/tutorial/workflow-101-lesson-06/add-final-llm-node.png)
    </Frame>
  </Step>
  <Step title="Final Check">
    ...
    <Frame>
      ![Select Output Variable](/images/use-dify/tutorial/workflow-101-lesson-06/output-variable.png)
    </Frame>
  </Step>
</Steps>

...
- [Schedule Trigger](/en/self-hosted/use-dify/nodes/trigger/schedule-trigger)
...
- [Plugin Trigger](/en/self-hosted/use-dify/nodes/trigger/plugin-trigger)
...
- [Webhook Trigger](/en/self-hosted/use-dify/nodes/trigger/webhook-trigger)

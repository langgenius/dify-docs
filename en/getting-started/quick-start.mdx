...
<iframe className="w-full aspect-video rounded-xl" src="https://youtu.be/opKZRpfd80k" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
...
**IMPORTANT: When you want to reference any variable, type { first and you can see the different variables available in your workflow.**

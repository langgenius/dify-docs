...
> If you need to use OpenAI TTS, `FFmpeg` must be installed on the system for it to function properly. For more details, refer to: [Link](/en/getting-started/install-self-hosted/faqs#id-14.-what-to-do-if-this-error-occurs-in-text-to-speech).

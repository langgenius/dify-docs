...
<CardGroup cols={3}>
  <Card title="Quick Start" icon="play" href="/en/documentation/getting-started/quick-start">
    Start shipping powerful apps in minutes
  </Card>
  <Card title="Concepts" icon="highlighter" iconType="regular" href="/en/documentation/getting-started/key-concepts">
    Core Dify building blocks explained
  </Card>
  <Card title="Self Host" icon="arrow-down-to-line" href="/en/self-hosting/quick-start/docker-compose">
  ...
  <Card title="Tutorials" icon="lightbulb" href="/en/documentation/tutorials/customer-service-bot">

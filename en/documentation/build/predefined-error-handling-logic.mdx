...
[LLM](/en/documentation/nodes/llm), [HTTP](/en/documentation/nodes/http-request), [Code](/en/documentation/nodes/code), and [Tool](/en/documentation/nodes/tools) 
...
- `error_type` - What kind of error happened (see [Error Types](en/documentation/debug/error-types))

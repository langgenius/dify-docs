...
<Card title="Maintain Knowledge Documents" icon="link" href="/en/documentation/knowledge/manage-knowledge/maintain-knowledge-documents">
...
<Card title="Maintain Knowledge Base via API" icon="link" href="/en/documentation/knowledge/manage-knowledge/maintain-dataset-via-api">

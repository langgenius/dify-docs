...
See **Metadata Filtering** in *[Integrate Knowledge Base within Application](/en/documentation/knowledge/integrate-knowledge-within-application)*.

## API Documentation

See *[Maintaining Dataset via API](/en/documentation/knowledge/manage-knowledge/maintain-dataset-via-api)*.

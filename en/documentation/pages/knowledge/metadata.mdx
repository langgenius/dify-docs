...
See **Metadata Filtering** in *[Integrate Knowledge Base within Application](/en/documentation/pages/knowledge/integrate-knowledge-within-application)*.

## API Documentation

See *[Maintaining Dataset via API](/en/documentation/pages/knowledge/manage-knowledge/maintain-dataset-via-api)*.

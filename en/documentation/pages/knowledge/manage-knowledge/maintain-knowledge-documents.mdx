...
Different [chunking modes](/en/documentation/knowledge/create-knowledge/chunking-and-cleaning-text) correspond to different text chunking preview methods:

<Tabs>
  <Tab title="General Mode">
    **General Mode**

    Chunks of text in [General mode](/en/documentation/knowledge/create-knowledge/chunking-and-cleaning-text#general-mode) are independent blocks. If you want to view the complete content of a chunk, click the **full-screen** icon.
  ...
  <Tab title="Parent-child Mode">
    **Parent-child Mode**
    ...
    In [Parent-child](/en/documentation/knowledge/create-knowledge/chunking-and-cleaning-text#parent-child-mode) mode, content is divided into parent chunks and child chunks.
...
[Edit this page](https://github.com/langgenius/dify-docs/edit/main/en/documentation/pages/knowledge/manage-knowledge/maintain-knowledge-documents.mdx) | [Report an issue](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)

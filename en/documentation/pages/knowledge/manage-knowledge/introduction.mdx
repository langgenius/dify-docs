...
* **Indexing Mode**: For detailed explanations, please refer to the [documentation](/en/documentation/knowledge/create-knowledge/setting-indexing-methods).
...
<Card title="Maintain Knowledge Documents" icon="link" href="/en/documentation/pages/knowledge/manage-knowledge/maintain-knowledge-documents">
...
<Card title="Maintain Knowledge Base via API" icon="link" href="/en/documentation/pages/knowledge/manage-knowledge/maintain-dataset-via-api">

...
<img
  ...
  alt="Gst Deeper Dive Workflow Pn"
  style={{ width:"100%" }}
/>
...
<img
  src="/images/start_input_field.png"
  alt="Start Input Field Pn"
  title="Start Input Field Pn"
  className="mx-auto"
  style={{ width:"77%" }}
/>
...
<img
  src="/images/parameter_extractor.png"
  alt="Parameter Extractor Pn"
  title="Parameter Extractor Pn"
  className="mx-auto"
  style={{ width:"75%" }}
/>
...
<img
  src="/images/list_operator.png"
  alt="List Operator Pn"
  className="mx-auto"
  style={{ width:"70%" }}
/>
...
<img
  src="/images/integrate_information.png"
  alt="Integrate Information Pn"
  className="mx-auto"
  style={{ width:"78%" }}
/>
...
3. Click the LLM node to configure it:
   ...
   4. In the system prompt field, paste the following:
      ...
      <Warning>
        ...
        <img
          src="/images/reference_variable.png"
          alt="Reference Variable Pn"
          title="Reference Variable Pn"
          className="mx-auto"
          style={{ width:"58%" }}
        />
      </Warning>
...
3. After the Identity Style node, add another LLM node and configure it:
   ...
   4. Enable structured output.
      ...
      <img
        src="/images/structured_output.png"
        alt="Structured Output Pn"
        title="Structured Output Pn"
        className="mx-auto"
        style={{ width:"64%" }}
      />
...
1. Make sure your Checklist is clear.
   ...
   ![Clear Checklist Pn](/images/clear_checklist.png)

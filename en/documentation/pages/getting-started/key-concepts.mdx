...
- **[User Input](/en/pages/documentation/nodes/user-input)**: Direct user interaction or API call invokes the app.

- **[Trigger](/en/pages/documentation/nodes/trigger/overview)**: The application runs automatically on a schedule or in response to a specific third-party event.
...
Unlike workflow, chatflow can't use [Trigger](/en/pages/documentation/nodes/trigger/overview) to start.
...
**Inputs**: You can specify any number of input variables at the [User Input](/en/pages/documentation/nodes/user-input) node for your app's end users to fill in.

...
Dify records detailed logs every time your workflow runs. You can see what happened at both the application level and for individual nodes.

<Info>
For logs from live users after publishing, see [Logs and Annotation](/en/guides/annotation/logs).
</Info>

...
<Info>
  For detailed file upload configuration and advanced document processing features, see the [File Upload guide](/en/guides/workflow/additional-features).
</Info>
...
[Edit this page](https://github.com/langgenius/dify-docs/edit/main/en/documentation/pages/nodes/doc-extractor.mdx) | [Report an issue](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)

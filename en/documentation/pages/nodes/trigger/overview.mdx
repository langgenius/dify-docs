...
- [Schedule Trigger](/en/documentation/pages/nodes/trigger/schedule-trigger)
...
- [Plugin Trigger](/en/documentation/pages/nodes/trigger/plugin-trigger)
...
- [Webhook Trigger](/en/documentation/pages/nodes/trigger/webhook-trigger)

...
<Info>
  Configure at least one model provider in **System Settings → Model Providers** before using LLM nodes. See the [Model Configuration Guide](/en/guides/model-configuration/readme) for setup instructions.
</Info>

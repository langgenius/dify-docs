...
<Info>
  Configure at least one model provider in **System Settings → Model Providers** before using LLM nodes. See [how to install model plugins](/en/documentation/pages/workspace/plugins) for setup instructions.
</Info>
...
[Edit this page](https://github.com/langgenius/dify-docs/edit/main/en/documentation/pages/nodes/llm.mdx) | [Report an issue](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)

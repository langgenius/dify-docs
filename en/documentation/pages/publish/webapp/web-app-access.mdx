...
<Info>
Only Workspace Owner, Admin, and Editor roles can create and publish web apps. See [Member Permission Management](/en-us/administrator-guide/members-management#member-permission-management) for role details.
</Info>
...
<Card title="Embed in Website" icon="link" href="/en-us/user-guide/application-publishing/embedding-in-websites">
  Get embed code to add your app to other websites
</Card>

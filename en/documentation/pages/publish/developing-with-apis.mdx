...
Dify's API lets you integrate AI capabilities into your existing applications without building AI infrastructure from scratch. You get all the power of large language models with the flexibility to create custom user experiences.

## Why Use Dify APIs

<CardGroup cols={2}>
  <Card title="Skip Backend Complexity" icon="server">
    Access LLM capabilities directly from frontend apps without managing AI infrastructure
  </Card>
  <Card title="Visual App Management" icon="eye">
    Design and update AI behavior visually—changes flow to all API consumers instantly
  </Card>
  <Card title="Provider Flexibility" icon="shuffle">
    Switch between AI providers and manage API keys centrally without code changes  
  </Card>
  <Card title="Built-in Monitoring" icon="chart-line">
    Get logs, analytics, and user activity tracking out of the box
  </Card>
</CardGroup>
...
<Info>
Your API automatically inherits all features from your Dify app—prompts, knowledge bases, tools, and model configurations.
</Info>
...
**Best Practices:**
- Store API keys as environment variables in your backend
- Implement rate limiting on your side to prevent excessive usage
- Add request validation before forwarding to Dify APIs
...
[Edit this page](https://github.com/langgenius/dify-docs/edit/main/en/guides/application-publishing/developing-with-apis.mdx) | [Report an issue](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)

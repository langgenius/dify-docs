...
<Card title="Advanced Access Management" icon="shield-check" href="/en/documentation/publish/web-app-access">
...
<CardGroup cols={2}>
  ...
  <Card title="Website Embedding" icon="window" href="/en/documentation/publish/embedding-in-websites">

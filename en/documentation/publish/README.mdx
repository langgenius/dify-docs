...
<CardGroup cols={2}>
  <Card title="Web Apps" icon="globe" href="/en/documentation/publish/webapp/chatflow-webapp">
    Instant, shareable applications. Perfect for testing ideas or serving end users directly.
  </Card>
  <Card title="API Integration" icon="code" href="/en/documentation/publish/developing-with-apis">
    Build AI into your existing products. Full control over user experience and data flow.
  </Card>
  <Card title="Embed on Websites" icon="window" href="/en/documentation/publish/webapp/embedding-in-websites">
    Deploy your web app as chat widgets or inline frames on any website.
  </Card>
  <Card title="MCP Server" icon="plug" href="/en/documentation/publish/publish-mcp">

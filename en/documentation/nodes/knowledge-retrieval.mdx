...
<Info>
  Create and populate knowledge bases before using this node. See the [knowledge base creation guide](/en/documentation/knowledge/create-knowledge/introduction) for setup instructions.
</Info>

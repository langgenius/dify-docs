...
<Info>
    ...
    End nodes are only for Workflow applications. Chatflows use the [Answer](/en/documentation/nodes/answer) node instead to deliver responses during the conversation flow.
</Info>

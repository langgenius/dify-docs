...
- [Schedule Trigger](/en/documentation/nodes/trigger/schedule-trigger)
...
- [Plugin Trigger](/en/documentation/nodes/trigger/plugin-trigger)
...
- [Webhook Trigger](/en/documentation/nodes/trigger/webhook-trigger)

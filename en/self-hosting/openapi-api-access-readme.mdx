...
<Card title="API Access" icon="code" horizontal href="/api-reference/chat/send-chat-message">
...
<Card title="Sync" icon="rotate" horizontal href="https://github.com/langgenius/dify/tree/main/web/app/components/develop/template">
...
[Edit this page](https://github.com/langgenius/dify-docs/edit/main/en/self-hosting/openapi-api-access-readme.mdx) | [Report an issue](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)

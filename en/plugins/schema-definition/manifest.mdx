...
{/* 
  ...
  /plugin-dev-en/0411-plugin-info-by-manifest.en
*/}

<Card title="This Documentation is Being Deprecated" icon="circle-exclamation" href="/plugin-dev-en/0411-plugin-info-by-manifest.en">

...
For detailed instructions on preparing the plugin development scaffolding tool, please refer to [Initializing Development Tools](/en/initialize-development-tools).

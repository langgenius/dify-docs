...
{/* 
  ...
  /plugin-dev-en/0321-plugin-auto-publish-pr.en
*/}

<Card title="This Documentation is Being Deprecated" icon="circle-exclamation" href="/plugin-dev-en/0321-plugin-auto-publish-pr.en">

...
1. Develop and test your plugin according to the [Plugin Developer Guidelines](/en/plugin-developer-guidelines).
2. Write a [Plugin Privacy Policy](/en/plugin-privacy-protection-guidelines) for your plugin in line with Dify’s privacy policy requirements. In your plugin’s [Manifest](/en/../../schema-definition/manifest) file, include the file path or URL for this privacy policy.
...
The Contributor Agreement mentioned above refers to [Plugin Developer Guidelines](/en/plugin-developer-guidelines).
</Info>
...
* Check if the plugin’s [Manifest](/plugins/schema-definition/manifest) file follows format specifications and includes valid author contact information.

**3. Plugin Functionality and Relevance**

* Test plugins according to [Plugin Development Guidelines](/en/plugin-developer-guidelines).

...
See the [Initialize Development Tools](/en/../quick-start/develop-plugins/initialize-development-toolsx) tutorial for dependency installation and configuration steps.

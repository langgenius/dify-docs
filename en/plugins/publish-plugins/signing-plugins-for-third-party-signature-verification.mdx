...
{/* 
  ...
  /plugin-dev-en/0312-third-party-signature-verification.en
*/}

<Card title="This Documentation is Being Deprecated" icon="circle-exclamation" href="/plugin-dev-en/0312-third-party-signature-verification.en">

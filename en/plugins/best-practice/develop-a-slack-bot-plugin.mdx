...
- **Dify plugin developing tool**: For more information, see [Initializing the Development Tool](/en/../tool-initializationx).
...
Now we’ll dive into the actual coding. Before starting, make sure you’ve read [Quick Start: Developing an Extension Plugin](/en/../extensionx) or have already built a Dify plugin before.
...
You can now upload it to the [Dify Marketplace repository](https://github.com/langgenius/dify-plugins) for public release. Before publishing, ensure your plugin meets the [Plugin Publishing Guidelines](/zh-hans/plugins/publish-plugins/publish-to-dify-marketplace). Once approved, your code is merged into the main branch, and the plugin goes live on the [Dify Marketplace](https://marketplace.dify.ai/).
...
**Quick Starts:**
- [Develop an Extension Plugin](/en/../extension)
- [Develop a Model Plugin](/en/../model/)
- [Bundle Plugins: Packaging Multiple Plugins](/en/../bundle)

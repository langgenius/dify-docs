...
{/* 
  ...
  /plugin-dev-en/0432-develop-a-slack-bot-plugin.en
*/}

<Card title="This Documentation is Being Deprecated" icon="circle-exclamation" href="/plugin-dev-en/0432-develop-a-slack-bot-plugin.en">

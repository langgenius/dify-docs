...
This guide shows how to deploy a local MCP server using the [dify-docs-mintlify repository](https://github.com/langgenius/dify-docs-mintlify). This enables natural conversations between LLMs and documentation.

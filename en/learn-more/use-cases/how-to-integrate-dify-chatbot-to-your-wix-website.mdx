---
title: Integrating Dify Chatbot into Your Wix Website
---
...
Assuming you've already created a [Dify AI application](/guides/application-orchestrate/creating-an-application), follow these steps to acquire the iFrame code snippet:

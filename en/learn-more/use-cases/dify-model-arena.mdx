...
Before testing, click **“Profile → Model Provider”** (top-right corner) and follow the prompts to manually add the API keys for multiple models. For more details, please check [here](/guides/model-configuration)

...
> For compliance-sensitive industries like finance and legal, Dify offers [**Private Deployment of DeepSeek + Dify: Build Your Own AI Assistant**](/en/./private-ai-ollama-deepseek-difyx):
>
...
> If the link is inaccessible, consider deploying DeepSeek locally. See the [local deployment guide](/en/./private-ai-ollama-deepseek-difyx) for more details.
...
[Retrieval-Augmented Generation (RAG)](/zh-hans/learn-more/extended-reading/retrieval-augment) is an advanced technique that enhances AI responses by retrieving relevant knowledge. By providing the model with necessary contextual information, it improves response accuracy and relevance. When you upload internal documents or domain-specific materials, the AI can generate more informed answers based on this knowledge.

#### 3.1 Create a Knowledge Base

Upload documents containing information you want the AI to analyze. To ensure DeepSeek accurately understands document content, it is recommended to use the **Parent-Child Segmentation** mode. This preserves document hierarchy and context. See [Create a Knowledge Base](/zh-hans/guides/knowledge-base/create-knowledge-and-upload-documents) for detailed steps.
...
* [Workflow](/zh-hans/guides/workflow)
* [File Upload](/zh-hans/guides/workflow/file-upload)
* [Deploy DeepSeek + Dify Locally to Build a Private AI Assistant](/en/./private-ai-ollama-deepseek-difyx)

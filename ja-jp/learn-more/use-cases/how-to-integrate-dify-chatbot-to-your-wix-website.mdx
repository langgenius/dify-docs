---
title: DifyチャットボットをWixサイトに統合する方法
---
...
すでに[Dify AIアプリケーション](/v/ja-jp/guides/application-orchestrate/creating-an-application)を作成していると仮定し、以下の手順に従ってiFrameコードスニペットを取得してください：

...
## 3. Difyの基本的なチャットボットアプリケーションの作成（[DifyをWeChatエコシステムに接続する方法](/en/./dify-on-wechat)からの抜粋）

まず、[Dify公式アプリケーションプラットフォーム](https://cloud.dify.ai/signin)にログインします。GithubまたはGoogleのアカウントでログインすることができます。また、Dify公式チュートリアル[Docker Composeによるデプロイ | 日本語 | Dify](/v/ja-jp/getting-started/install-self-hosted/docker-compose)を参照して、プライベートデプロイを行うことも可能です。Difyはオープンソースプロジェクトであり、プライベートデプロイをサポートしています。
...
<img
src="../../.gitbook/assets/dify-on-whatsapp/twilio1.png"
className="mx-auto"
alt=""
/>
...
<img
src="../../.gitbook/assets/dify-on-whatsapp/lt1.png"
className="mx-auto"
alt=""
/>
...
<img
src="../../.gitbook/assets/dify-on-whatsapp/twilio2.png"
className="mx-auto"
alt=""
/>
...
<img
src="../../.gitbook/assets/dify-on-whatsapp/twilio3.png"
className="mx-auto"
alt=""
/>

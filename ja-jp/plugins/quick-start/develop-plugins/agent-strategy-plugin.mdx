...
プラグイン開発の足場ツールを準備する方法については、[開発ツールの初期化](/en/initialize-development-tools)を参照してください。
...
完全な実装については、モデル呼び出しの[サンプルコード](/en/agent-strategy-plugin#diao-yong-gong-ju-1)を参照してください。
...
完全な機能コードについては、ツール呼び出しの[サンプルコード](/en/agent-strategy-plugin#diao-yong-gong-ju-1)を参照してください。
...
作成したプラグインは、[Dify Plugins コードリポジトリ](https://github.com/langgenius/dify-plugins)にアップロードして公開できます。アップロードする前に、プラグインが[プラグイン公開規約](/en/../../publish-plugins/publish-to-dify-marketplace)に準拠していることをご確認ください。審査に合格すると、コードはメインブランチにマージされ、[Dify Marketplace](https://marketplace.dify.ai/)に自動的に公開されます。

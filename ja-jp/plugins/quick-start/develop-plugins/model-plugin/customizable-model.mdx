...
*   **モデルパラメータのスキーマ**
    ...
    [事前定義されたモデルタイプ](/en/integrate-the-predefined-model)とは異なり、YAMLファイルにモデルがサポートするパラメータが事前に定義されていないため、モデルパラメータのスキーマを動的に生成する必要があります。
...
<Card title="publish-to-dify-marketplace.md" icon="link" href="../../../publish-plugins/publish-to-dify-marketplace.md">

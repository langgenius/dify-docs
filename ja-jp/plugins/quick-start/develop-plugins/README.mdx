...
1. [一般的な構造の標準定義](/en/../../schema-definition/general-specifications)
2. [マニフェストの標準定義](/en/../../schema-definition/manifest)
3. [ツールとの接続の標準定義](/en/../../schema-definition/tool)
4. [モデルとの接続の標準定義](/en/../../schema-definition/model/)
5. [エンドポイントの標準定義](/en/../../schema-definition/endpoint)
6. [拡張エージェント策略](/en/../../schema-definition/agent)
7. Difyサービスの逆呼び出し機能
   1. [アプリ](/en/../../schema-definition/reverse-invocation-of-the-dify-service/app "mention")の逆呼び出し
   2. [モデル](/en/../../schema-definition/reverse-invocation-of-the-dify-service/model "mention")の逆呼び出し
   3. [ノード](/en/../../schema-definition/reverse-invocation-of-the-dify-service/node "mention")の逆呼び出し
   4. [ツール](/en/../../schema-definition/reverse-invocation-of-the-dify-service/tool "mention")の逆呼び出し
8. [プラグインの永続化されたストレージ機能](/en/../../schema-definition/persistent-storage)

### 貢献ガイド

Difyプラグインにコードや機能を提供し、公式プラグインに貢献したいとお考えですか？開発者がプラグインの開発と貢献のプロセスをスムーズに理解し、参加できるように、詳細なガイドを用意しています：

*   [マーケットプレイスの公開ガイド](/en/../../publish-plugins/publish-to-dify-marketplace)

    あなたのプラグインを Dify Marketplace に公開し、多くの開発者と成果を共有する方法についてご案内します。

*   [GitHub での公開ガイド](/en/../../publish-plugins/publish-plugin-on-personal-github-repo)

...
<Note> ⚠️ このドキュメントはAIによって自動翻訳されています。不正確な部分がある場合は、[英語版](/en/documentation/pages/nodes/doc-extractor)を参照してください。</Note>
...
<Info>
  詳細なファイルアップロード設定と高度なドキュメント処理機能については、[ファイルアップロードガイド](/en/guides/workflow/additional-features)をご覧ください。
</Info>
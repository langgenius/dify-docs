...
3.  [**Rerankモデル**](/v/ja-jp/learn-more/extended-reading/retrieval-augment/rerank)。**Rerankモデルは検索能力を強化し、LLMの検索結果を改善するために使用されます。**
...
* [Hugging Face](/ja-jp/guides/model-configuration/new-provider#hugging-face)
* [Replicate](/ja-jp/guides/model-configuration/new-provider#replicate)
* [Xinference](/ja-jp/guides/model-configuration/new-provider#xinference)
* [OpenLLM](/ja-jp/guides/model-configuration/new-provider#openllm)

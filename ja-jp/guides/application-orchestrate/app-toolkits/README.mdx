...
アプリケーションツールボックスは、Difyの[アプリケーション](/ja-jp/guides/application-orchestrate#アプリケーションタイプ)に対して様々な付加機能を提供します。
...
詳しい説明は[引用と帰属](/ja-jp/guides/knowledge-base/retrieval-test-and-citation#引用と帰属)をご覧ください。

...
**索引模式**，详细说明请[参考文档](/ja-jp/guides/knowledge-base/knowledge-base-creation/introduction)。

**Embedding 模型**， 修改知识库的嵌入模型，修改 Embedding 模型将对知识库内的所有文档重新嵌入，原先的嵌入将会被删除。

**检索设置**，详细说明请[参考文档](/ja-jp/guides/knowledge-base/knowledge-base-creation/introduction)。
...
### ![](</zh-hans/user-guide/.gitbook/assets/image (7).png>)编辑文本分段

...
5. 等待分段嵌入
6. 完成上传，在应用内关联知识库并使用。你可以参考[在应用内集成知识库](/ja-jp/guides/knowledge-base/integrate-knowledge-within-application)，搭建出能够基于知识库进行问答的 LLM 应用。如需修改或管理知识库，请参考[知识库管理与文档维护](/ja-jp/guides/knowledge-base/knowledge-and-documents-maintenance)。
...
* 社区版可选，默认使用 Dify ETL ，可通过[环境变量](/ja-jp/getting-started/install-self-hosted/environments#knowledge-base-config)开启 Unstructured ETL；

...
<Frame caption="探索 - エージェントアシスタントアプリケーションテンプレート">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/jp/guides/application-orchestrate/25c0a4a8a1c2d3c83ed2011aba737b5e.png" alt="探索 - エージェントアシスタントアプリケーションテンプレート" />
</Frame>
...
<Frame caption="エージェントアシスタントの推論モデルを選択">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/jp/guides/application-orchestrate/d481cf4f733378ed7cbd5f7cb01418fc.png" alt="エージェントアシスタントの推論モデルを選択" />
</Frame>
...
<Frame caption="エージェントアシスタントの指示プロンプトを編成">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/jp/guides/application-orchestrate/76b4807d5d4887740448483692150655.png" alt="エージェントアシスタントの指示プロンプトを編成" />
</Frame>
...
<Frame caption="アシスタントに必要なツールを追加">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/jp/guides/application-orchestrate/f10aa2287ead79c751984ed582625c86.png" alt="アシスタントに必要なツールを追加" />
</Frame>
...
<Frame caption="Function Calling モード">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/jp/guides/application-orchestrate/5e5b435a57721c5fb25a1f5752d7a263.png" alt="Function Calling モード" />
</Frame>

<Frame caption="ReAct モード">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/jp/guides/application-orchestrate/7da96fb0bbc2a17c10ee898699cd3d47.png" alt="ReAct モード" />
</Frame>
...
<Frame caption="会話のオープニングとオープニング質問を設定">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/jp/guides/application-orchestrate/df2f6f23bc2aa6ff65e6560ad45dd94a.png" alt="会話のオープニングとオープニング質問を設定" />
</Frame>
...
<Frame caption="デバッグとプレビュー">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/jp/guides/application-orchestrate/50f9f42ad312c9d37a7134562f346392.png" alt="デバッグとプレビュー" />
</Frame>

### アプリの公開

<Frame caption="アプリをWebアプリとして公開">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/jp/guides/application-orchestrate/1b5934f412cfe0d4c44bfa5ad1a5fc66.png" alt="アプリをWebアプリとして公開" />
</Frame>

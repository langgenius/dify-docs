...
* 新しいタイプの外部データツールの追加 [外部データツール](/ja-jp/guides/extension/code-based-extension/external-data-tool)
* センシティブコンテンツモデレーション戦略の拡張 [モデレーション](/ja-jp/guides/extension/code-based-extension/moderation)

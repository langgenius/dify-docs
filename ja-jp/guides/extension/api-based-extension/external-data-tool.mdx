...
AIアプリを作成する際、開発者はAPI拡張を通じて外部ツールを利用し、追加データを取得してPromptに組み込むことができます。具体的な手順については[ツール - 外部データツール](/ja-jp/guides/tools/extensions/api-based/external-data-tool)を参照してください。

### 前提条件

まずは[ここの概要を](/ja-jp/guides/extension/api-based-extension/README)読み、APIサービスの基本的な機能の開発と接続を完了してください。

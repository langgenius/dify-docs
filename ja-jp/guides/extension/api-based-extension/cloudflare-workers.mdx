...
<div className="image-side-by-side">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/jp/guides/extension/api-based-extension/9433a486a441713ade6270e9dc6c0544.png" className="mx-auto" alt="Dify に API エンドポイントを追加する" />
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/jp/guides/extension/api-based-extension/72c285e58ec136a1a9a66f61b4b41ca1.png" className="mx-auto" alt="アプリ編集ページに API ツールを追加する" />
</div>

...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>ベクトルデータベース対応</td>
      <td>Qdrant（推奨）、Weaviate、Zilliz/Milvus、Pgvector、Pgvector-rs、Chroma、OpenSearch、TiDB、Tencent Cloud VectorDB、Oracle、Relyt、Analyticdb、Couchbase、OceanBase、Tablestore、Lindorm、OpenGauss</td>
    </tr>
    <tr>
      <td>エージェント技術</td>
      <td>

...
- 可用 Python 3.12+ 用于 [schema 迁移脚本](https://github.com/langgenius/dify-docs/blob/main/assets/migrate_weaviate_collections.py)
...
按照[步骤 A5](#step-a5%3A-migrate-the-schema) 中的相同命令操作。你可以在本地或在 Worker 容器内运行脚本：

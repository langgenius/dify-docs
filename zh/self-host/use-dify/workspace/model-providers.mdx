...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/self-host/use-dify/workspace/model-providers)。</Note>
...
<Tip>
  在 Dify 企业版中，你可以在多个凭据之间自动均衡请求负载。如需了解更多，请 [联系销售](https://dify.ai/pricing)。
</Tip>

...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/self-host/use-dify/workspace/api-extension/api-extension)。</Note>
...
如果 API 扩展运行在你的本机，而 Dify 部署在别处，可使用 [Ngrok](https://ngrok.com) 将本地端点暴露到公网，让 Dify 实例能够访问。操作步骤：
...
详细说明请参考 [使用 Cloudflare Workers 部署 API 扩展](/zh/self-host/use-dify/workspace/api-extension/cloudflare-worker)。

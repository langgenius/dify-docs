...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/self-host/use-dify/publish/publish-mcp)。</Note>


Dify 现在支持将你的应用程序作为 [MCP](https://modelcontextprotocol.io/docs/getting-started/intro)（Model Context Protocol）服务器公开，实现与 Claude Desktop 等 AI 助手和 Cursor 等开发环境的无缝集成。这使得这些工具可以直接与你的 Dify 应用程序交互，就像它们是原生扩展一样。

<Note>
  如果你希望在 Dify 工作流和 Agent 中使用 MCP 工具，请参阅 [此处](/zh/self-host/use-dify/build/mcp)。
</Note>

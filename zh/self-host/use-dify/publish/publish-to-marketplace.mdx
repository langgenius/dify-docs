...
- **个人**：适用于独立创作者。在创作者中心，只有你能查看和管理以个人账户提交的模板。首次登录创作者中心时，系统默认选择个人账户。

- **组织**：适用于希望共同管理模板的团队。创建组织并邀请成员，然后在提交模板前选择该组织。所有组织成员都可管理以该组织提交的模板。
...
模板发布后，可在创作者中心的 **模板** 页面查看使用情况、整体评分和点赞总数。在 **消息** 中，可查看当前所选个人账户或组织名下模板收到的评分、点赞和私密反馈。

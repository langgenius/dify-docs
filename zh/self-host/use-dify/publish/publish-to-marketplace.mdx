...
若要发布模板，请通过 [创作者中心](https://creators.dify.ai) 提交。通过个人账户提交可自行管理模板，通过组织提交则可与团队共同管理。
...
模板发布后，可在 [**模板**](https://creators.dify.ai/dashboard/templates) 页面查看使用总数、整体评分、评分数量和点赞总数。如需逐条查看评分、点赞和私密反馈，请打开 [**消息**](https://creators.dify.ai/dashboard/inbox)。

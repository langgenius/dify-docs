...
> 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/self-host/use-dify/publish/webapp/embedding-in-websites)。
...
<Steps>
  <Step title="获取你的嵌入令牌">
    在你的 Dify 应用中，打开 **访问点** 标签页，在 **Web 应用** 卡片上点击 **嵌入网站**，找到唯一令牌。
  </Step>

...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/self-host/use-dify/tutorials/workflow-101/lesson-03)。</Note>
...
<Steps>
  <Step title="打开设置">
    ...
    <Frame>
      ![设置](/images/use-dify/tutorial/workflow-101-lesson-03/llm-node-01.png)
    </Frame>
  </Step>

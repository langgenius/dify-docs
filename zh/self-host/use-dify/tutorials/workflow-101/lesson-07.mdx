...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/self-host/use-dify/tutorials/workflow-101/lesson-07)。</Note>
...
<Frame>
  ![工具](/images/use-dify/tutorial/workflow-101-lesson-07/tools.png)
</Frame>
...
<Steps>
  ...
  <Step title="新增 LLM 节点">
    ...
    - 在 User 内，引用对应的变量：
      ...
      <Frame>
        ![填写提示词](/images/use-dify/tutorial/workflow-101-lesson-07/llm-settings.png)
      </Frame>
  </Step>
</Steps>
...
<Frame>
  ![工作流预览](/images/use-dify/tutorial/workflow-101-lesson-07/workflow-preview-01.png)
</Frame>
...
<Steps>
  <Step title="添加条件分支节点">
    ...
    <Frame>
      ![添加条件分支节点](/images/use-dify/tutorial/workflow-101-lesson-07/add-if-else-node.png)
    </Frame>
  </Step>
  <Step title="添加搜索工具">
    ...
    <Frame>
      ![安装插件](/images/use-dify/tutorial/workflow-101-lesson-07/add-tools.png)
    </Frame>
  </Step>
  <Step title="选择搜索功能">
    ...
    <Frame>
      ![安装谷歌搜索](/images/use-dify/tutorial/workflow-101-lesson-07/install-google-search.png)
    </Frame>
  </Step>
  <Step title="获取 API Key">
    ...
    <Frame>
      ![谷歌搜索设置](/images/use-dify/tutorial/workflow-101-lesson-07/google-search-setup.png)
    </Frame>
    1. 在谷歌搜索工具的设置页面中，点击 **API Key 授权配置**，这时候页面会提示从 SerpAPI 获取您的 SerpAPI API key。点击跳转进入 SerpAPI 官网后，简单注册一个账号，就能立即获得你的专属 API Key。
       ...
       <Frame>
         ![API Key 授权配置](/images/use-dify/tutorial/workflow-101-lesson-07/api-key-authorization-configuration.png)
       </Frame>
    ...
    <Frame>
      ![添加查询字段](/images/use-dify/tutorial/workflow-101-lesson-07/add-query-string.png)
    </Frame>
  </Step>
  <Step title="配置两条路径">
    ...
    **User Message**:
    ...
    <Frame>
      ![LLM 2 的提示词](/images/use-dify/tutorial/workflow-101-lesson-07/llm-02-prompt.png)
    </Frame>
    **知识库回答路径**
    ...
    **User Message**:
    ...
    <Frame>
      ![LLM 3 的提示词](/images/use-dify/tutorial/workflow-101-lesson-07/prompt-llm-03.png)
    </Frame>
  </Step>
  <Step title="汇总信息">
    ...
    <Frame>
      ![变量聚合器设置](/images/use-dify/tutorial/workflow-101-lesson-07/variable-aggregator-setup.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![工作流预览 2](/images/use-dify/tutorial/workflow-101-lesson-07/workflow-preview-02.png)
</Frame>
...
<Steps>
  <Step title="配置迭代输出变量">
    ...
    <Frame>
      ![迭代输出](/images/use-dify/tutorial/workflow-101-lesson-07/iteration-output.png)
    </Frame>
  </Step>
  <Step title="连接总结 LLM">
    ...
    **User Message**:
    ...
    <Frame>
      ![LLM 4 的提示词](/images/use-dify/tutorial/workflow-101-lesson-07/prompt-for-llm-04.png)
    </Frame>
  </Step>
  <Step title="添加输出节点">
    ...
    <Frame>
      ![输出设置](/images/use-dify/tutorial/workflow-101-lesson-07/output-setup.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![最终工作流预览](/images/use-dify/tutorial/workflow-101-lesson-07/final-workflow-preview.png)
</Frame>

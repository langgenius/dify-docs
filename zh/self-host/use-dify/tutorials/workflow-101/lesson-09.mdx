...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/self-host/use-dify/tutorials/workflow-101/lesson-09)。</Note>
...
<Steps>
  ...
  <Step title="添加用户信息 （User Message）">
    ...
    <Frame>
      ![设置输入](/images/use-dify/tutorial/workflow-101-lesson-09/edit-llm-node.png)
    </Frame>
  </Step>
  <Step title="添加模板转换节点（Template Node）">
    ...
    <Frame>
      ![添加模板转换节点](/images/use-dify/tutorial/workflow-101-lesson-09/add-template-node.png)
    </Frame>
  </Step>
  <Step title="设置输入变量">
    ...
    - `body`：选择 `LLM / {x} text String`
      ...
      <Frame>
        ![设置模板转换器输入变量](/images/use-dify/tutorial/workflow-101-lesson-09/template-input-variable.png)
      </Frame>
  </Step>
...
<Frame>
  ![最终工作流](/images/use-dify/tutorial/workflow-101-lesson-09/the-final-workflow.png)
</Frame>

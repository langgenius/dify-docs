...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/self-host/use-dify/tutorials/workflow-101/lesson-06)。</Note>
...
<Frame>
  ![参数提取器](/images/use-dify/tutorial/workflow-101-lesson-06/parameter-extractor.png)
</Frame>
...
<Steps>
  <Step title="添加节点">
    ...
    <Frame>
      ![添加参数提取器](/images/use-dify/tutorial/workflow-101-lesson-06/add-parameter-extractor.png)
    </Frame>
  </Step>
  <Step title="选择输入变量值">
    ...
    <Frame>
      ![设置输入变量](/images/use-dify/tutorial/workflow-101-lesson-06/set-the-input.png)
    </Frame>
  ...
  <Step title="添加提取参数">
    ...
    <Frame>
      ![添加提取参数](/images/use-dify/tutorial/workflow-101-lesson-06/add-extract-parameter.png)
    </Frame>
    <Info>
      **参数类型**
  ...
  <Step title="完成提取参数">
    ...
    <Frame>
      ![完成添加提取参数](/images/use-dify/tutorial/workflow-101-lesson-06/finish-add-extract-parameter.png)
    </Frame>
  </Step>
  <Step title="添加指令">
...
<Frame>
  ![迭代节点](/images/use-dify/tutorial/workflow-101-lesson-06/iteration.png)
</Frame>
...
<Steps>
  <Step title="添加节点">
    ...
    <Frame>
      ![添加迭代节点](/images/use-dify/tutorial/workflow-101-lesson-06/add-iteration.png)
    </Frame>
    **迭代的高级选项**
    ...
    <Frame>
      ![迭代高级选项](/images/use-dify/tutorial/workflow-101-lesson-06/advanced-iteration-options.png)
    </Frame>
    **并行模式**：默认关闭。
  ...
  <Step title="添加知识检索节点">
    ...
    <Frame>
      ![添加知识检索节点并设置查询文本](/images/use-dify/tutorial/workflow-101-lesson-06/knowledge-retrieval-query-text.png)
    </Frame>
  ...
  <Step title="添加 LLM 节点">
    ...
    **User**:
    ...
    <Frame>
      ![添加 LLM 节点和提示词](/images/use-dify/tutorial/workflow-101-lesson-06/add-llm-and-prompt.png)
    </Frame>
  ...
  <Step title="选择迭代节点的输出">
    ...
    <Frame>
      ![设置迭代输出](/images/use-dify/tutorial/workflow-101-lesson-06/set-iteration-output.png)
    </Frame>
  </Step>
  <Step title="添加最后的 LLM 节点">
    ...
    **User**:
    ...
    <Frame>
      ![添加最终 LLM 节点](/images/use-dify/tutorial/workflow-101-lesson-06/add-final-llm-node.png)
    </Frame>
  </Step>
  <Step title="检查">
    ...
    <Frame>
      ![选择输出变量](/images/use-dify/tutorial/workflow-101-lesson-06/output-variable.png)
    </Frame>
  </Step>
</Steps>

...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/self-host/use-dify/tutorials/workflow-101/lesson-05)。</Note>
...
<Frame>
  ![条件分支节点](/images/use-dify/tutorial/workflow-101-lesson-05/if-else-node.png)
</Frame>
...
<Steps>
  ...
  <Step title="配置条件规则">
    ...
    <Frame>
      ![添加条件](/images/use-dify/tutorial/workflow-101-lesson-05/settings-01.png)
    </Frame>
    3. 判断条件：保持默认的 **包含 (Contains)** 选项。在下方的输入值内填入 **Dify**。

    <Frame>
      ![包含条件](/images/use-dify/tutorial/workflow-101-lesson-05/settings-02.png)
    </Frame>
...
<Frame>
  ![连接 IF 分支](/images/use-dify/tutorial/workflow-101-lesson-05/connect-if-branch.png)
</Frame>
...
<Steps>
  ...
  <Step title="添加用户消息（User Message)">
    ...
    <Frame>
      ![LLM 2 的提示词](/images/use-dify/tutorial/workflow-101-lesson-05/final-prompt-for-llm-02.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![变量聚合器](/images/use-dify/tutorial/workflow-101-lesson-05/variable-aggregator.png)
</Frame>
...
<Steps>
  <Step title="添加聚合器">
    ...
    <Frame>
      ![添加变量聚合器](/images/use-dify/tutorial/workflow-101-lesson-05/add-variable-aggregator.png)
    </Frame>
  </Step>
  <Step title="合并路径">
    将两个 LLM 节点连接至变量聚合器。
  ...
  <Step title="赋值输出">
    ...
    <Frame>
      ![变量赋值](/images/use-dify/tutorial/workflow-101-lesson-05/assign-variable.png)
    </Frame>
  ...
  <Step title="最后一步">
    ...
    <Frame>
      ![更新输出变量](/images/use-dify/tutorial/workflow-101-lesson-05/update-output-variable.png)
    </Frame>
    现在的工作流如图所示：

    <Frame>
      ![最终工作流](/images/use-dify/tutorial/workflow-101-lesson-05/final-workflow.png)
    </Frame>
  </Step>
  <Step title="运行与测试">

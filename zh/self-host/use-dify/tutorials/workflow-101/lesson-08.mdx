...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/self-host/use-dify/tutorials/workflow-101/lesson-08)。</Note>
...
<Steps>
  <Step title="清理迭代">
    ...
    <Frame>
      ![迭代节点](/images/use-dify/tutorial/workflow-101-lesson-08/iteration.png)
    </Frame>
  </Step>
  <Step title="添加 Agent 节点">
    ...
    <Frame>
      ![添加 Agent 节点](/images/use-dify/tutorial/workflow-101-lesson-08/add-agent-node.png)
    </Frame>
  </Step>
  <Step title="安装 Agent 策略">
    ...
    <Frame>
      ![搜索 Agent 策略](/images/use-dify/tutorial/workflow-101-lesson-08/search-agent-strategy.png)
    </Frame>
  </Step>
  <Step title="选择 Agent 策略">
    ...
    <Frame>
      ![选择 Agent 策略](/images/use-dify/tutorial/workflow-101-lesson-08/choose-agent-node.png)
    </Frame>
  </Step>
  <Step title="选择 ReAct">
    ...
    <Frame>
      ![选择 ReAct](/images/use-dify/tutorial/workflow-101-lesson-08/select-react.png)
    </Frame>
    **为什么选择 ReAct？**
  ...
  <Step title="选择模型">
    ...
    **为什么必须支持 Function Calling？**
    ...
    <Frame>
      ![选择模型](/images/use-dify/tutorial/workflow-101-lesson-08/choose-a-model.png)
    </Frame>
  </Step>
  <Step title="选择工具">
    在工具列表中添加 **谷歌搜索**，确认启用。
    ...
    <Frame>
      ![添加工具](/images/use-dify/tutorial/workflow-101-lesson-08/add-tool.png)
    </Frame>
  </Step>
  <Step title="填写指令">
    ...
    <Frame>
      ![添加指令](/images/use-dify/tutorial/workflow-101-lesson-08/add-instructions.png)
    </Frame>
  </Step>
  <Step title="上下文和查询">
    ...
    **为什么是 item，而不是最开始的 email_content 呢？**
    ...
    <Frame>
      ![上下文和查询](/images/use-dify/tutorial/workflow-101-lesson-08/context-and-query.png)
    </Frame>
  </Step>
  <Step title="设置迭代输出变量">
    ...
    <Frame>
      ![设置迭代输出](/images/use-dify/tutorial/workflow-101-lesson-08/iteration-output.png)
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="最终撰写人（LLM）">
    ...
    3. 在 User Message 中分别将 answers、email content 和 customer name 替换成对应的变量。当前 LLM 节点如下所示。
       ...
       <Frame>
         ![最终 LLM](/images/use-dify/tutorial/workflow-101-lesson-08/final-llm.png)
       </Frame>
  </Step>
  <Step title="添加输出节点">
    ...
    <Frame>
      ![添加输出节点](/images/use-dify/tutorial/workflow-101-lesson-08/add-output-node.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![最终工作流](/images/use-dify/tutorial/workflow-101-lesson-08/final-workflow.png)
</Frame>

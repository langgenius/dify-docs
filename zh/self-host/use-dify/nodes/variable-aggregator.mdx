...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/self-host/use-dify/nodes/variable-aggregator)。</Note>
...
如需合并并行分支的结果，请使用 [代码执行](/zh/self-host/use-dify/nodes/code) 或 [模板转换](/zh/self-host/use-dify/nodes/template) 节点。
</Note>

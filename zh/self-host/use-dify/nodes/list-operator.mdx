...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/self-host/use-dify/nodes/list-operator)。</Note>
...
<Frame caption="列表操作符节点界面">
  ![列表操作符节点界面](https://assets-docs.dify.ai/dify-enterprise-mintlify/en/guides/workflow/node/522a0c932aab93d4f3970168412f759e.png)
</Frame>
...
<Frame caption="数组处理工作流示例">
  ![数组处理工作流示例](https://assets-docs.dify.ai/dify-enterprise-mintlify/en/guides/workflow/node/812d1b2f167065e17df8392b2cb3cc8a.png)
</Frame>
...
<Frame caption="混合文件处理工作流">
  ![混合文件处理工作流](https://assets-docs.dify.ai/dify-enterprise-mintlify/en/guides/workflow/node/610358293217e54b55b7e1d4d16bf83c.png)
</Frame>

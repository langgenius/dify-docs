...
> 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/self-host/use-dify/knowledge/readme)。
...
- **[创建即用型知识库](/zh/self-host/use-dify/knowledge/create-knowledge/introduction)**：导入数据，设置处理规则，其余一切交给 Dify。简单高效，新手友好。
- **[构建自定义知识库](/zh/self-host/use-dify/knowledge/knowledge-pipeline/readme)**：自定义步骤和集成，编排更复杂、灵活的数据处理流程。

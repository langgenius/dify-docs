...
> 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/self-host/use-dify/knowledge/manage-knowledge/maintain-dataset-via-api)。
...
有关完整的端点列表、请求/响应结构、错误码和交互式示例，请参阅[知识库 API 参考](https://docs.dify.ai/zh/api-reference/knowledge-bases/list-knowledge-bases)。

...
> 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/self-host/use-dify/monitor/integrations/integrate-langsmith)。

### LangSmith 简介

LangSmith 是一个用于构建生产级 LLM 应用的平台，它用于开发、协作、测试、部署和监控 LLM 应用。

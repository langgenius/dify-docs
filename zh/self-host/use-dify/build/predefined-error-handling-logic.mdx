...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/self-host/use-dify/build/predefined-error-handling-logic)。</Note>
...
[大型语言模型](/zh/self-host/use-dify/nodes/llm)、[HTTP](/zh/self-host/use-dify/nodes/http-request)、[代码](/zh/self-host/use-dify/nodes/code) 和 [工具](/zh/self-host/use-dify/nodes/tools) 
...
<AccordionGroup>
  ...
  <Accordion title="默认值">
    ...
    <Frame>
      ![当节点失败时，使用备用值代替](https://assets-docs.dify.ai/2024/12/e9e5e757090679243e0c9976093c7e6c.png)
    </Frame>
...
- `error_type` - 发生了什么类型的错误（参见 [错误类型](/zh/self-host/use-dify/debug/error-type)）

...
若要通过共享的 DSL 文件创建 Agent，选择 **导入 DSL 文件**。导入后检查 Agent，并根据当前工作空间的需要添加 Skill 或文件。
...
若要把 Agent 分享到其他工作空间，可将它导出为 DSL 文件。同时分享 Skill 包和在 **文件** 中添加的文件，方便接收者在自己的工作空间中完成 Agent 设置。

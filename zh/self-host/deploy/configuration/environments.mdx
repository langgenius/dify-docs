...
| `MARKETPLACE_API_URL` | `https://marketplace.dify.ai` | 用于浏览和下载插件与模板，以及检查插件升级的 Marketplace API 端点。<br/><br/>Dify API 服务、Celery 工作进程、Web 服务端和用户浏览器都会使用该 URL，因此每个运行环境都需要能访问它。 |

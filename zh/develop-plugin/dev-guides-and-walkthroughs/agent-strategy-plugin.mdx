...
现在可将插件包提交到 [Dify 插件仓库](https://github.com/langgenius/dify-plugins)。提交前，确保它符合 [Marketplace 准备与验证要求](/zh/develop-plugin/publishing/marketplace-listing/prepare-plugin-for-marketplace)。审核通过后，软件包会合并到主分支，并通过 Marketplace 流水线发布。

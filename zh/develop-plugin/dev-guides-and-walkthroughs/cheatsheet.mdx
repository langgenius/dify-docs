...
类别标签在 [`ToolLabelEnum`](https://github.com/langgenius/dify-plugin-sdks/blob/main/src/dify_plugin/entities/tool.py) 中定义：
...
- **扩展插件**：扩展 Dify 平台功能，如 Endpoints 和 Web 应用。详见 [扩展插件](/zh/develop-plugin/dev-guides-and-walkthroughs/endpoint)。

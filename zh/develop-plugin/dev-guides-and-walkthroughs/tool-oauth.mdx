...
[编辑此页面](https://github.com/langgenius/dify-docs/edit/main/plugin-dev-en/0222-tool-oauth.mdx) | [报告问题](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
...
深入了解如何构建一个由 AI 驱动的 Slack Bot——它可以直接在 Slack 中回答用户问题。如果你之前没有开发过插件，我们建议先阅读[插件开发快速入门指南](/en/develop-plugin/dev-guides-and-walkthroughs/tool-plugin)。
...
- **Dify 插件开发工具**：更多信息，请参阅[初始化开发工具](/en/develop-plugin/getting-started/cli)。
...
现在我们将深入实际编码。在开始之前，请确保你已阅读[快速入门：开发扩展插件](/en/develop-plugin/dev-guides-and-walkthroughs/endpoint)或已经构建过 Dify 插件。
...
有关在插件中反向调用 Dify 服务的更多详细信息，请参阅[反向调用：App](/en/develop-plugin/features-and-specs/advanced-development/reverse-invocation-app)。
...
确认插件工作正常后，你可以通过以下命令打包并命名它。运行后，你会在当前目录中找到一个 `slack_bot.difypkg` 文件——这就是你的最终插件包。有关详细的打包步骤，请参阅[打包为本地文件并分享](/en/develop-plugin/publishing/marketplace-listing/release-by-file)。
...
你现在可以将其上传到 [Dify Marketplace 仓库](https://github.com/langgenius/dify-plugins) 进行公开发布。在发布之前，请确保你的插件符合[发布到 Dify Marketplace 指南](/en/develop-plugin/publishing/marketplace-listing/release-to-dify-marketplace)。一旦获得批准，你的代码将合并到主分支，插件将在 [Dify Marketplace](https://marketplace.dify.ai/) 上线。

---

## 相关资源

- [插件开发基础](/en/develop-plugin/getting-started/getting-started-dify-plugin) - Dify 插件开发的全面概述
- [插件开发快速入门指南](/en/develop-plugin/dev-guides-and-walkthroughs/tool-plugin) - 从零开始开发插件
- [开发扩展插件](/en/develop-plugin/dev-guides-and-walkthroughs/endpoint) - 了解扩展插件开发
- [反向调用 Dify 服务](/en/develop-plugin/features-and-specs/advanced-development/reverse-invocation) - 了解如何调用 Dify 平台功能
- [反向调用：App](/en/develop-plugin/features-and-specs/advanced-development/reverse-invocation-app) - 了解如何调用平台内的应用
- [发布插件](/en/develop-plugin/publishing/marketplace-listing/release-overview) - 了解发布流程
- [发布到 Dify Marketplace](/en/develop-plugin/publishing/marketplace-listing/release-to-dify-marketplace) - Marketplace 发布指南
- [端点详细定义](/en/develop-plugin/dev-guides-and-walkthroughs/endpoint) - 端点详细定义
...
**快速入门：**
- [开发扩展插件](/en/develop-plugin/dev-guides-and-walkthroughs/endpoint)
- [开发模型插件](/en/develop-plugin/dev-guides-and-walkthroughs/creating-new-model-provider)
- [Bundle 插件：打包多个插件](/en/develop-plugin/features-and-specs/advanced-development/bundle)

**插件接口文档：**
- [通过 Manifest 文件定义插件信息](/en/develop-plugin/features-and-specs/plugin-types/plugin-info-by-manifest) - Manifest 结构
- [端点](/en/develop-plugin/dev-guides-and-walkthroughs/endpoint) - 端点详细定义
- [反向调用](/en/develop-plugin/features-and-specs/advanced-development/reverse-invocation) - 反向调用 Dify 功能
- [通用规范](/en/develop-plugin/features-and-specs/plugin-types/general-specifications) - 工具规范
- [模型 Schema](/en/develop-plugin/features-and-specs/plugin-types/model-schema) - 模型

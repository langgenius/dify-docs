...
有关完整的模型供应商 YAML 规范，请参阅[模型 Schema](/en/develop-plugin/features-and-specs/plugin-types/model-schema) 文档。
...
* [模型设计规则](/en/develop-plugin/features-and-specs/plugin-types/model-designing-rules) - 集成预定义模型的标准
* [模型 Schema](/en/develop-plugin/features-and-specs/plugin-types/model-schema) - 模型配置文件的标准
...
有关发布流程的更多详情，请参阅[发布概述](/en/develop-plugin/publishing/marketplace-listing/release-overview)。

## 参考资源

- [快速集成新模型](/en/develop-plugin/dev-guides-and-walkthroughs/creating-new-model-provider) - 如何向现有供应商添加新模型
- [插件开发基本概念](/en/develop-plugin/getting-started/getting-started-dify-plugin) - 返回插件开发入门指南
- [模型 Schema](/en/develop-plugin/features-and-specs/plugin-types/model-schema) - 了解详细的模型配置规范
- [通用规范](/en/develop-plugin/features-and-specs/plugin-types/general-specifications) - 了解插件清单文件配置

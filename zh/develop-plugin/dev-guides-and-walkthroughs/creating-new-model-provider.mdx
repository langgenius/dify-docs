...
有关完整的模型供应商 YAML 规范，请参阅[模型 Schema](/plugin-dev-en/0412-model-schema) 文档。
...
* [模型设计规则](/plugin-dev-en/0411-model-designing-rules) - 集成预定义模型的标准
* [模型 Schema](/plugin-dev-en/0412-model-schema) - 模型配置文件的标准
...
有关发布流程的更多详情，请参阅[发布概述](/plugin-dev-en/0321-release-overview)。

## 参考资源

- [快速集成新模型](/plugin-dev-en/0211-getting-started-new-model) - 如何向现有供应商添加新模型
- [插件开发基本概念](/plugin-dev-en/0111-getting-started-dify-plugin) - 返回插件开发入门指南
- [模型 Schema](/plugin-dev-en/0412-model-schema) - 了解详细的模型配置规范
- [通用规范](/plugin-dev-en/0411-general-specifications) - 了解插件清单文件配置

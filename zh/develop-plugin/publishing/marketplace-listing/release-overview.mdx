...
<CardGroup cols={3}>
  <Card title="市场" icon="store" href="/zh/develop-plugin/publishing/marketplace-listing/prepare-plugin-for-marketplace">
...
| **审核** | 自动风险与软件包检查 + 人工审核 | 无 | 无 |
| **安装路径** | 在市场界面一键安装 | 通过 GitHub 对话框安装 | 在插件页面上传 |
| **版本管理** | 每个版本都提交新软件包和新 PR | 带 `.difypkg` 资产的 GitHub 发布 | 重新打包并重新分发 |

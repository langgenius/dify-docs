...
- 已安装 [Dify 插件 CLI](/zh/develop-plugin/getting-started/cli)。运行 `dify version` 进行确认。
...
<CardGroup cols={2}>
  ...
  <Card title="提交到市场" icon="store" href="/zh/develop-plugin/publishing/marketplace-listing/prepare-plugin-for-marketplace">

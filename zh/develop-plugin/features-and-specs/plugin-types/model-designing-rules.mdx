...
> 有关使用模板的详细信息，可参考[创建新模型供应商](/plugin-dev-en/0222-creating-new-model-provider)中的示例。
...
- [模型架构详解](/plugin-dev-en/0412-model-schema) - 深入了解模型插件的架构规范
- [快速集成新模型](/plugin-dev-en/0211-getting-started-new-model) - 学习如何应用这些规则来添加新模型
- [通用规范](/plugin-dev-en/0411-general-specifications) - 了解插件清单文件的配置
- [创建新模型供应商](/plugin-dev-en/0222-creating-new-model-provider) - 开发全新的模型供应商插件
...
[编辑此页面](https://github.com/langgenius/dify-docs/edit/main/plugin-dev-en/0411-model-designing-rules.mdx) | [报告问题](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
...
> 有关使用模板的详细信息，可参考[创建新模型供应商](/en/develop-plugin/dev-guides-and-walkthroughs/creating-new-model-provider)中的示例。
...
- [模型架构详解](/en/develop-plugin/features-and-specs/plugin-types/model-schema) - 深入了解模型插件的架构规范
- [快速集成新模型](/en/develop-plugin/dev-guides-and-walkthroughs/creating-new-model-provider) - 学习如何应用这些规则来添加新模型
- [通用规范](/en/develop-plugin/features-and-specs/plugin-types/general-specifications) - 了解插件清单文件的配置
- [创建新模型供应商](/en/develop-plugin/dev-guides-and-walkthroughs/creating-new-model-provider) - 开发全新的模型供应商插件

...
<Note>
在深入阅读此 API 参考之前，我们建议先阅读[模型设计规则](/plugin-dev-en/0411-model-designing-rules)和[模型插件介绍](/plugin-dev-en/0131-model-plugin-introduction)以获得概念上的理解。
</Note>
...
- [模型插件介绍](/plugin-dev-en/0411-model-plugin-introduction) - 快速了解模型插件的基本概念
- [快速集成新模型](/plugin-dev-en/0211-getting-started-new-model) - 学习如何向现有提供商添加新模型
- [创建新模型提供商](/plugin-dev-en/0222-creating-new-model-provider) - 学习如何开发全新的模型提供商

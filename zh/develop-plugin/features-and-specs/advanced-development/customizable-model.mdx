...
与[预定义模型](/en/plugins/quick-start/develop-plugins/model-plugin/predefined-model)不同，没有 YAML 定义模型支持哪些参数。您必须动态生成参数模式。
...
* [开发扩展插件](/en/plugins/quick-start/develop-plugins/extension-plugin)
* [开发工具插件](/en/plugins/quick-start/develop-plugins/tool-plugin)
* [Bundle 插件：打包多个插件](/en/plugins/quick-start/develop-plugins/bundle)

**插件端点文档：**

* [Manifest](/en/plugins/schema-definition/manifest) 结构
* [Endpoint](/en/plugins/schema-definition/endpoint) 定义
* [反向调用 Dify 服务](/en/plugins/schema-definition/reverse-invocation-of-the-dify-service)
* [工具](/en/plugins/schema-definition/tool)
* [模型](/en/plugins/schema-definition/model)

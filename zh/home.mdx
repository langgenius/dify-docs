...
<div className="max-w-5xl mx-auto px-6 py-16">
  ...
  <div className="mt-6">
    <Columns cols={2}>
      ...
      <Card title="自部署" icon="server" href="/zh/self-host/deploy/overview">
        在你自己的基础设施上运行开源的 Community Edition。使用 Docker Compose 几分钟即可完成部署。
      </Card>
    </Columns>
  </div>
  ...
  <div className="mt-6">
    <Columns cols={4}>
      <Card title="API 参考" icon="code" href="/zh/api-reference/chat-messages/send-chat-message">
        通过 REST API 将 Dify 应用集成到你自己的产品中。
      </Card>
      <Card title="CLI" icon="terminal" href="/zh/cli/overview">
        通过 difyctl，从终端、脚本、CI 和 AI Agent 运行你的 Dify 应用。
      </Card>

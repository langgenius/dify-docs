...
进入 **设置 -- 数据来源**，在 **Firecrawl** 卡片上添加 API Key。若没有该卡片，请先从 Dify Marketplace 安装 Firecrawl 数据源插件。
...
进入 **设置 -- 数据来源**，在 **Jina Reader** 卡片上添加 API Key。若没有该卡片，请先从 Dify Marketplace 安装 Jina Reader 数据源插件。

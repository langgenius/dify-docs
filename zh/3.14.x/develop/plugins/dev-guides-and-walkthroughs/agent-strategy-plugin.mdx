...
有关准备插件开发工具的详细信息，参见 [CLI](/zh/3.14.x/develop/plugins/getting-started/cli)。
...
你现在可以将插件包上传到 [Dify 插件仓库](https://github.com/langgenius/dify-plugins)。在此之前，确保它符合[插件发布指南](/zh/3.14.x/develop/plugins/publishing/marketplace-listing/release-to-dify-marketplace)。一旦获得批准，你的代码将合并到主分支，插件将自动在 [Dify 市场](https://marketplace.dify.ai/) 上线。

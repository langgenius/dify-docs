...
工具插件使用两个 YAML 文件：一个 **provider** 文件用于声明凭证并列出工具，以及每个可调用工具对应一个 **tool** 文件。完整的 schema 请参阅[通用规范](/zh/3.14.x/develop/plugins/features-and-specs/plugin-types/general-specifications)。

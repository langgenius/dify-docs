...
- [Dify 插件 CLI](/zh/3.14.x/develop/plugins/getting-started/cli)
...
完整的模型供应商 YAML 规范，参见 [模型 Schema](/zh/3.14.x/develop/plugins/features-and-specs/plugin-types/model-schema)。
...
- [模型设计规则](/zh/3.14.x/develop/plugins/features-and-specs/plugin-types/model-designing-rules)：集成预定义模型的标准。
- [模型 Schema](/zh/3.14.x/develop/plugins/features-and-specs/plugin-types/model-schema)：模型配置文件的标准。
...
发布流程的更多详情，参见 [发布概述](/zh/3.14.x/develop/plugins/publishing/marketplace-listing/release-overview)。

## 参考资源

- [快速集成新模型](/zh/3.14.x/develop/plugins/dev-guides-and-walkthroughs/creating-new-model-provider)：如何向现有供应商添加新模型。
- [插件开发基本概念](/zh/3.14.x/develop/plugins/getting-started/getting-started-dify-plugin)：返回插件开发入门指南。
- [模型 Schema](/zh/3.14.x/develop/plugins/features-and-specs/plugin-types/model-schema)：详细的模型配置规范。
- [通用规范](/zh/3.14.x/develop/plugins/features-and-specs/plugin-types/general-specifications)：插件清单文件配置。

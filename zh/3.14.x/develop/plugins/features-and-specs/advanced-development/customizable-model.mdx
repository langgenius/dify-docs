...
与 [预定义模型](/zh/3.14.x/develop/plugins/features-and-specs/plugin-types/model-schema) 不同，没有 YAML 文件定义模型支持哪些参数，因此你必须动态生成参数模式。
...
<Card title="调试插件" icon="link" href="/zh/3.14.x/develop/plugins/dev-guides-and-walkthroughs/cheatsheet">
</Card>
...
- [开发扩展插件](/zh/3.14.x/develop/plugins/features-and-specs/plugin-types/general-specifications)
- [开发工具插件](/zh/3.14.x/develop/plugins/dev-guides-and-walkthroughs/tool-plugin)
- [Bundle 插件：打包多个插件](/zh/3.14.x/develop/plugins/features-and-specs/advanced-development/bundle)

**插件端点文档**：

- [Manifest](/zh/3.14.x/develop/plugins/features-and-specs/plugin-types/plugin-info-by-manifest) 结构
- [Endpoint](/zh/3.14.x/develop/plugins/dev-guides-and-walkthroughs/endpoint) 定义
- [反向调用 Dify 服务](/zh/3.14.x/develop/plugins/features-and-specs/advanced-development/reverse-invocation)
- [工具](/zh/3.14.x/develop/plugins/features-and-specs/plugin-types/tool)
- [模型](/zh/3.14.x/develop/plugins/features-and-specs/plugin-types/model-schema)

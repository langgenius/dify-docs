...
<Note>
在深入阅读本 API 参考之前，建议先阅读 [模型设计规则](/zh/3.14.x/develop/plugins/features-and-specs/plugin-types/model-designing-rules) 了解概念模型，并参考 [创建新模型供应商](/zh/3.14.x/develop/plugins/dev-guides-and-walkthroughs/creating-new-model-provider) 获取分步演示。
</Note>
...
- [模型设计规则](/zh/3.14.x/develop/plugins/features-and-specs/plugin-types/model-designing-rules)：模型配置的标准。
- [模型插件介绍](/zh/3.14.x/develop/plugins/features-and-specs/plugin-types/model-designing-rules)：模型插件的核心概念。
- [快速集成新模型](/zh/3.14.x/develop/plugins/dev-guides-and-walkthroughs/creating-new-model-provider)：向现有供应商添加新模型。
- [创建新模型供应商](/zh/3.14.x/develop/plugins/dev-guides-and-walkthroughs/creating-new-model-provider)：从零开发新的模型供应商。

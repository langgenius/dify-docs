...
本页介绍所有插件类型共享的结构。建议结合 [插件开发基本概念](/zh/3.14.x/develop/plugins/getting-started/getting-started-dify-plugin) 和 [开发者速查表](/zh/3.14.x/develop/plugins/getting-started/cli) 一起阅读，以了解整体架构。
...
<ParamField path="model_type" type="enum">
  模型类型枚举，参见 [模型设计规则](/zh/3.14.x/develop/plugins/features-and-specs/plugin-types/model-designing-rules#modeltype)。
</ParamField>
...
- [插件开发基本概念](/zh/3.14.x/develop/plugins/getting-started/getting-started-dify-plugin)：Dify 插件开发总览
- [开发者速查表](/zh/3.14.x/develop/plugins/dev-guides-and-walkthroughs/cheatsheet)：常用命令和概念的快速参考
- [工具插件开发详解](/zh/3.14.x/develop/plugins/dev-guides-and-walkthroughs/tool-plugin)：定义插件信息及工具插件开发流程
- [模型设计规则](/zh/3.14.x/develop/plugins/features-and-specs/plugin-types/model-designing-rules)：模型配置的相关标准

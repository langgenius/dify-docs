...
发现命令集的方式详见 [help 参考](/zh/3.14.x/develop/cli/reference/help#机器可读帮助)，完整集成方式详见 [安装 difyctl 技能](/zh/3.14.x/develop/cli/integrate-agents/install-the-difyctl-skill)。

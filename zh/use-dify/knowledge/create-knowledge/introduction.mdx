...
4. 等待分段嵌入
5. 完成上传，在应用内关联知识库并使用。你可以参考[在应用内集成知识库](/zh/use-dify/knowledge/integrate-knowledge-within-application)，搭建出能够基于知识库进行问答的 LLM 应用。如需修改或管理知识库，请参考[知识库管理与文档维护](/zh/use-dify/knowledge/knowledge-and-documents-maintenance/introduction)。
...
如需使用元数据功能管理知识库，请参阅 [元数据](/zh/use-dify/knowledge/metadata)。

...
1. 在数据源配置界面，选择对应的数据源，点击右侧的**配置**，选择**添加 API Key**。
   ...
   <Frame>
     ![添加API Key](/images/use-dify/knowledge/authorize-data-03.png)
   </Frame>

2. 在弹出的配置面板中，填写对应信息。完成后，点击**保存**完成授权。
   
   <Frame>
     ![API Key配置](/images/use-dify/knowledge/authorize-data-04.png)
   </Frame>
...
1. 在数据源配置界面，选择对应的数据源，点击右侧的**配置**，选择**添加 OAuth**。
   ...
   <Frame>
     ![添加OAuth](/images/use-dify/knowledge/authorize-data-07.png)
   </Frame>
...
<Frame>
  ![OAuth客户端设置](/images/use-dify/knowledge/authorize-data-10.png)
</Frame>
...
1. 在数据源配置界面，选择对应的数据源，点击右侧的**配置**，选择**添加 OAuth** 右侧的**设置图标**，进入 OAuth 客户端设置。
   ...
   <Frame>
     ![自定义OAuth设置](/images/use-dify/knowledge/authorize-data-11.png)
   </Frame>

2. 点击**自定义**，输入 **Client ID** 和 **Client Secret**。点击**保存并授权**完成 OAuth 授权流程。
   
   <Frame>
     ![自定义OAuth配置](/images/use-dify/knowledge/authorize-data-12.png)
   </Frame>

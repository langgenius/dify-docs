...
<Frame>
  <img src="/images/difyworkflow101-lesson07-tools.png" alt="工具" />
</Frame>
...
<Steps>
  ...
  <Step title="新增 LLM 节点">
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson07-llmsettings.png" alt="LLM 设置" />
    </Frame>
  </Step>
</Steps>
...
<Frame>
  <img src="/images/difyworkflow101-lesson07-workflowpreview1.png" alt="工作流预览" />
</Frame>
...
<Steps>
  <Step title="添加条件分支节点">
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson07-addifelsenode.png" alt="添加条件分支节点" />
    </Frame>
  </Step>

  <Step title="添加搜索工具">
    让我们在 If 后连接搜索工具，这表明当知识库未找到相关回答信息时，使用搜索进行答案查询。在 If 节点后，添加工具，在搜索框中输入 Google。鼠标移至 Google，点击右侧的**安装**。在弹窗中再次点击**安装**。

    <Frame>
      <img src="/images/difyworkflow101-lesson07-addtools.png" alt="安装插件" />
    </Frame>
  </Step>
  ...
  <Step title="选择搜索功能">
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson07-installgooglesearch.png" alt="安装谷歌搜索" />
    </Frame>
  </Step>
  ...
  <Step title="获取 API Key">
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson07-googlesearchsetup.png" alt="谷歌搜索设置" />
    </Frame>
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson07-apikeyauthorizationconfiguration.png" alt="API Key 授权配置" />
    </Frame>
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson07-addquerystring.png" alt="添加查询字段" />
    </Frame>
  </Step>
  ...
  <Step title="配置两条路径">
    ...
    **搜索回答（LLM 2）**
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson07-llm2prompt.png" alt="LLM 2 的提示词" />
    </Frame>
    ...
    **根据知识库回答（LLM 3）**
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson07-promptllm3.png" alt="LLM 3 的提示词" />
    </Frame>
  </Step>
  ...
  <Step title="汇总信息">
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson07-variableaggregatorsetup.png" alt="变量聚合器设置" />
    </Frame>
  </Step>
</Steps>
...
<Frame>
  <img src="/images/difyworkflow101-lesson07-workflowpreview2.png" alt="工作流预览 2" />
</Frame>
...
<Steps>
  <Step title="配置迭代输出变量">
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson07-iterationoutput.png" alt="迭代输出" />
    </Frame>
  </Step>
  ...
  <Step title="连接总结 LLM">
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson07-promptforllm4.png" alt="LLM 4 的提示词" />
    </Frame>
  </Step>
  ...
  <Step title="添加输出节点">
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson07-outputsetup.png" alt="输出设置" />
    </Frame>
  </Step>
</Steps>
...
<Frame>
  <img src="/images/difyworkflow101-lesson07-finalworkflowpreview.png" alt="最终工作流预览" />
</Frame>

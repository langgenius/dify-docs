...
<Steps>
  ...
  <Step title="添加模版转换节点（Template Node）">
    在 LLM 节点之后，点击 `+` 号添加一个模板节点。

    <Frame>
      ![添加模版转换节点](/images/difyworkflow101-lesson09-addtemplatenode.png)
    </Frame>
  </Step>
  <Step title="设置输入变量">
    ...
    - `body`：选择 `LLM / {x} text String`
      ...
      <Frame>
        ![设置模版转换器输入变量](/images/difyworkflow101-lesson09-templateinputvariable.png)
      </Frame>
  </Step>

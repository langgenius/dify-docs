...
如何让我们的助理学会看人下菜碟，对不同类型的邮件进行差异化处理呢？让我们为工作流设置一个\_十字路口\_，它能根据不同的信号，让流程走向不同的轨道。
...
<Info>
  **读懂十字路口的判断逻辑**
  ...
  - **是 / 不是**
    ...
    完全等于或不等于某个值。可以把它想象成\_一把钥匙开一把锁\_，只有当变量内容和我们设定的值一模一样时，条件才算满足。
  - **包含 / 不包含**
...
<Steps>
  ...
  <Step title="配置这个 LLM 节点">
    ...
    <Frame>
      ![Difyworkflow101 Lesson05 Promptforllm2 1](/images/difyworkflow101-lesson05-promptforllm2-1.png)
    </Frame>
    ```
    ...
    ![Prompt for LLM 2](/images/difyworkflow101-lesson05-promptforllm2-1.png)
  </Step>
  <Step title="添加用户消息（User Message)">
    ...
    6. 再次按下 **/** 键并点击 **email_content**。
       ...
       <Frame>
         ![Difyworkflow101 Lesson05 Finalpromptforllm2](/images/difyworkflow101-lesson05-finalpromptforllm2.png)
       </Frame>
  </Step>
</Steps>

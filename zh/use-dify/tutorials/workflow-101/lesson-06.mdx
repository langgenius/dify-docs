...
<Frame>
  <img src="/images/difyworkflow101-lesson06-parameterextractor.png" alt="参数提取器" />
</Frame>
...
<Steps>
  <Step title="添加节点">
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson06-addparameterextractor.png" alt="添加参数提取器" />
    </Frame>
  </Step>

  <Step title="选择输入变量值">
    1. 点击参数提取器，在右侧面板的**输入变量**中。
    2. 点击设置变量值，在下拉菜单中选择 `email_content`。

    <Frame>
      <img src="/images/difyworkflow101-lesson06-settheinput.png" alt="设置输入变量" />
    </Frame>
  ...
  <Step title="添加提取参数">
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson06-addextractparameter.png" alt="添加提取参数" />
    </Frame>
    ...
    **列表类型（装多个）**
    ...
    - **Array[String]**（文本列表）：Array 代表*列表*，String 代表*文本*。所以，`Array[String]` 就意味着，我们要用一个能装多个文本的篮子，比如邮件里的所有问题。
  ...
  <Step title="完成提取参数">
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson06-finishaddextractparameter.png" alt="完成添加提取参数" />
    </Frame>
  </Step>
...
<Frame>
  <img src="/images/difyworkflow101-lesson06-iteration.png" alt="迭代节点" />
</Frame>
...
<Steps>
  <Step title="添加节点">
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson06-additeration.png" alt="添加迭代节点" />
    </Frame>
    ...
    **迭代的*高级选项***
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson06-advancediterationoptions.png" alt="迭代高级选项" />
    </Frame>
  ...
  <Step title="添加知识检索节点">
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson06-knowledgeretrievalquerytext.png" alt="添加知识检索节点并设置查询文本" />
    </Frame>
  ...
  <Step title="添加 LLM 节点">
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson06-addllmandprompt.png" alt="添加 LLM 节点和提示词" />
    </Frame>
  ...
  <Step title="选择迭代节点的输出">
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson06-setiterationoutput.png" alt="设置迭代输出" />
    </Frame>
  </Step>
  ...
  <Step title="添加变量聚合器">
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson06-variableaggregator.png" alt="添加变量聚合器" />
    </Frame>
  </Step>
  ...
  <Step title="添加最后的 LLM 节点">
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson06-addfinalllmnode.png" alt="添加最终 LLM 节点" />
    </Frame>
  </Step>
  ...
  <Step title="检查">
    ...
    <Frame>
      <img src="/images/difyworkflow101-lesson06-ourputvariable.png" alt="选择输出变量" />
    </Frame>
  </Step>
</Steps>

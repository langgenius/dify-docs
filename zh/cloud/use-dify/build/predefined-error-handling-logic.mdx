...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/cloud/use-dify/build/predefined-error-handling-logic)。</Note>
...
[大型语言模型](/zh/cloud/use-dify/nodes/llm)、[HTTP](/zh/cloud/use-dify/nodes/http-request)、[代码](/zh/cloud/use-dify/nodes/code) 和 [工具](/zh/cloud/use-dify/nodes/tools) 
...
- `error_type` - 发生了什么类型的错误（参见 [错误类型](/zh/cloud/use-dify/debug/error-type)）

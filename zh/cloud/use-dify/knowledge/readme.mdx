...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/cloud/use-dify/knowledge/readme)。</Note>
...
- **[快速创建](/zh/cloud/use-dify/knowledge/create-knowledge/introduction)**：导入数据，设置处理规则，其余一切交给 Dify。简单高效，新手友好。
- **[通过知识流水线创建](/zh/cloud/use-dify/knowledge/knowledge-pipeline/readme)**：自定义步骤和插件，编排更复杂、灵活的数据处理流程。

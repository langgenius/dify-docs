...
> 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/cloud/use-dify/workspace/api-extension/moderation-api-extension)。
...
## 代码示例
下面展示一段可部署在 Cloudflare 的 `src/index.ts` 代码。（Cloudflare 完整的使用方法参见 [此文档](/zh/cloud/use-dify/workspace/api-extension/cloudflare-worker)）

...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/cloud/use-dify/tutorials/twitter-chatflow)。</Note>
...
前往 [cloud.dify.ai](https://cloud.dify.ai) 注册。新账户使用 Sandbox 套餐，含 200 AI 额度，无需自备模型供应商的 API Key 即可完成本教程。

如需自定义其他模型供应商，点击 **右上角头像 - 设置 - 模型供应商**：

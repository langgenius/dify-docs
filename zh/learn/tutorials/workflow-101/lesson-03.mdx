...
> 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/learn/tutorials/workflow-101/lesson-03)。

<Frame>
  ![LLM 节点](/images/use-dify/tutorial/workflow-101-lesson-03/llm-node.png)
</Frame>
...
<Steps>
  <Step title="打开集成">
    ...
    <Frame>
      ![模型供应商](/images/use-dify/tutorial/workflow-101-lesson-03/llm-node-01.png)
    </Frame>
  </Step>
  <Step title="安装 OpenAI 模型供应商">
    在安装模型供应商里选择 OpenAI，点击 **安装**。

    <Frame>
      ![选择 OpenAI](/images/use-dify/tutorial/workflow-101-lesson-03/llm-node-02.png)
    </Frame>
    <Frame>
      ![安装 OpenAI](/images/use-dify/tutorial/workflow-101-lesson-03/install.png)
    </Frame>
  </Step>
  <Step title="返回编排窗口">
...
<AccordionGroup>
  ...
  <Accordion title="1048K（记忆力）">
    ...
    K 代表千，1048K 就意味着它能一次性处理大约一百万个 token 的超长信息，比如读完一本很厚的书，还能记住开头的情节。
...
<Steps>
  ...
  <Step title="添加节点">
    ...
    <Frame>
      ![添加节点](/images/use-dify/tutorial/workflow-101-lesson-03/add-the-node.png)
    </Frame>
  </Step>
  <Step title="连接节点">
    ...
    <Frame>
      ![连接节点](/images/use-dify/tutorial/workflow-101-lesson-03/connect-the-nodes.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![添加提示词](/images/use-dify/tutorial/workflow-101-lesson-03/prompt.png)
</Frame>
...
<Steps>
  ...
  <Step title="添加用户消息（User Message）">
    ...
    6. 再次按下 `/` 键并点击 **email_content**。
       ...
       <Frame>
         ![添加用户消息](/images/use-dify/tutorial/workflow-101-lesson-03/add-user-message.png)
       </Frame>
    ...
    <Frame>
      ![提示词预览](/images/use-dify/tutorial/workflow-101-lesson-03/final-prompt.png)
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="提前检查">
    ...
    <Frame>
      ![检查清单](/images/use-dify/tutorial/workflow-101-lesson-03/checklist.png)
    </Frame>
  </Step>
  <Step title="分析警告">
  ...
  <Step title="解决问题">
    ...
    <Frame>
      ![解决问题](/images/use-dify/tutorial/workflow-101-lesson-03/fix-the-issue.png)
    </Frame>
  </Step>
  <Step title="测试运行">
    ...
    <Frame>
      ![测试运行](/images/use-dify/tutorial/workflow-101-lesson-03/test-run.png)
    </Frame>
    <CodeGroup>
...
<Tip>
  ...
  <Frame>
    ![提示词生成器](/images/use-dify/tutorial/workflow-101-lesson-03/prompt-generator.png)
  </Frame>
</Tip>
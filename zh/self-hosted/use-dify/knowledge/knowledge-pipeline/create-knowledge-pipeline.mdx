...
<Note> ⚠️ 本文档由 AI 自动翻译。如有任何不准确之处，请参考 [英文原版](/en/use-dify/knowledge/knowledge-pipeline/create-knowledge-pipeline)。</Note>
...
<Frame>
  ![导入DSL](/images/use-dify/knowledge/create-knowledge-pipeline-03.png)
</Frame>

...
![ツールの構造](https://assets-docs.dify.ai/2025/01/a6b6b631077c13034447242fe3744b56.png)
...
Scaffoldingツールに含まれるテンプレートは、いずれも完全なコードプロジェクトとして利用できます。この記事の例では、`Tool`プラグインを選択してください。プラグインに精通している開発者であれば、テンプレートを使用せずに、[インターフェースドキュメント](../../schema-definition/)のガイダンスに従って、さまざまな種類のプラグイン開発を行うことも可能です。

...
<Note> ⚠️ このドキュメントはAIによって自動翻訳されています。不正確な部分がある場合は、[英語版](/en/documentation/getting-started/introduction)を参照してください。</Note>
...
<CardGroup cols={3}>
  <Card title="クイックスタート" icon="play" href="/jp/documentation/getting-started/quick-start">
    数分で強力なアプリの構築を開始
  </Card>
  <Card title="概念" icon="highlighter" iconType="regular" href="/jp/documentation/getting-started/key-concepts">
    Difyの核となる構成要素の説明
  </Card>
  <Card title="セルフホスティング" icon="arrow-down-to-line" href="/jp/self-hosting/quick-start/docker-compose">
  ...
  <Card title="チュートリアル" icon="lightbulb" href="/jp/documentation/tutorials/customer-service-bot">

...
<Note> ⚠️ このドキュメントはAIによって自動翻訳されています。不正確な部分がある場合は、[英語版](/en/documentation/publish/publish-mcp)を参照してください。</Note>
...
<Note>
  Difyワークフローおよびエージェント内でMCPツールを使用する場合は、[こちら](/jp/documentation/build/mcp)をご覧ください。
</Note>

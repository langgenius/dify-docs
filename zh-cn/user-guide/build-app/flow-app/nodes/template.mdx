...
<Frame caption="拼接文本" width="375">
  <img src="/zh-cn/user-guide/.gitbook/assets/image (209).png" alt="拼接文本示例" />
</Frame>
...
<Frame caption="知识检索节点输出转换为 Markdown">
  <img src="/zh-cn/user-guide/.gitbook/assets/image (210).png" alt="知识检索节点输出转换为 Markdown示例" />
</Frame>

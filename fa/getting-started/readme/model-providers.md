# لیست ارائه‌کننده‌های مدل‌ها

سرویس Dify به صورت پیش‌فرض از مدل‌های هوش‌مصنوعی زیر پشتیبانی می‌کند:

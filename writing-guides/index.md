...
| 2 | dify-docs-translation-test | On the zh and ja pages: a fresh agent judges each beside its English source against the language's formatting guide and the glossary, with the same form of marks and verdict. |
